 ...
 * |        |          |If the TBINTDIS bit is enabled it will not generates TDIFn(PDMA_TDSTS[3:0]) when PDMA controller finishes transfer task.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |CHENn     |PDMA Channel Enable Bits
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |PAUSEn    |PDMA Channel n Transfer Pause Control (Write Only)
 * |        |          |User can set PAUSEn bit field to pause the PDMA transfer
 * |        |          |When user sets PAUSEn bit, the PDMA controller will pause the on-going transfer, then clear the channel enable bit CHEN(PDMA_CHCTL [n], n=0,1..3) and clear request active flag(PDMA_TRGSTS[n:0], n=0,1..3
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |SWREQn    |PDMA Software Request (Write Only)
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |REQSTSn   |PDMA Channel Request Status (Read Only)
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |FPRISETn  |PDMA Fixed Priority Setting
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |FPRICLRn  |PDMA Fixed Priority Clear Bits (Write Only)
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |INTENn    |PDMA Interrupt Enable Bits
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |ABTIFn    |PDMA Read/Write Target Abort Interrupt Status Flag
 ...
 * |        |          |24 =.
 * |        |          |25 =.
 * |        |          |26 = Channel connects to USCI2_TX.
 * |        |          |27 = Channel connects to USCI2_RX.
 * |        |          |28 = Channel connects to USCI3_TX.
 * |        |          |29 = Channel connects to USCI3_RX.
 * |        |          |30 = Reserved.
 * |        |          |31 = Reserved.
 ...
 * |        |          |Please refer to the explanation of REQSRC0.
 */
    DSCT_T        DSCT[4];               /*!< [0x0000 ~ 0x003c] Control Register of PDMA Channel 0 ~ 3                  */
    __I  uint32_t RESERVE0[48];
    __I  uint32_t CURSCAT[4];            /*!< [0x0100 ~ 0x010c] Current Scatter-gather Descriptor Table Address of PDMA Channel n */
    __I  uint32_t RESERVE1[188];
...
#define PDMA_CHCTL_CHENn_Msk             (0xful << PDMA_CHCTL_CHENn_Pos)                   /*!< PDMA_T::CHCTL: CHENn Mask              */

#define PDMA_PAUSE_PAUSEn_Pos            (0)                                               /*!< PDMA_T::PAUSE: PAUSEn Position         */
#define PDMA_PAUSE_PAUSEn_Msk            (0xful << PDMA_PAUSE_PAUSEn_Pos)                  /*!< PDMA_T::PAUSE: PAUSEn Mask             */

#define PDMA_SWREQ_SWREQn_Pos            (0)                                               /*!< PDMA_T::SWREQ: SWREQn Position         */
#define PDMA_SWREQ_SWREQn_Msk            (0xful << PDMA_SWREQ_SWREQn_Pos)                  /*!< PDMA_T::SWREQ: SWREQn Mask             */

#define PDMA_TRGSTS_REQSTSn_Pos          (0)                                               /*!< PDMA_T::TRGSTS: REQSTSn Position       */
#define PDMA_TRGSTS_REQSTSn_Msk          (0xful << PDMA_TRGSTS_REQSTSn_Pos)                /*!< PDMA_T::TRGSTS: REQSTSn Mask           */

#define PDMA_PRISET_FPRISETn_Pos         (0)                                               /*!< PDMA_T::PRISET: FPRISETn Position      */
#define PDMA_PRISET_FPRISETn_Msk         (0xful << PDMA_PRISET_FPRISETn_Pos)               /*!< PDMA_T::PRISET: FPRISETn Mask          */

#define PDMA_PRICLR_FPRICLRn_Pos         (0)                                               /*!< PDMA_T::PRICLR: FPRICLRn Position      */
#define PDMA_PRICLR_FPRICLRn_Msk         (0xful << PDMA_PRICLR_FPRICLRn_Pos)               /*!< PDMA_T::PRICLR: FPRICLRn Mask          */

#define PDMA_INTEN_INTENn_Pos            (0)                                               /*!< PDMA_T::INTEN: INTENn Position         */
#define PDMA_INTEN_INTENn_Msk            (0xful << PDMA_INTEN_INTENn_Pos)                  /*!< PDMA_T::INTEN: INTENn Mask             */
...
#define PDMA_ALIGN_ALIGNn_Msk            (0xful << PDMA_ALIGN_ALIGNn_Pos)                  /*!< PDMA_T::ALIGN: ALIGNn Mask             */

#define PDMA_TACTSTS_TXACTFn_Pos         (0)                                               /*!< PDMA_T::TACTSTS: TXACTFn Position      */
#define PDMA_TACTSTS_TXACTFn_Msk         (0xful << PDMA_TACTSTS_TXACTFn_Pos)               /*!< PDMA_T::TACTSTS: TXACTFn Mask          */
...
#define PDMA_CHRST_CHnRST_Msk            (0xful << PDMA_CHRST_CHnRST_Pos)                  /*!< PDMA_T::CHRST: CHnRST Mask             */

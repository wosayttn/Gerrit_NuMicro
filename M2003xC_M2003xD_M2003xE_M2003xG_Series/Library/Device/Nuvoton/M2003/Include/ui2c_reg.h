 ...
 * |        |          |0 = The chip is woken up according receive 'START' symbol.
 ...
 * |        |          |It must write one by software to this bit after the related interrupt flags are set to 1 and the I2C protocol function will go ahead until the STOP is active or the PROTIEN is disabled.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.STARIEN = 1.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.STORIEN = 1.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.NACKIEN = 1.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.ARBLOIEN = 1.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.ERRIEN = 1.
 ...
 * |        |          |A protocol interrupt can be generated if UI2C_PROTIEN.ACKIEN = 1.

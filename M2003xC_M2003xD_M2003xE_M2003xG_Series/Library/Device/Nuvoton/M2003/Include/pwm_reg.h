 ...
 * |        |          |0 = The state of pin PWM_BRAKE0 is passed to the negative edge detector.
 * |        |          |1 = The inversed state of pin PWM_BRAKE10 is passed to the negative edge detector.
 ...
 * |        |          |0 = The state of pin PWM_BRAKE1 is passed to the negative edge detector.
 * |        |          |1 = The inversed state of pin PWM_BRAKE1 is passed to the negative edge detector.
 ...
 * |        |          |Note: This bit can be cleared by software writing 1.
 * @var PWM_T::WECAP
 * Offset: 0x130  PWM Trigger Window Mode ECAP Source Select Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |TRGWECSEL0|PWM Trigger Window Mode ECAP0 Source Select
 ...
 * |[7]     |TRGWEC0   |PWM Trigger Window Mode ECAP0 Enable Bit
 * |        |          |0 = PWM Trigger ECAP0 function Disabled.
 * |        |          |1 = PWM Trigger ECAP0 function Enabled.
 * |        |          |Note: This control register is only effective when associated with PWM0.
 * |[11:8]  |TRGWECSEL1|PWM Trigger Window Mode ECAP1 Source Select
 * |        |          |0000 = PWM_CH0 duty ON as window period.
 * |        |          |0001 = PWM_CH0 duty OFF as window period.
 * |        |          |0010 = PWM_CH1 duty ON as window period.
 * |        |          |0011 = PWM_CH1 duty OFF as window period
 ...
 * |        |          |1111 = Reserved
 * |        |          |Note: This control register is only effective when associated with PWM0.
 * |[15]    |TRGWEC1   |PWM Trigger Window Mode ECAP1 Enable Bit
 * |        |          |0 = PWM Trigger ECAP1 function Disabled.
 * |        |          |1 = PWM Trigger ECAP1 function Enabled.
 * |[19:16] |TRGWECSEL2|PWM Trigger Window Mode ECAP2 Source Select
 * |        |          |0000 = PWM_CH0 duty ON as window period.
 * |        |          |0001 = PWM_CH0 duty OFF as window period.
 * |        |          |0010 = PWM_CH1 duty ON as window period.
 * |        |          |0011 = PWM_CH1 duty OFF as window period
 ...
 * |        |          |1111 = Reserved
 * |        |          |Note: This control register is only effective when associated with PWM0.
 * |[23]    |TRGWEC2   |PWM Trigger Window Mode ECAP2 Enable Bit
 ...
 */
    ...
    __IO uint32_t WECAP;                 /*!< [0x0130] PWM Trigger Window Mode ECAP Source Select Register              */
    __I  uint32_t RESERVE14[51];
...
#define PWM_WECAP_TRGWECSEL0_Pos         (0)                                               /*!< PWM_T::WECAP: TRGWECSEL0 Position      */
#define PWM_WECAP_TRGWECSEL0_Msk         (0xful << PWM_WECAP_TRGWECSEL0_Pos)               /*!< PWM_T::WECAP: TRGWECSEL0 Mask          */

#define PWM_WECAP_TRGWEC0_Pos            (7)                                               /*!< PWM_T::WECAP: TRGWEC0 Position         */
#define PWM_WECAP_TRGWEC0_Msk            (0x1ul << PWM_WECAP_TRGWEC0_Pos)                  /*!< PWM_T::WECAP: TRGWEC0 Mask             */

#define PWM_WECAP_TRGWECSEL1_Pos         (8)                                               /*!< PWM_T::WECAP: TRGWECSEL1 Position      */
#define PWM_WECAP_TRGWECSEL1_Msk         (0xful << PWM_WECAP_TRGWECSEL1_Pos)               /*!< PWM_T::WECAP: TRGWECSEL1 Mask          */

#define PWM_WECAP_TRGWEC1_Pos            (15)                                              /*!< PWM_T::WECAP: TRGWEC1 Position         */
#define PWM_WECAP_TRGWEC1_Msk            (0x1ul << PWM_WECAP_TRGWEC1_Pos)                  /*!< PWM_T::WECAP: TRGWEC1 Mask             */

#define PWM_WECAP_TRGWECSEL2_Pos         (16)                                              /*!< PWM_T::WECAP: TRGWECSEL2 Position      */
#define PWM_WECAP_TRGWECSEL2_Msk         (0xful << PWM_WECAP_TRGWECSEL2_Pos)               /*!< PWM_T::WECAP: TRGWECSEL2 Mask          */

#define PWM_WECAP_TRGWEC2_Pos            (23)                                              /*!< PWM_T::WECAP: TRGWEC2 Position         */
#define PWM_WECAP_TRGWEC2_Msk            (0x1ul << PWM_WECAP_TRGWEC2_Pos)                  /*!< PWM_T::WECAP: TRGWEC2 Mask             */

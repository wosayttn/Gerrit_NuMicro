...
typedef struct
{
     ...
     * |        |          |In Power-down mode, HXT, HIRC and system clock will be disabled and ignored the clock source selection.
     ...
     * |[2]     |CRCCKEN   |CRC Generator Controller Clock Enable Bit
     ...
     * |[9]     |SRAM1CKEN |SRAM Bank1 Controller Clock Enable Bit
     * |        |          |0 = SRAM bank1 clock Disabled.
     * |        |          |1 = SRAM bank1 clock Enabled.
     * |[12]    |PDMACKEN  |PDMA Controller Clock Enable Bit
     * |        |          |0 = PDMA peripheral clock Disabled.
     * |        |          |1 = PDMA peripheral clock Enabled.
     * |[16]    |GPACKEN   |GPIOA Clock Enable Bit
     ...
     * |[19]    |GPDCKEN   |GPIOD Clock Enable Bit
     ...
     * |[22]    |GPGCKEN   |GPIOG Clock Enable Bit
     ...
     * |[11]    |USCI3CKEN |USCI3 Clock Enable Bit
     * |        |          |0 = USCI3 clock Disabled.
     * |        |          |1 = USCI3 clock Enabled.
     ...
     * |        |          |101 = Clock source from 24/32 MHz internal high speed RC oscillator (HIRC).
     * |        |          |Others = Reserved.
     ...
     * |        |          |11 = Clock source from 24/32 MHz internal high speed RC oscillator (HIRC).
     ...
     * |[1]     |PWM1SEL   |PWM0 Clock Source Selection (Read Only)
     ...
     * |        |          |11 = Clock source from 32 MHz internal high speed RC oscillator (HIRC).
     * |        |          |Others = Reserved.
     * |[18:16] |UART0SEL  |UART0 Clock Source Selection
     * |        |          |011 = Clock source from 24/32 MHz internal high speed RC oscillator (HIRC).
     ...
     * |        |          |11 = Clock source from 24/32 MHz internal high speed RC oscillator (HIRC).
     * |        |          |Others = Reserved.
     * |[30:28] |UART2SEL  |UART2 Clock Source Selection
     * |        |          |011 = Clock source from 24/32 MHz internal high speed RC oscillator (HIRC).
     * |        |          |100 = Clock source from PCLK0.
     * |        |          |Others = Reserved.
     * @var CLK_T::CLKDIV0
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |HCLKDIV   |HCLK Clock Divide Number From HCLK Clock Source
     ...
     * |        |          |Note: This field write ignore when CLK_APBCLK0u2019s ADCCKEN = 1.
     ...
     * |        |          |0 = 24/32 MHz internal high speed RC oscillator (HIRC) clock is not stable or disabled.
     * |        |          |1 = 24/32 MHz internal high speed RC oscillator (HIRC) clock is stable and enabled.
     ...
     * |        |          |Frequency out of range will be asserted when (HIRC_period*512) / HXT_period )> CLK_DUPB.
     * @var CLK_T::CDLOWB
     ...
     * |        |          |Frequency out of range will be asserted when ((HIRC_period*512) / HXT_period) < CLK_CDLOWB.
     * @var CLK_T::HXTCTL
     * Offset: 0x84  High Speed Crystal Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[3:0]   |GAIN      |HXT Gain Control Bit (Write Protect)
     ...
     * |        |          |0000 = HXT frequency is lower than from 4 MHz.
     * |        |          |0001 = HXT frequency is lower than from 4 MHz
     * |        |          |0010 = HXT frequency is from 4 MHz to 12 MHz..
     * |        |          |0011 = HXT frequency is from 4 MHz to 12 MHz.
     * |        |          |0100 = HXT frequency is from 12 MHz to 16 MHz.
     * |        |          |0101 = HXT frequency is from 12 MHz to 16 MHz.
     * |        |          |0110 = HXT frequency is from 12 MHz to 16 MHz..
     * |        |          |0111 = HXT frequency is from 16 MHz to 24 MHz
     * |        |          |1000 = HXT frequency is from 16 MHz to 24 MHz.
     * |        |          |1001 = HXT frequency is from 16 MHz to 24 MHz.
     * |        |          |1010 = HXT frequency is from 16 MHz to 24 MHz.
     * |        |          |1011 = HXT frequency is from 24 MHz to 32 MHz.
     * |        |          |1100 = HXT frequency is from 24 MHz to 32 MHz.
     * |        |          |1101 = HXT frequency is from 24 MHz to 32 MHz.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
     * @var CLK_T::PMUCTL
     ...
     * @var CLK_T::PASWKCTL
     * Offset: 0xA0  GPA Power-down Wake-up Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |The de-bounce function is valid only for edge triggered.
     * @var CLK_T::PDSWKCTL
     * Offset: 0xAC  GPD Power-down Wake-up Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |WKEN      |Standby Power-down Pin Wake-up Enable Bit
     ...
     * |[7:4]   |WKPSEL    |GPD Power-down Wake-up Pin Select
     ...
     * |        |          |Note: This bit is auto cleared by hardware.
     * @var CLK_T::HXTFSEL
     * Offset: 0xB4  HXT Filter Select Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |HXTFDIS   |HXT Filter Disable Bit
    ...
    __IO uint32_t HXTCTL;                /*!< [0x0084] High Speed Crystal Control Register                              */
    ...
    __IO uint32_t SWKDBCTL;              /*!< [0x009c] Power-down Wake-up De-bounce Control Register                    */
    __IO uint32_t PASWKCTL;              /*!< [0x00a0] GPA Power-down Wake-up Control Register                          */
    __IO uint32_t PBSWKCTL;              /*!< [0x00a4] GPB Power-down Wake-up Control Register                          */
    __IO uint32_t PCSWKCTL;              /*!< [0x00a8] GPC Power-down Wake-up Control Register                          */
    __IO uint32_t PDSWKCTL;              /*!< [0x00ac] GPD Power-down Wake-up Control Register                          */
    __IO uint32_t IOPDCTL;               /*!< [0x00b0] GPIO Power-down Control Register                                 */
    __IO uint32_t HXTFSEL;               /*!< [0x00b4] HXT Filter Select Register                                       */
} CLK_T;
...
#define CLK_AHBCLK_CRCCKEN_Pos           (2)                                               /*!< CLK_T::AHBCLK: CRCCKEN Position        */
...
#define CLK_AHBCLK_SRAM1CKEN_Pos         (9)                                               /*!< CLK_T::AHBCLK: SRAM1CKEN Position      */
#define CLK_AHBCLK_SRAM1CKEN_Msk         (0x1ul << CLK_AHBCLK_SRAM1CKEN_Pos)               /*!< CLK_T::AHBCLK: SRAM1CKEN Mask          */

#define CLK_AHBCLK_PDMACKEN_Pos          (12)                                              /*!< CLK_T::AHBCLK: PDMACKEN Position       */
#define CLK_AHBCLK_PDMACKEN_Msk          (0x1ul << CLK_AHBCLK_PDMACKEN_Pos)                /*!< CLK_T::AHBCLK: PDMACKEN Mask           */

#define CLK_AHBCLK_GPACKEN_Pos           (16)                                              /*!< CLK_T::AHBCLK: GPACKEN Position        */
...
#define CLK_AHBCLK_GPDCKEN_Pos           (19)                                              /*!< CLK_T::AHBCLK: GPDCKEN Position        */
...
#define CLK_AHBCLK_GPGCKEN_Pos           (22)                                              /*!< CLK_T::AHBCLK: GPGCKEN Position        */
...
#define CLK_APBCLK1_USCI3CKEN_Pos        (11)                                              /*!< CLK_T::APBCLK1: USCI3CKEN Position     */
#define CLK_APBCLK1_USCI3CKEN_Msk        (0x1ul << CLK_APBCLK1_USCI3CKEN_Pos)              /*!< CLK_T::APBCLK1: USCI3CKEN Mask         */
...
#define CLK_CLKSEL2_UART2SEL_Pos         (28)                                              /*!< CLK_T::CLKSEL2: UART2SEL Position      */
...
#define CLK_CLKDIV0_HCLKDIV_Msk          (0xfful << CLK_CLKDIV0_HCLKDIV_Pos)               /*!< CLK_T::CLKDIV0: HCLKDIV Mask           */
...
#define CLK_HXTCTL_GAIN_Pos              (0)                                               /*!< CLK_T::HXTCTL: GAIN Position           */
#define CLK_HXTCTL_GAIN_Msk              (0xful << CLK_HXTCTL_GAIN_Pos)                    /*!< CLK_T::HXTCTL: GAIN Mask               */
...
#define CLK_HXTFSEL_HXTFDIS_Pos          (0)                                               /*!< CLK_T::HXTFSEL: HXTFDIS Position       */
#define CLK_HXTFSEL_HXTFDIS_Msk          (0x1ul << CLK_HXTFSEL_HXTFDIS_Pos)                /*!< CLK_T::HXTFSEL: HXTFDIS Mask           */

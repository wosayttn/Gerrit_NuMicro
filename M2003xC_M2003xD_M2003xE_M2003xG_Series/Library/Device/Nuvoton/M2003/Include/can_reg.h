 ...
 * @var CAN_IF_T::CMASK
 * Offset: 0x24, 0x84  IFn Command Mask Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |1 = Set TxRqst bit.
 * |        |          |Note: If a transmission is requested by programming bit TxRqst_NewDat in the IFn Command Mask Register, bit TxRqst in the IFn Message Control Register will be ignored.
 ...
 * @var CAN_IF_T::MASK1
 * Offset: 0x28, 0x88  IFn Mask 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::MASK2
 * Offset: 0x2C, 0x8C  IFn Mask 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::ARB1
 * Offset: 0x30, 0x90  IFn Arbitration 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::ARB2
 * Offset: 0x34, 0x94  IFn Arbitration 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::MCON
 * Offset: 0x38, 0x98  IFn Message Control Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::DAT_A1
 * Offset: 0x3C, 0x9C  IFn Data A1 Registers (Register Map Note 3)
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::DAT_A2
 * Offset: 0x40, 0xA0  IFn Data A2 Registers (Register Map Note 3)
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::DAT_B1
 * Offset: 0x44, 0xA4  IFn Data B1 Registers (Register Map Note 3)
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_IF_T::DAT_B2
 * Offset: 0x48, 0xA8  IFn Data B2 Registers (Register Map Note 3)
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Table 6.4-5 Last Error CodeTable 6.4-5 Last Error Codedescribes the error code.
 ...
 * @var CAN_T::STSEL
 * Offset: 0xFF8  Tx Rx Signal Type Selection Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |CAN_TxL   output high
 */
    __IO uint32_t CON;                   /*!< [0x0000] CAN Control Register                                             */
    __IO uint32_t STATUS;                /*!< [0x0004] CAN Status Register                                              */
    __I  uint32_t ERR;                   /*!< [0x0008] CAN Error Counter Register                                       */
    ...
    __I  uint32_t RESERVE6[930];
    __IO uint32_t STSEL;                 /*!< [0x0ff8] Tx Rx Signal Type Selection Register                             */
...
#define CAN_IF_CREQ_BUSY_Pos             (15)                                              /*!< CAN_IF_T::IF_CREQ: BUSY Position       */
...
#define CAN_TXREQ1_TXRQST_Pos            (0)                                               /*!< CAN_T::TXREQ1: TXRQST Position         */
#define CAN_TXREQ1_TXRQST_Msk            (0xfffful << CAN_TXREQ1_TXRQST_Pos)               /*!< CAN_T::TXREQ1: TXRQST Mask             */

#define CAN_TXREQ2_TXRQST_Pos            (0)                                               /*!< CAN_T::TXREQ2: TXRQST Position         */
#define CAN_TXREQ2_TXRQST_Msk            (0xfffful << CAN_TXREQ2_TXRQST_Pos)               /*!< CAN_T::TXREQ2: TXRQST Mask             */
...
#define CAN_STSEL_TXHS_Pos               (0)                                               /*!< CAN_T::STSEL: TXHS Position            */
#define CAN_STSEL_TXHS_Msk               (0x7ul << CAN_STSEL_TXHS_Pos)                     /*!< CAN_T::STSEL: TXHS Mask                */

#define CAN_STSEL_TXLS_Pos               (4)                                               /*!< CAN_T::STSEL: TXLS Position            */
#define CAN_STSEL_TXLS_Msk               (0x7ul << CAN_STSEL_TXLS_Pos)                     /*!< CAN_T::STSEL: TXLS Mask                */

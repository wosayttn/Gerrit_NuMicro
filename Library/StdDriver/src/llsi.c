...
uint32_t LLSI_GetIntFlag(const LLSI_T *llsi, uint32_t u32Mask)
{
    ...
    if ((u32Mask & (uint32_t)LLSI_UNDFL_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_UNDFLIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & (uint32_t)LLSI_FEND_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_FENDIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & (uint32_t)LLSI_RSTC_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_RSTCIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & (uint32_t)LLSI_EMP_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_EMPIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & (uint32_t)LLSI_FUL_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_FULIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & (uint32_t)LLSI_TXTH_INT_MASK) != 0UL)
    {
        if ((llsi->STATUS & LLSI_STATUS_TXTHIF_Msk) != 0UL)
        {

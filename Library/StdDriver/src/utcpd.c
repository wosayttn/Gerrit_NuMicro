...
{
    return tcpc_update16(port, TCPC_REG_ALERT, (uint16_t)(AlertStClr), MASK_SET);
}
...
{
    return tcpc_update16(port, TCPC_REG_ALERT_MASK, (uint16_t)(mask_set), MASK_SET);
}
...
{
    return tcpc_update16(port, TCPC_REG_ALERT_MASK, (uint16_t)(mask_clr), MASK_CLR);
}
...
{
    return tcpc_update16(port, TCPC_REG_POWER_STATUS_MASK, (uint16_t)(mask_set), MASK_SET);
}
...
{
    return tcpc_update16(port, TCPC_REG_POWER_STATUS_MASK, (uint16_t)(mask_clr), MASK_CLR);
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_STATUS_MASK, (uint16_t)(mask_set), MASK_SET);
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_STATUS_MASK, (uint16_t)(mask_clr), MASK_CLR);
}
...
{
    return tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(mask_set), MASK_SET);  /* VBUS Monitor and VBUS Alarm are 0 to enable */
}
...
{
    return tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(maskclr), MASK_CLR);  /* VBUS Monitor and VBUS Alarm are 1 to disable */
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(mask_set), MASK_CLR);  /* 0 to enable */
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(maskclr), MASK_SET);  /* 1 to disable */
}
...
{
    return tcpc_update16(port, TCPC_REG_POWER_STATUS, (uint16_t)(PowerStClr), MASK_CLR);
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_STATUS, (uint16_t)(mask_set), MASK_SET);
}
...
{
    return tcpc_update16(port, TCPC_REG_FAULT_STATUS, (uint16_t)(FaultStClr), MASK_CLR);
}
...
int32_t UTCPD_SetRoleCtrl(int port, uint32_t u32DrpToggle, uint32_t u32Rpvalue, uint32_t u32CC2, uint32_t u32CC1)
{
    ...
    return tcpc_addr_write16(port, 0, TCPC_REG_ROLE_CTRL, (int)reg_set);
}
...
int32_t UTCPD_GetRoleCtrl(int port, uint32_t *pu32DrpToggle, uint32_t *pu32CC1, uint32_t *pu32CC2, uint32_t *pu32Rpvalue)
{
    ...
    int i32Tmp = 0;
    rv = tcpc_addr_read32(port, 0, TCPC_REG_ROLE_CTRL, &i32Tmp);
    u32Reg = (uint32_t)i32Tmp;
...
int32_t UTCPD_SetTypeCPortCtrl(int port, uint32_t u32BistMode, uint32_t u32Orient)
{
    ...
    return tcpc_addr_write16(port, 0, TCPC_REG_TCPC_CTRL, (int)reg_set);
}
...
{
    return tcpc_addr_write16(port, 0, TCPC_REG_COMMAND, (int)cmd);
}
...
int32_t UTCPD_GetFaultSts(int port, uint32_t *pu32VBUSOverCurr, uint32_t *pu32VBUSOverVolt, uint32_t *pu32VCONNOverCurr, uint32_t *pu32I2CInfErr)
{
    ...
    *pu32I2CInfErr = 0;  /* M5531 didn't support I2C */
    return rv;
}
...
int32_t UTCPD_SetMsgHeaderInfo(int port, uint32_t u32DataRole, uint32_t u32Revision, uint32_t u32PwrRole)
{
    ...
    return tcpc_addr_write16(port, 0, TCPC_REG_MSG_HDR_INFO, (int)reg_set);
}
...
int32_t UTCPD_SetRecDetect(int port, uint32_t u32RegData)
{
    ...
    return tcpc_addr_write16(port, 0, TCPC_REG_RX_DETECT, (int)reg_set);
}
...
{
    uint8_t u8TxBuf[4];
    u8TxBuf[0] = (uint8_t)(u32AlarmH & 0xFFU);
    u8TxBuf[1] = (uint8_t)((u32AlarmH >> 8) & 0xFFU);
    u8TxBuf[2] = (uint8_t)(u32AlarmL & 0xFFU);
    u8TxBuf[3] = (uint8_t)((u32AlarmL >> 8) & 0xFFU);
...
{
    return tcpc_addr_write16(port, 0, TCPC_REG_VBUS_SINK_DISCONNECT_THRESH, (int)u32SnkDiscVolt);
}
...
{
    return tcpc_addr_write16(port, 0, TCPC_REG_VBUS_STOP_DISCHARGE_THRESH, (int)u32StopDischgVolt);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_ENABLE_VCONN), MASK_CLR);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_ENABLE_VCONN), MASK_SET);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_TCPC_CTRL, (uint16_t)(TCPC_REG_TCPC_CTRL_PLUG_ORIENTATION), MASK_CLR);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_TCPC_CTRL, (uint16_t)(TCPC_REG_TCPC_CTRL_PLUG_ORIENTATION), MASK_SET);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_VCEN), MASK_CLR);
}
...
void UTCPD_vconn_polarity_active_high(int port)
{
    ...
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_VCEN), MASK_SET);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VCONN_OCP_FAULT_DIS), MASK_SET);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VCONN_OCP_FAULT_DIS), MASK_CLR);
}
...
void UTCPD_vconn_mux_selection(int port, uint32_t cc1vcensel, uint32_t cc2vcensel)
{
    uint32_t data;
    int i32Tmp2 = 0;
    (void)tcpc_addr_read16(port, 0, UTCPD_MUXSEL, &i32Tmp2);
    data = (uint32_t)i32Tmp2;
...
/* ============  VBUS SRCEN Polarity ========== */
void UTCPD_vbus_srcen_pol_act_low(int port)
{
    /* Set VBUS SRCEN Polarity active Low */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_SRCEN), MASK_CLR);
}

void UTCPD_vbus_srcen_pol_act_high(int port)
{
    /* Set VBUS SRCEN Polarity Active high */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_SRCEN), MASK_SET);
}

/* ============  VBUS SNKEN Polarity ========== */
void UTCPD_vbus_snken_pol_act_low(int port)
{
    /* Set VBUS SNKEN Polarity active Low */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_SNKEN), MASK_CLR);
}

void UTCPD_vbus_snken_pol_act_high(int port)
{
    /* Set VBUS SNKEN Polarity Active high */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_SNKEN), MASK_SET);
}

void UTCPD_vbus_disable_oc_fault(int port)
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_OCP_FAULT_DIS), MASK_SET);
}

void UTCPD_vbus_enable_oc_fault(int port)
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_OCP_FAULT_DIS), MASK_CLR);
}

void UTCPD_vbus_discharge_pol_act_low(int port)
{
    /* Set VBUS discharge Polarity Active low */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_VBDCHG), MASK_CLR);
}

void UTCPD_vbus_discharge_pol_act_high(int port)
{
    /* Set VBUS discharge Polarity Active high */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_VBDCHG), MASK_SET);
}
...
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_OVP_FAULT_DIS), MASK_SET);
}

void UTCPD_vbus_enable_ov_fault(int port)
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_OVP_FAULT_DIS), MASK_CLR);
}

/* VBUS force off fault */
void UTCPD_vbus_disable_forceoff_fault(int port)
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_FORCE_OFF_DIS), MASK_SET);
}

void UTCPD_vbus_enable_forceoff_fault(int port)
{
    (void)tcpc_update16(port, TCPC_REG_FAULT_CTRL, (uint16_t)(TCPC_REG_FAULT_CTRL_VBUS_FORCE_OFF_DIS), MASK_CLR);
}
...
uint32_t UTCPD_vbus_is_source(int port)
{
    uint32_t data;
    int i32Tmp2 = 0;
    (void)tcpc_addr_read16(port, 0, TCPC_REG_POWER_STATUS, &i32Tmp2);
    data = (uint32_t)i32Tmp2;

    if ((data & TCPC_REG_POWER_STATUS_SOURCING_VBUS) != 0U)
    {
        return 1;
    }
    else
...
uint32_t UTCPD_vbus_is_sink(int port)
{
    ...
    if ((data & TCPC_REG_POWER_STATUS_SINKING_VBUS) != 0U)
    {
        return 1;
    }
    else
...
uint32_t UTCPD_vbus_is_source_hv(int port)
{
    ...
    if ((data & TCPC_REG_POWER_STATUS_SOURCING_HIGH_VBUS) != 0U)
    {
        return 1;
    }
    else
...
{
    /* 0 enable monitor */
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_VBUS_VOL_MONITOR_DIS), MASK_CLR);
}

void UTCPD_power_disable_monitor(int port)
{
    /* 1 disable monitor */
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_VBUS_VOL_MONITOR_DIS), MASK_SET);
}
...
void UTCPD_power_disable_auto_discharge(int port)
{
    ...
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_AUTO_DISCHARGE_DISCONNECT), MASK_CLR);
}

void UTCPD_power_enable_auto_discharge(int port)
{
    /* Enable Auto Discharge = 0 */
    (void)tcpc_update16(port, TCPC_REG_POWER_CTRL, (uint16_t)(TCPC_REG_POWER_CTRL_AUTO_DISCHARGE_DISCONNECT), MASK_SET);
}

void UTCPD_frs_tx_polarity_active_low(int port)
{
    /* Set FRS Polarity Active low */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_FRSTX), MASK_CLR);
}

void UTCPD_frs_tx_polarity_active_high(int port)
{
    /* Set FRS Polarity Active high */
    (void)tcpc_update16(port, TCPC_REG_PINPL, (uint16_t)(TCPC_REG_PINPL_FRSTX), MASK_SET);
}

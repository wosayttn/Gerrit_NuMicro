...
/**
 * @brief      Check if the OTFC module is valid.
 *
 * @param[in]  otfc  is the base address of OTFC module.
 * @param[in]  u32PR is the Protection Region.
 *                   - \ref OTFC_PR_0
 *                   - \ref OTFC_PR_1
 *                   - \ref OTFC_PR_2
 *                   - \ref OTFC_PR_3
 *
 * @return     OTFC_OK if the OTFC module is valid; otherwise return OTFC_ERR_FAIL.
 */
...
/**
 * @brief      Wait until the OTFC module is not busy.
 *
 * @param[in]  otfc  is the base address of OTFC module.
 * @param[in]  u32PR is the Protection Region.
 *                   - \ref OTFC_PR_0
 ...
 *                   - \ref OTFC_PR_3
 *
 * @return     OTFC_OK if the OTFC module is not busy; otherwise return OTFC_ERR_TIMEOUT.
 */
static int32_t otfc_wait_busy(const OTFC_T *otfc, uint32_t u32PR)
{
    volatile int32_t i32Timeout = (int32_t)OTFC_TIMEOUT;

...
uint32_t EPWM_ConfigCaptureChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    (epwm)->CTL1 = ((epwm)->CTL1 & ~(EPWM_CTL1_CNTTYPE0_Msk << (u32ChannelNum << 1U))) | ((uint32_t)EPWM_DOWN_COUNTER << (u32ChannelNum << 1U));
...
uint32_t EPWM_ConfigOutputChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    if ((u32Prescale == 0UL) || (u32CNR == 0UL))
    {
        return 0UL;
    }

    if ((u32Prescale * u32CNR) == 0UL)
    {
        return 0UL;
    }
...
int32_t EPWM_EnableADCTriggerPrescale(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Prescale, uint32_t u32PrescaleCnt)
{
    ...
    if (((epwm)->EADCPSCCTL & (1UL << u32ChannelNum)) != 0UL)
    {
        return (-1);
    }
...
{
    return (((((epwm)->STATUS & (EPWM_STATUS_EADCTRGF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL));
}
...
uint32_t EPWM_GetDACTriggerFlag(const EPWM_T *epwm, uint32_t u32ChannelNum)
{
    ...
    return (((((epwm)->STATUS & EPWM_STATUS_DACTRGF_Msk) != 0UL) ? 1UL : 0UL));
}
...
void EPWM_EnableFaultBrake(EPWM_T *epwm, uint32_t u32ChannelMask, uint32_t u32LevelMask, uint32_t u32BrakeSource)
{
    ...
    for (i = 0U; i < EPWM_CHANNEL_NUM; i ++)
    {
        if ((u32ChannelMask & (1UL << i)) != 0UL)
        {
            if ((u32BrakeSource & (EPWM_BRKCTL0_1_SYSEBEN_Msk | EPWM_BRKCTL0_1_SYSLBEN_Msk)) != 0UL)
            {
...
{
    uint32_t RisingLatch = (((((epwm)->CAPIF & (EPWM_CAPIF_CRLIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL));
    return ((((((epwm)->CAPIF & (EPWM_CAPIF_CFLIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL) << 1) | RisingLatch);
}
/**
...
{
    return (((((epwm)->INTSTS0 & ((EPWM_INTSTS0_CMPDIF0_Msk | EPWM_INTSTS0_CMPUIF0_Msk) << u32ChannelNum))) != 0UL) ? 1UL : 0UL);
}
...
uint32_t EPWM_GetFaultBrakeIntFlag(const EPWM_T *epwm, uint32_t u32BrakeSource)
{
    ...
    return (((((epwm)->INTSTS1 & (0x3fUL << u32BrakeSource)) != 0UL) ? 1UL : 0UL));
}
...
{
    return (((((epwm)->INTSTS0 & ((1UL << EPWM_INTSTS0_PIF0_Pos) << u32ChannelNum))) != 0UL) ? 1UL : 0UL);
}
...
{
    return (((((epwm)->INTSTS0 & ((1UL << EPWM_INTEN0_ZIEN0_Pos) << u32ChannelNum))) != 0UL) ? 1UL : 0UL);
}
...
{
    return (((((epwm)->AINTSTS & (1UL << (u32ChannelNum))) != 0UL) ? 1UL : 0UL));
}
...
{
    return (((((epwm)->FTCI & ((EPWM_FTCI_FTCMU0_Msk | EPWM_FTCI_FTCMD0_Msk) << (u32ChannelNum >> 1U))) != 0UL) ? 1UL : 0UL));
}
...
{
    return (((((epwm)->STATUS & (EPWM_STATUS_CNTMAXF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL));
}
...
{
    return (((((epwm)->FDSTS & (EPWM_FDSTS_FDIF0_Msk << (u32ChannelNum))) != 0UL) ? 1UL : 0UL));
}

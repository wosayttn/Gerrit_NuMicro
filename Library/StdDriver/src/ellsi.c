...
{
    ellsi->TCCTL = 0;
    ellsi->TCCTL |= ((uint32_t)sPt->BledDimming << 0U);
    ellsi->TCCTL |= ((uint32_t)sPt->reserved0 << 5U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS0 << 6U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS1 << 7U);
    ellsi->TCCTL |= ((uint32_t)sPt->RledDimming << 8U);
    ellsi->TCCTL |= ((uint32_t)sPt->SEL_CUR << 13U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS2 << 14U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS3 << 15U);
    ellsi->TCCTL |= ((uint32_t)sPt->GledDimming << 16U);
    ellsi->TCCTL |= ((uint32_t)sPt->reserved1 << 21U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS4 << 22U);
    ellsi->TCCTL |= ((uint32_t)sPt->SS5 << 23U);
}
...
int32_t ELLSI_WaitCmdStsDone(ELLSI_T *ellsi, uint32_t u32Mask)
{
    ...
    if ((u32Mask & ELLSI_CMDDONE_MASK) == ELLSI_CMDDONE_MASK)
    {
        ...
        while ((ellsi->CMDSTS & ELLSI_CMDSTS_CMDDONE_Msk) == 0UL)
        {
            if (--u32TimeOutCnt == 0U)
            {
    ...
    if ((u32Mask & ELLSI_FBDONE_MASK) == ELLSI_FBDONE_MASK)
    {
        ...
        while ((ellsi->CMDSTS & ELLSI_CMDSTS_FBDONE_Msk) == 0UL)
        {
            if (--u32TimeOutCnt == 0U)
            {
                return ELLSI_ERR_TIMEOUT;
    ...
    if ((u32Mask & ELLSI_TH20DONE_MASK) == ELLSI_TH20DONE_MASK)
    {
        ...
        while ((ellsi->CMDSTS & ELLSI_CMDSTS_TH20DONE_Msk) == 0UL)
        {
            if (--u32TimeOutCnt == 0U)
            {
                return ELLSI_ERR_TIMEOUT;
    ...
    if ((u32Mask & ELLSI_ASETDONE_MASK) == ELLSI_ASETDONE_MASK)
    {
        ...
        while ((ellsi->CMDSTS & ELLSI_CMDSTS_ASETDONE_Msk) == 0UL)
        {
            if (--u32TimeOutCnt == 0U)
            {
                return ELLSI_ERR_TIMEOUT;
    ...
    if ((u32Mask & ELLSI_ATHDONE_MASK) == ELLSI_ATHDONE_MASK)
    {
        ...
        while ((ellsi->CMDSTS & ELLSI_CMDSTS_ATHDONE_Msk) == 0UL)
        {
            if (--u32TimeOutCnt == 0U)
            {
                return ELLSI_ERR_TIMEOUT;
...
uint32_t ELLSI_GetIntFlag(const ELLSI_T *ellsi, uint32_t u32Mask)
{
    ...
    if ((u32Mask & ELLSI_UNDFL_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_UNDFLIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FEND_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_FENDIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_RSTC_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_RSTCIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_EMP_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_EMPIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FUL_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_FULIF_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_TXTH_INT_MASK) != 0UL)
    {
        if ((ellsi->STATUS & ELLSI_STATUS_TXTHIF_Msk) != 0UL)
        {
...
uint32_t ELLSI_GetCmdIntFlag(const ELLSI_T *ellsi, uint32_t u32Mask)
{
    ...
    if ((u32Mask & ELLSI_CMDDONE_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_CMDDONE_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBDONE_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBDONE_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_TH20DONE_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_TH20DONE_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_SETIDLONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_SETIDLONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_CHKIDLONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_CHKIDLONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_SETIDSHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_SETIDSHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_CHKIDSHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_CHKIDSHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_SETGETOV_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_SETGETOV_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_CHKGETOV_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_CHKGETOV_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_SETGETUN_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_SETGETUN_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_CHKGETUN_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_CHKGETUN_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBC0LONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBC0LONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBC0SHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBC0SHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBC1LONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBC1LONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBC1SHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBC1SHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBID0LONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBID0LONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBID0SHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBID0SHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBID1LONG_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBID1LONG_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_FBID1SHORT_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_FBID1SHORT_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_ASETIDOV_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_ASETIDOV_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_ASETDONE_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_ASETDONE_Msk) != 0UL)
        {
    ...
    if ((u32Mask & ELLSI_ATHDONE_MASK) != 0UL)
    {
        if ((ellsi->CMDSTS & ELLSI_CMDSTS_ATHDONE_Msk) != 0UL)
        {
...
int32_t ELLSI_GetOverflowFlag(ELLSI_T *ellsi, uint32_t u32ID)
{
    ...
    if ((u32ID == 0U) || (u32ID > ELLSI_MAX_STRIP_CNT))
    {
        return -1;
    }

    u32Idx = u32ID - 1U;
    u32Reg = (ellsi->FB[u32Idx].FBPCNT & ELLSI_FBPCNT_FBPOV_Msk) >> ELLSI_FBPCNT_FBPOV_Pos;
...
/**
  ...
  */
int32_t ELLSI_GET_FB_COUNT(ELLSI_T *ellsi, uint32_t u32ID)
{
    uint32_t u32Idx;
    uint32_t u32Reg;
...
/**
  ...
  */
int32_t ELLSI_SET_FB_COUNT(ELLSI_T *ellsi, uint32_t u32ID, uint32_t u32IDCnt)
{
    uint32_t u32Idx;
    uint32_t u32Reg;
...
/**
  ...
  */
int32_t ELLSI_GET_FB_CURRENT(ELLSI_T *ellsi, uint32_t u32ID)
{
    uint32_t u32Idx;
    uint32_t u32Reg;
    ...
    u32Idx = u32ID - 1U;
    u32Reg = (ellsi->FB[u32Idx].FBPCNT & ELLSI_FBPCNT_FBPCUR_Msk) >> ELLSI_FBPCNT_FBPCUR_Pos;
    return (int32_t)u32Reg;
}
...
/**
  ...
  */
int32_t ELLSI_GET_FB_ID(ELLSI_T *ellsi, uint32_t u32ID)
{
    if ((u32ID == 0U) || (u32ID > ELLSI_MAX_STRIP_CNT))
    {
        return -1;

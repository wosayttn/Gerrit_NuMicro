...
__WEAK uint32_t ProcessHardFault(uint32_t *pu32StackFrame)
{
    ...
    */
    ...
    #ifndef NVT_ISP_FUNC
        #include "../../Device/Nuvoton/M3351/Source/GCC/retarget_GCC.c"
    #else
        // To reduce code size
    #endif
#endif
...
#if defined (__ARMCC_VERSION)
    #include "../../Device/Nuvoton/M3351/Source/ARM/retarget_ARMCC.c"
#endif

#if defined (__ICCARM__)
    #include "../../Device/Nuvoton/M3351/Source/IAR/retarget_ICC.c"
#endif

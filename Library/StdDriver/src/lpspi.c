...
/**
 * @brief      Check if the LPSPI module is valid.
 *
 * @param[in]  lpspi is the base address of LPSPI module.
 *
 * @return     1 if the LPSPI module is valid; otherwise return 0.
 */
...
/**
 * @brief      Check if the LPSPI module is operating in master mode or in slave mode.
 *
 * @param[in]  u32MasterSlave is the operating mode of LPSPI module. Valid values are:
 *                            - \ref LPSPI_MASTER
 *                            - \ref LPSPI_SLAVE
 *
 * @return     1 if the LPSPI module is operating in master mode or in slave mode; otherwise return 0.
 */
...
/**
 * @brief      Check if the LPSPI module is operating in LPSPI_MODE_0, LPSPI_MODE_1, LPSPI_MODE_2 or LPSPI_MODE_3.
 *
 * @param[in]  u32SPIMode is the transfer timing of LPSPI module. Valid values are:
 *                        - \ref LPSPI_MODE_0
 *                        - \ref LPSPI_MODE_1
 *                        - \ref LPSPI_MODE_2
 *                        - \ref LPSPI_MODE_3
 *
 * @return     1 if the LPSPI module is operating in LPSPI_MODE_0, LPSPI_MODE_1, LPSPI_MODE_2 or LPSPI_MODE_3; otherwise return 0.
 */
...
/**
 * @brief      Wait until the LPSPI module is ready to be disabled.
 *
 * @param[in]  lpspi is the base address of LPSPI module.
 *
 * @return     LPSPI_OK if the LPSPI module is ready to be disabled; otherwise return LPSPI_ERR_TIMEOUT.
 */
...
/**
 * @brief       Enter LPSPI configuration mode.
 *
 * @param[in]   lpspi          is the base address of LPSPI module.
 * @param[out]  pu32WasEnabled is the pointer to store the previous LPSPI enable status.
 *
 * @return      LPSPI_OK if the LPSPI module is ready to be configured; otherwise return LPSPI_ERR_FAIL or LPSPI_ERR_TIMEOUT.
 */
...
/**
 * @brief      Exit LPSPI configuration mode.
 *
 * @param[in]  lpspi         is the base address of LPSPI module.
 * @param[in]  u32WasEnabled is the previous LPSPI enable status.
 *
 * @return     None.
 */

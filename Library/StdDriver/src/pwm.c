...
{
    return ((((pwm)->STATUS & (PWM_STATUS_EADCTRG0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
}
...
{
    if ((u32Condition & (PWM_TRIGGER_DAC_COMPARE_UP | PWM_TRIGGER_DAC_COMPARE_DOWN)) != 0UL)
    {
        (pwm)->DACTRGEN |= ((u32Condition & (PWM_TRIGGER_DAC_COMPARE_UP | PWM_TRIGGER_DAC_COMPARE_DOWN)) << u32ChannelNum);
    }

    if ((u32Condition & (PWM_TRIGGER_DAC_ZERO | PWM_TRIGGER_DAC_PERIOD)) != 0UL)
    {
...
void PWM_DisableDACTrigger(PWM_T *pwm, uint32_t u32ChannelNum)
{
    ...
    (pwm)->DACTRGEN &= ~(((uint32_t)PWM_TRIGGER_DAC_ZERO | (uint32_t)PWM_TRIGGER_DAC_PERIOD) << ((u32ChannelNum >> 1UL) << 1UL));
}
...
uint32_t PWM_GetDACTriggerFlag(const PWM_T *pwm, uint32_t u32ChannelNum)
{
    ...
    return ((((pwm)->STATUS & PWM_STATUS_DACTRGF_Msk) != 0UL) ? 1UL : 0UL);
}
...
void PWM_EnableFaultBrake(PWM_T *pwm, uint32_t u32ChannelMask, uint32_t u32LevelMask, uint32_t u32BrakeSource)
{
    ...
    for (i = 0UL; i < PWM_CHANNEL_NUM; i ++)
    {
        if ((u32ChannelMask & (1UL << i)) != 0UL)
        {
            if ((u32BrakeSource & (PWM_BRKCTL_SYSEBEN_Msk | PWM_BRKCTL_SYSLBEN_Msk)) != 0UL)
            {
...
uint32_t PWM_GetCaptureIntFlag(const PWM_T *pwm, uint32_t u32ChannelNum)
{
    ...
    u32CapFFlag = ((((pwm)->CAPIF & (PWM_CAPIF_CFLIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
    u32CapRFlag = ((((pwm)->CAPIF & (PWM_CAPIF_CRLIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
...
{
    return ((((pwm)->INTSTS0 & ((PWM_INTSTS0_CMPDIF0_Msk | PWM_INTSTS0_CMPUIF0_Msk) << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
}
...
{
    return ((((pwm)->INTSTS0 & (PWM_INTSTS0_PIF0_Msk << ((u32ChannelNum >> 1UL) << 1UL))) != 0UL) ? 1UL : 0UL);
}
...
{
    return ((((pwm)->INTSTS0 & (PWM_INTSTS0_ZIF0_Msk << ((u32ChannelNum >> 1UL) << 1UL))) != 0UL) ? 1UL : 0UL);
}
...
{
    return ((((pwm)->STATUS & (PWM_STATUS_CNTMAX0_Msk << ((u32ChannelNum >> 1UL) << 1UL))) != 0UL) ? 1UL : 0UL);
}
...
{
    return ((((pwm)->AINTSTS & (1UL << ((u32ChannelNum >> 1) << 1))) != 0UL) ? 1UL : 0UL);
}

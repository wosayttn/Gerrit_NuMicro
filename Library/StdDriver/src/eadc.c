...
/**
  ...
  * @param[in] u32InputMode Decides the input mode. M3351 don't support this feature.
...
/**
  ...
  * @details      This function is used to read VALID bit field to get data valid status.
  */
uint32_t EADC_GET_DATA_VALID_FLAG(const EADC_T *eadc, uint32_t u32ModuleMask)
{
    uint32_t u32VALID;
...
/**
  ...
  * @details      This function is used to read OV bit field to get data overrun status.
  */
uint32_t EADC_GET_DATA_OVERRUN_FLAG(const EADC_T *eadc, uint32_t u32ModuleMask)
{
    uint32_t u32OVFlag;
...
/**
  ...
  * @details    This function is used to read RESULT bit field to get conversion data.
  */
uint32_t EADC_GET_CONV_DATA(EADC_T *eadc, uint32_t u32ModuleNum)
{
    ...
    return ((u32ModuleNum < 19UL) ? (eadc->DAT[u32ModuleNum] & adc_result_mask)
                                  : (eadc->DAT19[u32ModuleNum - 19UL] & adc_result_mask));
}
...
/**
  ...
  * @details    This function is used to read RESULT bit (EADC_DDATn[15:0], n=0~3) field to get conversion data.
  */
uint32_t EADC_GET_DOUBLE_DATA(EADC_T *eadc, uint32_t u32ModuleNum)
{
    uint32_t adc_result_mask;
...
/**
  ...
  * @return     None
  */
void EADC_ENABLE_CMP0(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
...
/**
  ...
  * @param[in]  eadc            The pointer of the specified EADC module.
  * @param[in]  u32ModuleNum    Specifies the compare sample module.
  * @param[in]  u32Condition    Specifies the compare condition.
  * @param[in]  u16CMPData      Specifies the compare value.
  * @param[in]  u32MatchCount   Specifies the match count setting, valid range are between 0~0xF.
  * @return     None
  */
void EADC_ENABLE_CMP1(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;
...
/**
  ...
  * @return     None
  */
void EADC_ENABLE_CMP2(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;
...
/**
  ...
  * @return     None
  */
void EADC_ENABLE_CMP3(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;

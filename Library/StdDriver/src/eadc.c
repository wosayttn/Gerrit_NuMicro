...
{
    volatile uint32_t u32Delay = SystemCoreClock;    /* 1 second */
    uint32_t u32ClkDivBackup, u32PclkDivBackup, u32RegLockBackup = 0;
...
void EADC_ConfigSampleModule(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32TriggerSrc, uint32_t u32Channel)
{
    ...
    {
        eadc->SCTL19[u32ModuleNum - 19] &= ~(EADC_SCTL19_EXTFEN_Msk | EADC_SCTL19_EXTREN_Msk | EADC_SCTL19_TRGSEL_Msk | EADC_SCTL19_CHSEL_Msk);
...
void EADC_SetTriggerDelayTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32TriggerDelayTime, uint32_t u32DelayClockDivider)
{
    ...
    {
        eadc->SCTL19[u32ModuleNum - 19] &= ~(EADC_SCTL19_TRGDLYDIV_Msk | EADC_SCTL19_TRGDLYCNT_Msk);
        eadc->SCTL19[u32ModuleNum - 19] |= ((u32TriggerDelayTime << EADC_SCTL19_TRGDLYCNT_Pos) | u32DelayClockDivider);
    }
}
...
void EADC_SetExtendSampleTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32ExtendSampleTime)
{
    ...
    {
        eadc->SCTL19[u32ModuleNum - 19] &= ~EADC_SCTL19_EXTSMPT_Msk;
        eadc->SCTL19[u32ModuleNum - 19] |= (u32ExtendSampleTime << EADC_SCTL19_EXTSMPT_Pos);
    }
}

...
/**
 * @brief      Check the specified USCI_SPI module is valid or not.
 *
...
/**
 * @brief      Check the specified USCI_SPI master/slave mode is valid or not.
 *
 * @param[in]  u32MasterSlave The specified USCI_SPI master/slave mode.
 *
 * @return     1 if valid, 0 otherwise.
 */
...
/**
 * @brief      Check the specified USCI_SPI transfer timing is valid or not.
 *
 * @param[in]  u32SPIMode The specified USCI_SPI transfer timing.
 *
 * @return     1 if valid, 0 otherwise.
 */
...
/**
 * @brief      Check the specified USCI_SPI automatic slave select configuration is valid or not.
 *
 * @param[in]  u32SSPinMask   The specified USCI_SPI automatic slave select pin mask.
 * @param[in]  u32ActiveLevel The specified USCI_SPI automatic slave select active level.
 *
 * @return     1 if valid, 0 otherwise.
 */

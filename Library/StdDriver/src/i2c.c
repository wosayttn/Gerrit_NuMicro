...
{
    const uint32_t u32AddrRegValue = ((((uint32_t)u16SlaveAddr) & 0x3ffU) << 1U) | (uint32_t)u8GCMode;
...
{
    const uint32_t u32AddrMskRegValue = ((((uint32_t)u16SlaveAddrMask) & 0x3ffU) << 1U);

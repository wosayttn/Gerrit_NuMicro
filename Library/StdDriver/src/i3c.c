...
void I3C_PresentStateInfo(I3C_DEVICE_T *dev)
{
    ...
    else
    {
        ...
        {
            if ((reg_val[0] & I3C_PRESENTS_MAIDLE_Msk) != 0UL)
            {
...
{
    if ((dev->ibi_status & I3C_IBIQSTS_NACK) != 0UL)
    {
...
int32_t I3C_TgtRecv(I3C_DEVICE_T *dev)
{
    ...
    else
    {
        ...
        {
            VOLATILE_U32_COPY(pu32RxBuf[i], dev->port->TXRXDAT);
        }
    }

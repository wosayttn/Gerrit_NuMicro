...
uint32_t BPWM_ConfigCaptureChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    uint16_t u16Prescale = (uint16_t)1U;
    uint16_t u16CNR = (uint16_t)0xFFFFU;
    uint8_t u8BreakLoop = (uint8_t)0U;
    ...
    for (u16Prescale = (uint16_t)1U; u16Prescale <= 0x1000U; u16Prescale++)
    {

...
uint32_t BPWM_ConfigOutputChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    if ((u32ChannelNum >= BPWM_CHANNEL_NUM) || (u32DutyCycle > 100UL))
    {
        return 0UL;
    }
...
{
    if ((u32ChannelNum >= BPWM_CHANNEL_NUM))
    {
        return;
    }
...
uint32_t BPWM_GetADCTriggerFlag(const BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    ...
    return ((((bpwm)->STATUS & (BPWM_STATUS_EADCTRG0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
}
...
uint32_t BPWM_GetCaptureIntFlag(const BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    ...
    u32CapIf = (((((bpwm)->CAPIF & (BPWM_CAPIF_CAPFIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL) << 1);
    u32CapIf |= ((((bpwm)->CAPIF & (BPWM_CAPIF_CAPRIF0_Msk << u32ChannelNum)) != 0UL) ? 1UL : 0UL);
    return u32CapIf;
}
...
uint32_t BPWM_GetDutyIntFlag(const BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    ...
    return (((((bpwm)->INTSTS & ((BPWM_INTSTS_CMPDIF0_Msk | BPWM_INTSTS_CMPUIF0_Msk) << u32ChannelNum))) != 0UL) ? 1UL : 0UL);
}
...
{
    (void)u32ChannelNum;
    return ((((bpwm)->INTSTS & BPWM_INTSTS_PIF0_Msk) != 0UL) ? 1UL : 0UL);
}
...
{
    (void)u32ChannelNum;
    return ((((bpwm)->INTSTS & BPWM_INTSTS_ZIF0_Msk) != 0UL) ? 1UL : 0UL);
}
...
{
    if ((u32ClkSrcSel > BPWM_CLKSRC_TIMER3))
    {
        return;
    }
...
{
    (void)u32ChannelNum;
    return ((((bpwm)->STATUS & BPWM_STATUS_CNTMAX0_Msk) != 0UL) ? 1UL : 0UL);
}

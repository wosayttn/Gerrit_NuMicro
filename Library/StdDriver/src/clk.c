 ...
 * @file     clk.c
 * @version  V1.00
 * @brief    M3351 series CLK driver source file
 *
...
/**
  ...
  * |\ref CLKO_MODULE    |\ref CLK_CLKSEL1_CLKOSEL_USB_SOF       | x                             |  
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    uint32_t au32DivTbl[3] = {0x0UL, 0x4UL, 0x8UL};                /* CLK_CLKDIV0~2 */
...
/**
 * @brief       Set Wake-up pin trigger type at Standby Power-down mode
 *
 * @param[in]   u32TriggerType Wake-up pin trigger type
 *              - \ref CLK_SPDWKPIN0_RISING
 *              - \ref CLK_SPDWKPIN0_FALLING
 *              - \ref CLK_SPDWKPIN0_BOTHEDGE
 *              - \ref CLK_SPDWKPIN1_RISING
 *              - \ref CLK_SPDWKPIN1_FALLING
 *              - \ref CLK_SPDWKPIN1_BOTHEDGE
 *              - \ref CLK_SPDWKPIN2_RISING
 *              - \ref CLK_SPDWKPIN2_FALLING
 *              - \ref CLK_SPDWKPIN2_BOTHEDGE
 *              - \ref CLK_SPDWKPIN3_RISING
 *              - \ref CLK_SPDWKPIN3_FALLING
 *              - \ref CLK_SPDWKPIN3_BOTHEDGE
 *              - \ref CLK_SPDWKPIN4_RISING
 *              - \ref CLK_SPDWKPIN4_FALLING
 *              - \ref CLK_SPDWKPIN4_BOTHEDGE
 * @return      None
 *

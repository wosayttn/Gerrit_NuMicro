...
static void SPI_SetPCLKSrc(SPI_T *spi)
{
    ...
    else if ((uint32_t)spi == (uint32_t)SPI1)
    {
        /* Set the peripheral clock rate to equal APB clock rate */
...
/**
  ...
  * @note   Only SPI0 supports I2S function.

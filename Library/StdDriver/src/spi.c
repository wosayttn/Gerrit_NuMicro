 ...
 * @file     spi.c
 * @version  V3.00
 * @brief    M471 series SPI driver source file
 *
 * @note
                  ...
                  uint32_t u32BusClock)
{
    ...
    uint32_t u32DataWidthReg = (u32DataWidth == 32U) ? 0U : u32DataWidth;
    ...
    if(u32MasterSlave == SPI_MASTER)
    {
        ...
        spi->CTL = (u32DataWidthReg << SPI_CTL_DWIDTH_Pos) | (u32SPIMode) | SPI_CTL_SPIEN_Msk;
    ...
    else     /* For slave mode, force the SPI peripheral clock rate to equal APB clock rate. */
    {
        ...
        /* Default setting: MSB first, disable unit transfer interrupt, SP_CYCLE = 0. */
        spi->CTL = u32MasterSlave | (u32DataWidthReg << SPI_CTL_DWIDTH_Pos) | (u32SPIMode) | SPI_CTL_SPIEN_Msk;
...
uint32_t SPII2S_Open(SPI_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat)
{
    ...
    if(u32MasterSlave == SPI_MASTER)
    {
        ...
        uint32_t u32BitRate = u32SampleRate * ((u32WordWidth >> ((uint32_t)SPI_I2SCTL_WDWIDTH_Pos & 0x1FU)) + 1U) * 16U;
        uint32_t u32Divider = ((u32SrcClk / u32BitRate) >> 1U) - 1U;
        ...
        uint32_t u32RealSampleRate = u32BitRate / (((u32WordWidth >> ((uint32_t)SPI_I2SCTL_WDWIDTH_Pos & 0x1FU)) + 1U) * 16U);

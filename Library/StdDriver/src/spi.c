...
/**
 * @brief      Check if the specified SPI module is valid.
 *
...
/**
 * @brief      Check if the specified SPI master/slave mode is valid.
 *
 * @param[in]  u32MasterSlave The SPI master/slave mode to be checked.
 *
 * @return     1 if valid, 0 otherwise.
 */
...
/**
 * @brief      Check if the specified SPI mode is valid.
 *
 * @param[in]  u32SPIMode The SPI mode to be checked.
 *
 * @return     1 if valid, 0 otherwise.
 */
...
/**
 * @brief      Wait for SPIEN bit to be cleared.
 *
 * @param[in]  spi The pointer of the specified SPI module.
 *
 * @return     SPI_OK if successful, SPI_ERR_TIMEOUT if timeout occurs.
 */
...
/**
 * @brief       Enter configuration mode and disable SPIEN bit if it was previously enabled.
 *
 * @param[in]   spi            The pointer of the specified SPI module.
 * @param[out]  pu32WasEnabled The previous state of the SPIEN bit before entering configuration mode.
 *
 * @return      SPI_OK if successful, SPI_ERR_TIMEOUT if timeout occurs, SPI_ERR_FAIL if invalid parameters.
 */
...
/**
 * @brief      Exit configuration mode and restore SPIEN bit if it was previously enabled.
 *
 * @param[in]  spi           The pointer of the specified SPI module.
 * @param[in]  u32WasEnabled The previous state of the SPIEN bit before entering configuration mode.
 *
 * @return     None.
 *
 * @details    This function restores the SPIEN bit to its previous state
 *             after configuration changes have been made.
 *             If the SPI module was enabled before entering configuration mode, it will be re-enabled.
 */

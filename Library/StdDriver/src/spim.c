...
/**
  * @brief  Exit Infineon Octal I/O (OPI) mode and revert to 1S-1S-1S legacy SPI mode.
  *         This function clears OPI-IT and SDRDDR bits in CFR5V (VCR6).
  * @param  spim     Pointer to SPIM module
  * @return None
  */
...
/**
  ...
  *         This function sets OPI-IT and SDRDDR bits in CFR5V (VCR6).
  * @param  spim     Pointer to SPIM module
  * @param  i32IsDDR - \ref SPIM_OP_DISABLE = Enter 8S-8S-8S (SDR) mode
  *                  - \ref SPIM_OP_ENABLE  = Enter 8D-8D-8D (DDR) mode
  * @return None
  */
...
/**
  * @brief      Adjust Power Level for DQS
  * @retval     None.

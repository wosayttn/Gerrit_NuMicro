...
/*---------------------------------------------------------------------------------------------------------*/
#define BPWM_DUTY_INT_DOWN_COUNT_MATCH_CMP        ((uint32_t)1U << ((uint32_t)BPWM_INTEN_CMPDIENn_Pos & 0x1FU))   /*!< BPWM duty interrupt triggered if down count match comparator \hideinitializer */
#define BPWM_DUTY_INT_UP_COUNT_MATCH_CMP          ((uint32_t)1U << ((uint32_t)BPWM_INTEN_CMPUIENn_Pos & 0x1FU))   /*!< BPWM duty interrupt triggered if up down match comparator \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  Load Mode Constant Definitions                                                                         */
/*---------------------------------------------------------------------------------------------------------*/
#define BPWM_LOAD_MODE_IMMEDIATE                  ((uint32_t)1U << BPWM_CTL0_IMMLDENn_Pos)    /*!< BPWM immediately load mode \hideinitializer */
#define BPWM_LOAD_MODE_CENTER                     ((uint32_t)1U << BPWM_CTL0_CTRLDn_Pos)      /*!< BPWM center load mode \hideinitializer */

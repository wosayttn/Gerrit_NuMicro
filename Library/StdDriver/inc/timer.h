...
#define TIMER_CAPSRC_INTERNAL                   (1UL << TIMER_CTL_CAPSRC_Pos)   /*!< Capture source from Internal event such as LIRC or HIRC  \hideinitializer */
...
#define TIMER_CAPTURE_FROM_INTERNAL             (TIMER_INTERCAPSEL_HIRC)        /*!< Capture source from Internal event HIRC    \hideinitializer */

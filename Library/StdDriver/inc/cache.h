...
/** @addtogroup CLK_EXPORTED_CONSTANTS CLK Exported Constants
    @{
*/
#define CACHE_PARITY_ERROR_NO_ACTION        (0 << CACHE_CTL_PERRRD_Pos)
#define CACHE_PARITY_ERROR_CACHE_MISS       (1 << CACHE_CTL_PERRRD_Pos)
 ...
 * @param[in] CACHE_PARITY_ERROR_NO_ACTION:  No action

...
#define I2S_FIFO_TX_LEVEL_WORD_1          (1UL << SPI_FIFOCTL_TXTH_Pos)     /*!< TX threshold is 1 word \hideinitializer */
#define I2S_FIFO_TX_LEVEL_WORD_2          (2UL << SPI_FIFOCTL_TXTH_Pos)     /*!< TX threshold is 2 words \hideinitializer */
#define I2S_FIFO_TX_LEVEL_WORD_3          (3UL << SPI_FIFOCTL_TXTH_Pos)     /*!< TX threshold is 3 words \hideinitializer */
/* I2S RX FIFO Threshold */
#define I2S_FIFO_RX_LEVEL_WORD_1          (0UL)                             /*!< RX threshold is 1 word \hideinitializer */
#define I2S_FIFO_RX_LEVEL_WORD_2          (1UL << SPI_FIFOCTL_RXTH_Pos)     /*!< RX threshold is 2 words \hideinitializer */
#define I2S_FIFO_RX_LEVEL_WORD_3          (2UL << SPI_FIFOCTL_RXTH_Pos)     /*!< RX threshold is 3 words \hideinitializer */
#define I2S_FIFO_RX_LEVEL_WORD_4          (3UL << SPI_FIFOCTL_RXTH_Pos)     /*!< RX threshold is 4 words \hideinitializer */

/* I2S Data Width */
#define I2S_DATABIT_8                     (0U << SPI_I2SCTL_WDWIDTH_Pos)    /*!< I2S data width is 8-bit \hideinitializer */
#define I2S_DATABIT_16                    (1U << SPI_I2SCTL_WDWIDTH_Pos)    /*!< I2S data width is 16-bit \hideinitializer */
#define I2S_DATABIT_24                    (2U << SPI_I2SCTL_WDWIDTH_Pos)    /*!< I2S data width is 24-bit \hideinitializer */
#define I2S_DATABIT_32                    (3U << SPI_I2SCTL_WDWIDTH_Pos)    /*!< I2S data width is 32-bit \hideinitializer */

/* I2S Audio Format */
#define I2S_MONO                          SPI_I2SCTL_MONO_Msk               /*!< Monaural channel \hideinitializer */
#define I2S_STEREO                        (0U)                              /*!< Stereo channel \hideinitializer */

/* I2S Data Format */
#define I2S_FORMAT_I2S                    (0U << SPI_I2SCTL_FORMAT_Pos)     /*!< I2S data format \hideinitializer */
#define I2S_FORMAT_MSB                    (1U << SPI_I2SCTL_FORMAT_Pos)     /*!< MSB justified data format \hideinitializer */
#define I2S_FORMAT_PCMA                   (2U << SPI_I2SCTL_FORMAT_Pos)     /*!< PCM mode A data format \hideinitializer */
#define I2S_FORMAT_PCMB                   (3U << SPI_I2SCTL_FORMAT_Pos)     /*!< PCM mode B data format \hideinitializer */

/* I2S Operation mode */
#define I2S_MODE_SLAVE                    SPI_I2SCTL_SLAVE_Msk              /*!< As slave mode \hideinitializer */
...
#define I2S_MONO_LEFT                     (1U)                              /*!< Record mono left channel \hideinitializer */
...
/* I2S Interrupt Mask */
#define I2S_FIFO_TXTH_INT_MASK            (0x01UL)                          /*!< TX FIFO threshold interrupt mask \hideinitializer */
#define I2S_FIFO_RXTH_INT_MASK            (0x02UL)                          /*!< RX FIFO threshold interrupt mask \hideinitializer */
#define I2S_FIFO_RXOV_INT_MASK            (0x04UL)                          /*!< RX FIFO overrun interrupt mask \hideinitializer */
#define I2S_FIFO_RXTO_INT_MASK            (0x08UL)                          /*!< RX FIFO time-out interrupt mask \hideinitializer */
#define I2S_TXUF_INT_MASK                 (0x10UL)                          /*!< TX FIFO underflow interrupt mask \hideinitializer */
#define I2S_RIGHT_ZC_INT_MASK             (0x20UL)                          /*!< Right channel zero cross interrupt mask \hideinitializer */
#define I2S_LEFT_ZC_INT_MASK              (0x40UL)                          /*!< Left channel zero cross interrupt mask \hideinitializer */
...
#define SPI_SET_SUSPEND_CYCLE(spi, u32SuspCycle)            \
    (spi)->CTL = ((spi)->CTL & ~(SPI_CTL_SUSPITV_Msk)) |    \
                 (((uint32_t)(u32SuspCycle) << SPI_CTL_SUSPITV_Pos) & SPI_CTL_SUSPITV_Msk)
...
/**
  ...
  */
#define I2S_ENABLE_TX_ZCD(i2s, u32ChMask)           \
    do {                                            \
...
/**
  ...
  */
#define I2S_DISABLE_TX_ZCD(i2s, u32ChMask)          \
    do {                                            \
        if (u32ChMask == I2S_RIGHT)                 \
        {                                           \
            (i2s)->I2SCTL &= ~SPI_I2SCTL_RZCEN_Msk; \
...
/**
  ...
  * @param[in] i2s The pointer of the specified I2S module.
  * @param[in] u32Ch right or left channel. Valid values are:
  *                - \ref I2S_MONO_RIGHT
  *                - \ref I2S_MONO_LEFT

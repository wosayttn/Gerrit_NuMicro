 ...
 */
#define GPIO_SET_DEBOUNCE_ICLKON(port)  (GPIO->DBCTL |= (0x1UL << (((((uint32_t)(port) - (uint32_t)GPIO_BASE) / 0x40UL) + 16UL))))
 ...
 */
#define GPIO_CLR_DEBOUNCE_ICLKON(port)  (GPIO->DBCTL &= ~(0x1UL << (((((uint32_t)(port) - (uint32_t)GPIO_BASE) / 0x40UL) + 16UL))))

 ...
 * @file     gpio.h
 * @version  V1.00
 * @brief    M2003J series GPIO driver header file
 *
...
#define GPIO_DBCTL_DBCLKSRC_LIRC    GPIO_DBCTL_DBCLKSRC_Msk /*!< GPIO_DBCTL setting for de-bounce counter clock source is the internal 32 kHz \hideinitializer */
 ...
 * @return      None
 *
 * @details     Toggle the specified GPIO pin.
 * \hideinitializer
 */

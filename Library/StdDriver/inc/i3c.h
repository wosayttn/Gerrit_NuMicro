...
/*---------------------------------------------------------------------------------------------------------*/
#define I3C_DEVTYPE_I2C                     (0x1UL) /*!< Target Device Type is I2C slave */
#define I3C_DEVTYPE_I3C                     (0x0UL) /*!< Target Device Type is I3C slave */
...
/*---------------------------------------------------------------------------------------------------------*/
#define I3C_IBI_TYPE_SIR                    (0)
#define I3C_IBI_TYPE_TIR                    (I3C_IBI_TYPE_SIR)
#define I3C_IBI_TYPE_MR                     (1)
#define I3C_IBI_TYPE_CR                     (I3C_IBI_TYPE_MR)
...
#define I3C_TGTRESP_MASTER_TERMINATE_ERR    (10UL << I3C_TGTRESP_ERRSTS_Pos)    /*!< Master early terminal Error */
...
#define I3C_TGTCMDSTS_MASTER_TERMINATE_ERR  (10UL << I3C_TGTCMDW1_ERRSTS_Pos)   /*!< Master early terminal Error */
...
typedef struct
{
    ...
    uint8_t     target_sa[1 + 4];     // target x1 + virtual target x4
    uint8_t     target_da[1 + 4 + 4]; // target x1 + virtual target x4 + group target x4 
    uint8_t     target_index;         // 0:target, 1~4:virtual target 1~4, 1~4:group target 1~4 
    ...
    uint32_t    ibi_status;
    uint32_t    cmd_response;       // Command response    
    uint8_t	    is_last_cmd;

...
#define I3C_CTR_TGT_TABLE_CNT             (7UL) /*!< Target table count in Controller (Target 1 to Target 7) */
#define I3C_MAIN_TGT_CNT                  (1UL) /*!< Main Target count */
#define I3C_VIRTUAL_TGT_CNT               (4UL) /*!< Virtual Target count */
#define I3C_GROUP_TGT_CNT                 (4UL) /*!< Group Target count */
...
#define I3C_CCC_ID(id, broadcast)   \
    ((id) | ((broadcast != 0UL) ? 0UL : I3C_CCC_DIRECT))
...
#define I3C_DEVICE_EXTCMD_CNT               (8UL)   /*!< Maximum Extended Command count of I3C */
...
#define I3C_UNICMD_IDBC_Msk                 (0x7UL << I3C_UNICMD_IDBC_Pos)
...
/*---------------------------------------------------------------------------------------------------------*/
/*  I3C Controller COMMAND_QUEUE_PORT - Transfer Mode and Speed Constant Definitions                       */
/*---------------------------------------------------------------------------------------------------------*/
...
#define I3C_TGTRESP_CONTROLLER_TERMINATE_ERR    (10UL << I3C_TGTRESP_ERRSTS_Pos)    /*!< Controller early termination Error */
...
#define I3C_TGTCMDSTS_CONTROLLER_TERMINATE_ERR  (10UL << I3C_TGTCMDW1_ERRSTS_Pos)   /*!< Controller early termination Error */
...
#define I3C_INTEN_IBI_RECEIVED              (I3C_INTEN_IBITH_Msk)       /*!< Enable IBI buffer threshold interrupt */
...
typedef struct
{
    ...
    uint8_t     target_sa[I3C_CTR_TGT_TABLE_CNT];
    uint8_t     target_da[I3C_MAIN_TGT_CNT + I3C_VIRTUAL_TGT_CNT + I3C_GROUP_TGT_CNT];
    uint8_t     target_index;   // 0:target, 1~4:virtual target 1~4, 5~8:group target 1~4
    uint8_t     target_count;
    uint8_t     target_extcmd;  // extended command 0~7
...
/**
  ...
  */
#define I3C_IS_CONTROLLER(i3c)              (((i3c)->DEVCTLE&I3C_DEVCTLE_OPERMODE_Msk) == I3C_CONTROLLER)
...
/**
  * @brief      Check I2C Static Address is valid
  *
  * @param[in]  i3c    The pointer of the specified I3C module
  *
  ...
  *
  * @details    This macro checks if the I2C Static Address is valid.
  */
...
/**
  * @brief      Check I3C Dynamic Address is valid
  *
  * @param[in]  i3c    The pointer of the specified I3C module
  *
  * @retval     0       I3C Dynamic Address is invalid
  * @retval     1       I3C Dynamic Address is valid
  *
  * @details    This macro checks if the I3C Dynamic Address is valid.
  */
...
__STATIC_INLINE int32_t I3C_Enable(I3C_T *i3c)
{
    ...
    while ((i3c->DEVCTL & I3C_DEVCTL_ENABLE_Msk) != I3C_DEVCTL_ENABLE_Msk)
    {
        if ((--u32Timeout) == 0UL)
        {

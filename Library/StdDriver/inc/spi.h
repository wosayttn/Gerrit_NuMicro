...
/**
  ...
  *             Slave 3-wire mode is only supported on SPI0.
  * \hideinitializer
  */
...
/**
  ...
  */
#define SPII2S_ENABLE_TX_ZCD(i2s, u32ChMask)       \
    do {                                           \
...
/**
  ...
  */
#define SPII2S_DISABLE_TX_ZCD(i2s, u32ChMask)       \
    do {                                            \
        if ((u32ChMask) == SPII2S_RIGHT)            \
        {                                           \
            (i2s)->I2SCTL &= ~SPI_I2SCTL_RZCEN_Msk; \
...
/**
  ...
  * \hideinitializer
  */
#define SPII2S_SET_MONO_RX_CHANNEL(i2s, u32Ch)        \
    do {                                              \

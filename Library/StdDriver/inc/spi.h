...
/* I2S Stereo Order */
#define SPII2S_STEREO_LEFT_HIGH           (0U)                              /*!< Record mono right channel \hideinitializer */
#define SPII2S_STEREO_LEFT_LOW            SPI_I2SCTL_ORDER_Msk              /*!< Record mono left channel \hideinitializer */
...
__STATIC_INLINE void SPII2S_SET_STEREO_LEFT_ORDER(SPI_T *i2s, uint32_t u32Ch);
...
/**
  * @brief  This function sets the stereo data order in FIFO.
  * @param[in] i2s The pointer of the specified I2S module.
  * @param[in] u32Ch left or right channel. Valid values are:
  *                - \ref SPII2S_STEREO_LEFT_HIGH
  *                - \ref SPII2S_STEREO_LEFT_LOW
  * @details This function selects the recording source channel of monaural mode.
  * \hideinitializer
  */
__STATIC_INLINE void SPII2S_SET_STEREO_LEFT_ORDER(SPI_T *i2s, uint32_t u32Ch)
{
    u32Ch == SPII2S_STEREO_LEFT_LOW ?
    ((i2s)->I2SCTL |= SPI_I2SCTL_ORDER_Msk) :
    ((i2s)->I2SCTL &= ~SPI_I2SCTL_ORDER_Msk);
}

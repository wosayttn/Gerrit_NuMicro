...
#define PWM_FB_EDGE_ADCRM                        (PWM_BRKCTL0_1_EADC0EBEN_Msk)     /*!< ADC Result Monitor (ADCRM) as edge-detect fault brake source */
...
#define PWM_FB_LEVEL_ADCRM                       (PWM_BRKCTL0_1_EADC0LBEN_Msk)     /*!< ADC Result Monitor (ADCRM) as level-detect fault brake source */

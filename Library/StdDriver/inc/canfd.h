...
#define CANFD_OP_CAN_MODE     0U
#define CANFD_OP_CAN_FD_MODE  1U
...
#define CANFD_RX_BUFFER_STD(id, mbIdx)               ((7UL << 27) | ((((id)) & 0x7FFUL) << 16) | (((mbIdx)) & 0x3FUL))
...
#define CANFD_RX_FIFO0_STD_MASK(match, mask)         ((2UL << 30) | (1UL << 27) | ((((match)) & 0x7FFUL) << 16) | (((mask)) & 0x7FFUL))

/* CAN FD Rx FIFO 0 extended Mask helper macro - low. */
#define CANFD_RX_FIFO0_EXT_MASK_LOW(match)           ((1UL << 29) | (((match)) & 0x1FFFFFFFUL))

/* CAN FD Rx FIFO 0 extended Mask helper macro - high. */
#define CANFD_RX_FIFO0_EXT_MASK_HIGH(mask)           ((2UL << 30) | (((mask)) & 0x1FFFFFFFUL))

/* CAN FD Rx FIFO 1 Mask helper macro. */
#define CANFD_RX_FIFO1_STD_MASK(match, mask)         ((2UL << 30) | (2UL << 27) | ((((match)) & 0x7FFUL) << 16) | (((mask)) & 0x7FFUL))

/* CANFD Rx FIFO 1 extended Mask helper macro - low. */
#define CANFD_RX_FIFO1_EXT_MASK_LOW(match)           ((2UL << 29) | (((match)) & 0x1FFFFFFFUL))

/* CANFD Rx FIFO 1 extended Mask helper macro - high. */
#define CANFD_RX_FIFO1_EXT_MASK_HIGH(mask)           ((2UL << 30) | (((mask)) & 0x1FFFFFFFUL))

...
/**
  ...
  * \hideinitializer
  */
#define LPTPWM_GET_PERIOD_INT_FLAG(lptmr)     (((lptmr)->PWMINTSTS0 & LPTMR_PWMINTSTS0_PIF_Msk) != 0UL ? 1UL : 0UL)
...
/**
  ...
  * \hideinitializer
  */
#define LPTPWM_GET_CMP_UP_INT_FLAG(lptmr)     (((lptmr)->PWMINTSTS0 & LPTMR_PWMINTSTS0_CMPUIF_Msk) != 0UL ? 1UL : 0UL)
...
/**
  ...
  * \hideinitializer
  */
#define LPTPWM_GET_REACH_MAX_CNT_STATUS(lptmr)    (((lptmr)->PWMSTATUS & LPTMR_PWMSTATUS_CNTMAXF_Msk) != 0UL ? 1UL : 0UL)
...
__STATIC_INLINE uint32_t LPTPWM_GetWakeupFlag(const LPTMR_T *lptmr)
{
    return (((lptmr->PWMSTATUS & LPTMR_PWMSTATUS_PWMINTWKF_Msk) != 0UL) ? 1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LPTPWM_GetAccInt(const LPTMR_T *lptmr)
{
    return (((lptmr)->PWMAINTSTS & LPTMR_PWMAINTSTS_IFAIF_Msk) != 0UL) ? 1UL : 0UL;
}

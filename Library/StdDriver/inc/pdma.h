 ...
 * @file     pdma.h
 * @version  V1.00
 * @brief    M2003J series PDMA driver header file
 *
...
/** @addtogroup PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
#define PDMA_CH_MAX    2UL   /*!< Specify Maximum Channels of PDMA  \hideinitializer */
...
#define PDMA_TMR0        11UL /*!<DMA Connect to TMR0 \hideinitializer */
#define PDMA_TMR1        12UL /*!<DMA Connect to TMR1 \hideinitializer */
#define PDMA_TMR2        13UL /*!<DMA Connect to TMR2 \hideinitializer */
#define PDMA_TMR3        14UL /*!<DMA Connect to TMR3 \hideinitializer */
#define PDMA_TMR4        15UL /*!<DMA Connect to TMR4 \hideinitializer */
#define PDMA_TMR5        16UL /*!<DMA Connect to TMR5 \hideinitializer */
#define PDMA_TMR6        17UL /*!<DMA Connect to TMR6 \hideinitializer */
#define PDMA_TMR7        18UL /*!<DMA Connect to TMR7 \hideinitializer */
#define PDMA_TMR8        19UL /*!<DMA Connect to TMR8 \hideinitializer */
#define PDMA_I2C0_TX     20UL /*!<DMA Connect to I2C0_TX \hideinitializer */
#define PDMA_I2C0_RX     21UL /*!<DMA Connect to I2C0_RX \hideinitializer */
#define PDMA_I2C1_TX     22UL /*!<DMA Connect to I2C1_TX \hideinitializer */
#define PDMA_I2C1_RX     23UL /*!<DMA Connect to I2C1_RX \hideinitializer */
#define PDMA_I2C2_TX     24UL /*!<DMA Connect to I2C2_TX \hideinitializer */
#define PDMA_I2C2_RX     25UL /*!<DMA Connect to I2C2_RX \hideinitializer */
#define PDMA_USCI0_TX    26UL /*!<DMA Connect to USCI0_TX \hideinitializer */
#define PDMA_USCI0_RX    27UL /*!<DMA Connect to USCI0_RX \hideinitializer */
#define PDMA_USCI1_TX    28UL /*!<DMA Connect to USCI1_TX \hideinitializer */
#define PDMA_USCI1_RX    29UL /*!<DMA Connect to USCI1_RX \hideinitializer */
#define PDMA_USCI2_TX    30UL /*!<DMA Connect to USCI2_TX \hideinitializer */
#define PDMA_USCI2_RX    31UL /*!<DMA Connect to USCI2_RX \hideinitializer */
#define PDMA_USCI3_TX    32UL /*!<DMA Connect to USCI3_TX \hideinitializer */
#define PDMA_USCI3_RX    33UL /*!<DMA Connect to USCI3_RX \hideinitializer */
#define PDMA_USCI4_TX    34UL /*!<DMA Connect to USCI4_TX \hideinitializer */
#define PDMA_USCI4_RX    35UL /*!<DMA Connect to USCI4_RX \hideinitializer */
#define PDMA_EINT0       36UL /*!<DMA Connect to EINT0 \hideinitializer */
#define PDMA_EINT1       37UL /*!<DMA Connect to EINT1 \hideinitializer */
#define PDMA_EINT2       38UL /*!<DMA Connect to EINT2 \hideinitializer */
#define PDMA_EINT3       39UL /*!<DMA Connect to EINT3 \hideinitializer */
#define PDMA_EINT4       40UL /*!<DMA Connect to EINT4 \hideinitializer */
#define PDMA_EINT5       41UL /*!<DMA Connect to EINT5 \hideinitializer */
#define PDMA_ADC0_RX     42UL /*!<DMA Connect to ADC0_RX \hideinitializer */

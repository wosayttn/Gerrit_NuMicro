...
//     <o>Base Address <0-0xFFFFFFE0>
*/
#define MPU_INIT_BASE1      0x00000000UL       /* Base address of MPU region 1 */
/*
//     <o>Region Size <0x20-0xFFFFFFFF:0x20>
*/
#define MPU_INIT_SIZE1      0x00100000UL       /* Size of MPU region 1 */
...
*/
#define MPU_INIT_REGION7    0UL
/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define MPU_INIT_BASE7      0x00000000UL       /* Base address of MPU region 7 */
/*
//     <o>Region Size <0x20-0xFFFFFFFF:0x20>
*/
#define MPU_INIT_SIZE7      0x00010000UL       /* Size of MPU region 7 */
#define MPU_INIT_LIMIT7     (MPU_INIT_BASE7 + MPU_INIT_SIZE7 - 1UL)
/*
//    <o>  Memory attribute
//      <0=> Device-nGnRnE
//      <1=> Device-nGnRE
...
//   <q.3> Non-executable
*/
#define MPU_MEM_ACC_ATTR7   0x0UL
/*
//   </h>
*/
/*
//   </e>
*/
#if (MPU_INIT_REGION7 == 1UL) /* Check region config */
    #if ((MPU_INIT_SIZE7 < 32UL) || ((MPU_INIT_SIZE7 % 32UL) != 0UL) || ((MPU_INIT_BASE7 % 32UL) != 0UL))
        #error "MPU region 7 has invalid base address or size config !"
    #endif

    #if (((1UL << MPU_MEM_ATTR7) & (MPU_INIT_MEM_ATTRS)) == 0UL)
...
#define MPU_INIT_REGIONS            ((MPU_INIT_REGION0 << 0UL) | (MPU_INIT_REGION1 << 1UL) | (MPU_INIT_REGION2 << 2UL) | (MPU_INIT_REGION3 << 3UL) | \
                                     (MPU_INIT_REGION4 << 4UL) | (MPU_INIT_REGION5 << 5UL) | (MPU_INIT_REGION6 << 6UL) | (MPU_INIT_REGION7 << 7UL))
...
#define MPU_MEM_ACC_ATTR(i, index)  (((uint32_t)(MPU_MEM_ACC_ATTR##i) >> (uint32_t)(index)) & 0x1UL)

...
#define FMC_MKROM_BASE          0x0F800000UL                            /*!< MKROM base address                 \hideinitializer */
#define FMC_MKROM_SIZE          0x8000UL                                /*!< MKROM Size                         \hideinitializer */
#define FMC_MKROM_END           (FMC_MKROM_BASE + FMC_MKROM_SIZE)       /*!< MKROM end address                  \hideinitializer */

#define FMC_FSST_BASE           0x0F300100UL                            /*!< FSST base address                  \hideinitializer */
#define FMC_FSST_SIZE           0x00000064UL                            /*!< FSST Size                          \hideinitializer */
#define FMC_FSST_END            (FMC_FSST_BASE + FMC_FSST_SIZE)         /*!< FSST end address                   \hideinitializer */
...
#define SOTP_BASE               0x0F320000
#define SOTP_DATA_END           0x0F3203F0
#define SOTP_END                0x0F320400
#define SOTP_SIZE               (SOTP_END - SOTP_BASE)
#define SOTP_MEUREN             0x0F3203F4
#define SOTP_LOCK               0x0F3203F8
#define SOTP_REVOKE             0x0F3203FC
#define SOTP_MEUREN             0x0F3203F4
#define SOTP_LOCK               0x0F3203F8
#define SOTP_REVOKE             0x0F3203FC
...
__STATIC_INLINE uint32_t FMC_ReadDID(void)
{
    ...
    FMC->ISPADDR = 0x00u;                       /* Must keep 0x4 when read PID */
    FMC->ISPTRG = FMC_ISPTRG_ISPGO_Msk;         /* Trigger to start ISP procedure */
    while(FMC->ISPTRG & FMC_ISPTRG_ISPGO_Msk)   /* Waiting for ISP Done */
    {
        if(i32TimeOutCnt-- <= 0)
...
extern int32_t  FMC_Read_64_ECC(uint32_t u32Addr, uint32_t * pu32Data);
extern int32_t  FMC_Read_64_NoECC(uint32_t u32addr, uint32_t au32Data[]);
...
extern int32_t  FMC_Write8Bytes_ECC(uint32_t u32addr, uint32_t u32data0, uint32_t u32data1, uint32_t u32Syndrome);

...
/**
  ...
  *             1 = FIFO is empty
  */
#define DMIC_IS_FIFOEMPTY(dmic)                       (((((dmic)->STATUS) & DMIC_STATUS_EMPTY_Msk) != 0UL) ? 1UL : 0UL)
...
/**
  ...
  *             1 = FIFO is full
  */
#define DMIC_IS_FIFOFULL(dmic)                        ((((dmic)->STATUS) & DMIC_STATUS_FULL_Msk) != 0UL ? 1UL : 0UL)
...
/**
  ...
  */
#define DMIC_IS_FIFODMTH(dmic)                        ((((dmic)->STATUS) & DMIC_STATUS_DMTHIF_Msk) != 0UL ? 1UL : 0UL)
...
/**
  ...
  */
#define DMIC_VAD_IS_ACTIVE(vad)                        (((vad)->STATUS0 & VAD_STATUS0_ACTIVE_Msk) != 0UL ? 1UL : 0UL)
...
__STATIC_INLINE void DMIC_ResetDSP(DMIC_T *dmic)
{
    ...
    u32Delay = SystemCoreClock >> 3UL;

    while ((dmic->CTL & DMIC_CTL_SWRST_Msk) != 0UL)
    {
        if (u32Delay == 0UL)
        {
            break;
...
__STATIC_INLINE void DMIC_VAD_SetBIQCoeff(VAD_T *vad, const DMIC_VAD_BIQ_T *psBIQCoeff)
{
    vad->BIQCTL0 = (vad->BIQCTL0 & ~VAD_BIQCTL0_BIQA1_Msk) | (((uint32_t)psBIQCoeff->u16BIQCoeffA1 << VAD_BIQCTL0_BIQA1_Pos) & VAD_BIQCTL0_BIQA1_Msk);
    vad->BIQCTL0 = (vad->BIQCTL0 & ~VAD_BIQCTL0_BIQA2_Msk) | (((uint32_t)psBIQCoeff->u16BIQCoeffA2 << VAD_BIQCTL0_BIQA2_Pos) & VAD_BIQCTL0_BIQA2_Msk);
    vad->BIQCTL1 = (vad->BIQCTL1 & ~VAD_BIQCTL1_BIQB0_Msk) | (((uint32_t)psBIQCoeff->u16BIQCoeffB0 << VAD_BIQCTL1_BIQB0_Pos) & VAD_BIQCTL1_BIQB0_Msk);
    vad->BIQCTL1 = (vad->BIQCTL1 & ~VAD_BIQCTL1_BIQB1_Msk) | (((uint32_t)psBIQCoeff->u16BIQCoeffB1 << VAD_BIQCTL1_BIQB1_Pos) & VAD_BIQCTL1_BIQB1_Msk);
    vad->BIQCTL2 = (vad->BIQCTL2 & ~VAD_BIQCTL2_BIQB2_Msk) | (((uint32_t)psBIQCoeff->u16BIQCoeffB2 << VAD_BIQCTL2_BIQB2_Pos) & VAD_BIQCTL2_BIQB2_Msk);
}

 ...
 * @file     ellsi.h
 * @version  V3.00
 * @brief    ELLSI driver header file
 *
...
/* ELLSI Mode */
#define ELLSI_MODE_SW                 (0 << ELLSI_CTL_ELLSIMODE_Pos)   /*!< Software mode */
#define ELLSI_MODE_PDMA               (1 << ELLSI_CTL_ELLSIMODE_Pos)   /*!< PDMA mode */

/* ELLSI Output Format */
#define ELLSI_FORMAT_RGB              (0 << ELLSI_CTL_OFDEF_Pos)      /*!< Output RGB format */
#define ELLSI_FORMAT_GRB              (1 << ELLSI_CTL_OFDEF_Pos)      /*!< Output GRB format */

/* ELLSI Idle Output State */
#define ELLSI_IDLE_LOW                (0 << ELLSI_OCTL_IDOS_Pos)      /*!< Idle output low */
#define ELLSI_IDLE_HIGH               (1 << ELLSI_OCTL_IDOS_Pos)      /*!< Idle output high */

/* ELLSI Interrupt Mask */
#define ELLSI_UNDFL_INT_MASK          (0x001)                         /*!< Underflow interrupt mask */
#define ELLSI_FEND_INT_MASK           (0x002)                         /*!< Frame end interrupt mask */
#define ELLSI_RSTC_INT_MASK           (0x004)                         /*!< Reset command interrupt mask */
#define ELLSI_EMP_INT_MASK            (0x008)                         /*!< FIFO empty interrupt mask */
#define ELLSI_FUL_INT_MASK            (0x010)                         /*!< FIFO full interrupt mask */
#define ELLSI_TXTH_INT_MASK           (0x020)                         /*!< TX threshold interrupt mask */
...
/* ELLSI Command Mode */
#define ELLSI_CMDMODE_LLSI            (0x0 << ELLSI_CTL_CMDMODE_Pos)  /*!< LLSI mode */
#define ELLSI_CMDMODE_NORMAL_CMD      (0x1 << ELLSI_CTL_CMDMODE_Pos)  /*!< Normal command mode */
#define ELLSI_CMDMODE_AUTO_SET        (0x2 << ELLSI_CTL_CMDMODE_Pos)  /*!< AUTO SET mode */
#define ELLSI_CMDMODE_AUTO_TH20SET    (0x3 << ELLSI_CTL_CMDMODE_Pos)  /*!< AUTO TH20 SET mode */

/* ELLSI Special Command */
#define ELLSI_SPECMD_NORMAL_CMD       (0x0 << ELLSI_CMD_SPECMD_Pos)   /*!< Normal command or no command */
#define ELLSI_SPECMD_FB_COUNT_CMD     (0x1 << ELLSI_CMD_SPECMD_Pos)   /*!< Feedback count command */
#define ELLSI_SPECMD_FB_ID_CMD        (0x2 << ELLSI_CMD_SPECMD_Pos)   /*!< Feedback ID command */
#define ELLSI_SPECMD_TH20SET_CMD      (0x3 << ELLSI_CMD_SPECMD_Pos)   /*!< TH20 SET command */
#define ELLSI_SPECMD_SEND_DATA        (0x4 << ELLSI_CMD_SPECMD_Pos)   /*!< Send Data */

/* ELLSI Normal Command Mode */
#define ELLSI_CMD_SET_ID              (0x1 << ELLSI_CMD_CMD_Pos)      /*!< Set ID command */
#define ELLSI_CMD_CLR_ID              (0x2 << ELLSI_CMD_CMD_Pos)      /*!< Clear ID command */
#define ELLSI_CMD_CHK_ID              (0x3 << ELLSI_CMD_CMD_Pos)      /*!< Check ID command */
#define ELLSI_CMD_SPE_ID              (0x4 << ELLSI_CMD_CMD_Pos)      /*!< Specify ID command */

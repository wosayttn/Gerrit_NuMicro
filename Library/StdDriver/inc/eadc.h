...
/**
  ...
  * \hideinitializer
  */
#define EADC_ENABLE_INT_POSITION(eadc, u32ModuleNum)     (((u32ModuleNum) < 19) ? ((eadc)->SCTL[(u32ModuleNum)] |= EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19] |= EADC_SCTL19_INTPOS_Msk))
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_INT_POSITION(eadc, u32ModuleNum)   (((u32ModuleNum)< 19) ? ((eadc)->SCTL[(u32ModuleNum)] &= ~EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19] &= ~EADC_SCTL19_INTPOS_Msk))
/**
...
__STATIC_INLINE uint32_t EADC_GET_CONV_DATA(EADC_T *eadc, uint32_t u32ModuleNum)
{
    ...
    return (((u32ModuleNum) < 19) ? ((eadc)->DAT[(u32ModuleNum)] & adc_result_mask) : ((eadc)->DAT19[(u32ModuleNum) -19] & adc_result_mask));
}
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_ENABLE_CMP0(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_pos = 0;

    if (eadc == EADC0)
    {
        adc_cmpdat_pos = EADC_CMP_CMPDAT_Pos;

    }
    else if (eadc == EADC1)
    {
        adc_cmpdat_pos = EADC1_CMP_CMPDAT_Pos;
    }

    return ((eadc)->CMP[0] = (((eadc)->CMP[0] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | EADC_CMP_CMPDAT_Msk | EADC_CMP_CMPMCNT_Msk)) | \
                              (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                               (u32Condition) | \
                               ((u16CMPData) << adc_cmpdat_pos) | \
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_ENABLE_CMP1(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_pos = 0;
    ...
    return ((eadc)->CMP[1] = (((eadc)->CMP[1] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | EADC_CMP_CMPDAT_Msk | EADC_CMP_CMPMCNT_Msk)) | \
                              (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                               (u32Condition) | \
                               ((u16CMPData) << adc_cmpdat_pos) | \
                               (((u32MatchCount) - 1) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_ENABLE_CMP2(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_pos = 0;
    ...
    return ((eadc)->CMP[2] = (((eadc)->CMP[2] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | EADC_CMP_CMPDAT_Msk | EADC_CMP_CMPMCNT_Msk)) | \
                              (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                               (u32Condition) | \
                               ((u16CMPData) << adc_cmpdat_pos) | \
                               (((u32MatchCount) - 1) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_ENABLE_CMP3(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_pos = 0;
    ...
    return ((eadc)->CMP[3] = (((eadc)->CMP[3] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | EADC_CMP_CMPDAT_Msk | EADC_CMP_CMPMCNT_Msk)) | \
                              (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                               (u32Condition) | \
                               ((u16CMPData) << adc_cmpdat_pos) | \
                               (((u32MatchCount) - 1) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  * \hideinitializer
  */
#define EADC_ENABLE_LEFT_ALIGN(eadc, u32ModuleNum)  (((u32ModuleNum) < 19) ? ((eadc)->MCTL1[(u32ModuleNum)] |= EADC_MCTL1_ALIGN_Msk) : ((eadc)->M19CTL1[(u32ModuleNum)-19] |= EADC_M19CTL1_ALIGN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_LEFT_ALIGN(eadc, u32ModuleNum) (((u32ModuleNum) < 19) ? ((eadc)->MCTL1[(u32ModuleNum)] &= (~EADC_MCTL1_ALIGN_Msk)) : ((eadc)->M19CTL1[(u32ModuleNum)-19] &= (~EADC_M19CTL1_ALIGN_Msk)))
...
/**
  ...
  * \hideinitializer
  */
#define EADC_ENABLE_AVG(eadc, u32ModuleNum)         (((u32ModuleNum) < 19) ? ((eadc)->MCTL1[(u32ModuleNum)] |= EADC_MCTL1_AVG_Msk) : ((eadc)->M19CTL1[(u32ModuleNum)-19] |= EADC_M19CTL1_AVG_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_AVG(eadc, u32ModuleNum)        (((u32ModuleNum) < 19) ? ((eadc)->MCTL1[(u32ModuleNum)] &= (~EADC_MCTL1_AVG_Msk)) : ((eadc)->M19CTL1[(u32ModuleNum)-19] &= (~EADC_M19CTL1_AVG_Msk)))
...
#define EADC_ENABLE_ACU(eadc,\
                        ...
                        u16ACUNum)  (((u32ModuleNum)<19) ? \
                                     ...
                                     (((eadc)->M19CTL1[(u32ModuleNum)-19]) = ((((eadc)->M19CTL1[(u32ModuleNum)-19]) & (~EADC_M19CTL1_ACU_Msk)) | (u16ACUNum)))   \
                                    )
...
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_ACU(eadc, u32ModuleNum)    (((u32ModuleNum) < 19) ? ((eadc)->MCTL1[(u32ModuleNum)] &= (~EADC_MCTL1_ACU_Msk)) : ((eadc)->M19CTL1[(u32ModuleNum)-19] &= (~EADC_M19CTL1_ACU_Msk)))

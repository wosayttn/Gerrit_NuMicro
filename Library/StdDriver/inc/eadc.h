...
/**
  ...
  * @details    This STPFn (n=0~26) bit remains 1 during pending state, when the respective EADC conversion is end,
 ...
 *
 *    @param[in]    eadc    The pointer of the specified EADC module
 *    @param[in]    u32ModuleMask   The combination of data overrun status bits. Each bit corresponds to a data valid status, valid range are between 1~0x7FFFFFF.
 *    @return       Return the data valid flag of the user-specified sample module.
 *
...
#endif
    return ((eadc)->DDAT[(u32ModuleNum)] & EADC_DDAT_RESULT_Msk);
}
...
/**
  ...
  * @details    The STOVF bit will keep 1 when any one of sample module event overrun flag SPOVFn (n=0~26) is set to 1.
  * \hideinitializer
  */

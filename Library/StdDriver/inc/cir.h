...
/* CIR Patterns */
#define CIR_HEADER_PAT                  (0UL)                                           /*!< Header Patern                                                          \hideinitializer */ 
#define CIR_DATA0_PAT                   (1UL)                                           /*!< Data0 Patern                                                           \hideinitializer */
#define CIR_DATA1_PAT                   (2UL)                                           /*!< Data1 Patern                                                           \hideinitializer */
#define CIR_SPECIAL_PAT                 (3UL)                                           /*!< Special Patern                                                         \hideinitializer */
#define CIR_END_PAT                     (4UL)                                           /*!< End Patern                                                             \hideinitializer */

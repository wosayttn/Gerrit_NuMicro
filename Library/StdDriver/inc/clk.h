 ...
 * @file     CLK.h
 * @version  V1.00
 * @brief    M3351 Series CLK Driver Header File
 *
...
#define CLK_CLKSEL1_CLKOSEL_USB_SOF      (0x6UL << CLK_CLKSEL1_CLKOSEL_Pos)         /*!< Select CLKO clock source from USB SOF \hideinitializer */
...
#define CLK_PLLCTL_STBSEL_2400          (0x0UL<<CLK_PLLCTL_STBSEL_Pos)      /*!< PLL stable time is 2400 PLL source clock (suitable for source clock equal to or less than 12 MHz) */
#define CLK_PLLCTL_STBSEL_6400          (0x1UL<<CLK_PLLCTL_STBSEL_Pos)      /*!< PLL stable time is 6400 PLL source clock (suitable for source clock greater than 12 MHz) */
...
#define TRACE_MODULE   (MODULE_APBCLK_ENC( 0UL)|MODULE_IP_EN_Pos_ENC((uint32_t)CLK_AHBCLK0_TRACECKEN_Pos)|\
                        MODULE_CLKSEL_ENC(  NA)|MODULE_CLKSEL_Msk_ENC(NA)|MODULE_CLKSEL_Pos_ENC(NA)|\
                        MODULE_CLKDIV_ENC( 1UL)|MODULE_CLKDIV_Msk_ENC(0xFFUL)|MODULE_CLKDIV_Pos_ENC(24UL))  /*!< TRACE Module */
...
#define CLK_PMUCTL_PDMSEL_LLSPD       (0x5UL << CLK_PMUCTL_PDMSEL_Pos)        /*!< Select power down mode is Deep Power-down mode \hideinitializer */
...
#define CLK_SPDSRETSEL_64K          (0x1UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 64K SRAM retention when chip enter SPD mode \hideinitializer */
#define CLK_SPDSRETSEL_192K         (0x2UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 192K SRAM retention when chip enter SPD mode \hideinitializer */
#define CLK_SPDSRETSEL_320K         (0x3UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 320K SRAM retention when chip enter SPD mode \hideinitializer */
...
void CLK_EnableWKPin(uint32_t u32TriggerType);

...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKDIV0_HCLK(x)  (((x)-1U) << CLK_CLKDIV0_HCLKDIV_Pos)      /*!< CLKDIV Setting for HCLK clock divider. It could be 1~16 */
#define CLK_CLKDIV0_UART0(x) (((x)-1U) << CLK_CLKDIV0_UART0DIV_Pos)     /*!< CLKDIV Setting for UART clock divider. It could be 1~16 */
#define CLK_CLKDIV0_UART1(x) (((x)-1U) << CLK_CLKDIV0_UART1DIV_Pos)     /*!< CLKDIV Setting for UART clock divider. It could be 1~16 */
#define CLK_CLKDIV0_EADC(x)  (((x)-1U) << CLK_CLKDIV0_EADCDIV_Pos)      /*!< CLKDIV Setting for EADC clock divider. It could be 1~256 */

/*---------------------------------------------------------------------------------------------------------*/
/*  CLKDIV4 constant definitions.                                                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKDIV4_UART2(x) (((x)-1U) << CLK_CLKDIV4_UART2DIV_Pos)     /*!< CLKDIV Setting for UART clock divider. It could be 1~16 */
#define CLK_CLKDIV4_UART3(x) (((x)-1U) << CLK_CLKDIV4_UART3DIV_Pos)     /*!< CLKDIV Setting for UART clock divider. It could be 1~16 */
#define CLK_CLKDIV4_UART4(x) (((x)-1U) << CLK_CLKDIV4_UART4DIV_Pos)     /*!< CLKDIV Setting for UART clock divider. It could be 1~16 */
#define CLK_CLKDIV4_CANFD0(x) (((x)-1U) << CLK_CLKDIV4_CANFD0DIV_Pos)   /*!< CLKDIV Setting for CANFD0 clock divider. It could be 1~4 */
...
#define MODULE_APBCLK(x)        ((((uint32_t)(x)) >> 30UL) & 0x3UL)    /*!< Calculate AHBCLK/APBCLK offset on MODULE index, 0x0:AHBCLK, 0x1:APBCLK0, 0x2:APBCLK1 */
#define MODULE_CLKSEL(x)        ((((uint32_t)(x)) >> 28UL) & 0x3UL)    /*!< Calculate CLKSEL offset on MODULE index, 0x0:CLKSEL0, 0x1:CLKSEL1, 0x2:CLKSEL2, 0x3:CLKSEL3 */
#define MODULE_CLKSEL_Msk(x)    ((((uint32_t)(x)) >> 25UL) & 0x7UL)    /*!< Calculate CLKSEL mask offset on MODULE index */
#define MODULE_CLKSEL_Pos(x)    ((((uint32_t)(x)) >> 20UL) & 0x1FUL)   /*!< Calculate CLKSEL position offset on MODULE index */
#define MODULE_CLKDIV(x)        ((((uint32_t)(x)) >> 18UL) & 0x3UL)    /*!< Calculate APBCLK CLKDIV on MODULE index, 0x0:CLKDIV, 0x1:CLKDIV1, 0x2:CLKDIV3, 0x3:CLKDIV4 */
#define MODULE_CLKDIV_Msk(x)    ((((uint32_t)(x)) >> 10UL) & 0xFFUL)   /*!< Calculate CLKDIV mask offset on MODULE index */
#define MODULE_CLKDIV_Pos(x)    ((((uint32_t)(x)) >> 5UL) & 0x1FUL)    /*!< Calculate CLKDIV position offset on MODULE index */
#define MODULE_IP_EN_Pos(x)     ((((uint32_t)(x)) >> 0UL) & 0x1FUL)    /*!< Calculate APBCLK offset on MODULE index */
#define MODULE_NoMsk            0x0UL                                  /*!< Not mask on MODULE index */
#define NA                      MODULE_NoMsk          /*!< Not Available */

#define MODULE_APBCLK_ENC(x)        ((((uint32_t)(x)) & 0x03UL) << 30UL)   /*!< MODULE index, 0x0:AHBCLK, 0x1:APBCLK0, 0x2:APBCLK1 */
#define MODULE_CLKSEL_ENC(x)        ((((uint32_t)(x)) & 0x03UL) << 28UL)   /*!< CLKSEL offset on MODULE index, 0x0:CLKSEL0, 0x1:CLKSEL1, 0x2:CLKSEL2, 0x3:CLKSEL3 */
#define MODULE_CLKSEL_Msk_ENC(x)    ((((uint32_t)(x)) & 0x07UL) << 25UL)   /*!< CLKSEL mask offset on MODULE index */
#define MODULE_CLKSEL_Pos_ENC(x)    ((((uint32_t)(x)) & 0x1FUL) << 20UL)   /*!< CLKSEL position offset on MODULE index */
#define MODULE_CLKDIV_ENC(x)        ((((uint32_t)(x)) & 0x03UL) << 18UL)   /*!< APBCLK CLKDIV on MODULE index, 0x0:CLKDIV0, 0x1:CLKDIV1, 0x2:CLKDIV3, 0x3:CLKDIV4*/
#define MODULE_CLKDIV_Msk_ENC(x)    ((((uint32_t)(x)) & 0xFFUL) << 10UL)   /*!< CLKDIV mask offset on MODULE index */
#define MODULE_CLKDIV_Pos_ENC(x)    ((((uint32_t)(x)) & 0x1FUL) <<  5UL)   /*!< CLKDIV position offset on MODULE index */
#define MODULE_IP_EN_Pos_ENC(x)     ((((uint32_t)(x)) & 0x1FUL) <<  0UL)   /*!< AHBCLK/APBCLK offset on MODULE index */

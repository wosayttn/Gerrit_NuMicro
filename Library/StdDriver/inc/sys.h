 ...
 * @file     SYS.h
 * @version  V1.00
 * @brief    M3351 Series SYS Driver Header File
 *
...
#define UART8_RST           ((4UL<<24) | SYS_IPRST1_UART8RST_Pos)       /*!< Reset UART8 \hideinitializer */
#define UART9_RST           ((4UL<<24) | SYS_IPRST1_UART9RST_Pos)       /*!< Reset UART9 \hideinitializer */
...
#define DAC0_RST           	((8UL<<24) | SYS_IPRST2_DAC0RST_Pos)       	/*!< Reset DAC0 \hideinitializer */
#define PWM0_RST           	((8UL<<24) | SYS_IPRST2_PWM0RST_Pos)       	/*!< Reset PWM0 \hideinitializer */
#define PWM1_RST           	((8UL<<24) | SYS_IPRST2_PWM1RST_Pos)       	/*!< Reset PWM1 \hideinitializer */
...
#define UART6_RST           ((8UL<<24) | SYS_IPRST2_UART6RST_Pos)       /*!< Reset UART6 \hideinitializer */
#define UART7_RST           ((8UL<<24) | SYS_IPRST2_UART7RST_Pos)       /*!< Reset UART7 \hideinitializer */
...
#define ELLSI1_RST          ((0x18UL<<24) | SYS_IPRST3_ELLSI1RST_Pos)   /*!< Reset ELLSI1 \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
#define SYS_VREFCTL_VREF_PIN        (0x0UL << SYS_VREFCTL_VREFRSEL_Pos)    /*!< Vref = Vref pin \hideinitializer */
#define SYS_VREFCTL_VREF_1_6V       (0x1UL << SYS_VREFCTL_VREFRSEL_Pos)    /*!< Vref = 1.6V \hideinitializer */
#define SYS_VREFCTL_VREF_2_0V       (0x2UL << SYS_VREFCTL_VREFRSEL_Pos)    /*!< Vref = 2.0V \hideinitializer */
#define SYS_VREFCTL_VREF_2_5V       (0x4UL << SYS_VREFCTL_VREFRSEL_Pos)    /*!< Vref = 2.5V \hideinitializer */
#define SYS_VREFCTL_VREF_3_0V       (0x5UL << SYS_VREFCTL_VREFRSEL_Pos)    /*!< Vref = 3.0V \hideinitializer */

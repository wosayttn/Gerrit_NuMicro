...
#define SYS_RST_REG_ENC(x)    ((((uint32_t)(x)) & 0xFUL) << 24UL)
#define SYS_RST_POS_ENC(x)    (((uint32_t)(x)) & 0x1FUL)

#define PDMA_RST    (SYS_RST_REG_ENC(0UL) | SYS_RST_POS_ENC(SYS_IPRST0_PDMARST_Pos))      /*!< PDMA reset is one of the SYS_ResetModule parameter */
#define CRC_RST     (SYS_RST_REG_ENC(0UL) | SYS_RST_POS_ENC(SYS_IPRST0_CRCRST_Pos))       /*!< CRC reset is one of the SYS_ResetModule parameter */
#define GPIO_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_GPIORST_Pos))      /*!< GPIO reset is one of the SYS_ResetModule parameter */
#define TMR0_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_TMR0RST_Pos))      /*!< TMR0 reset is one of the SYS_ResetModule parameter */
#define TMR1_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_TMR1RST_Pos))      /*!< TMR1 reset is one of the SYS_ResetModule parameter */
#define TMR2_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_TMR2RST_Pos))      /*!< TMR2 reset is one of the SYS_ResetModule parameter */
#define TMR3_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_TMR3RST_Pos))      /*!< TMR3 reset is one of the SYS_ResetModule parameter */
#define I2C0_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_I2C0RST_Pos))      /*!< I2C0 reset is one of the SYS_ResetModule parameter */
#define I2C1_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_I2C1RST_Pos))      /*!< I2C1 reset is one of the SYS_ResetModule parameter */
#define SPI0_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_SPI0RST_Pos))      /*!< SPI0 reset is one of the SYS_ResetModule parameter */
#define UART0_RST   (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_UART0RST_Pos))     /*!< UART0 reset is one of the SYS_ResetModule parameter */
#define UART1_RST   (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_UART1RST_Pos))     /*!< UART1 reset is one of the SYS_ResetModule parameter */
#define UART2_RST   (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_UART2RST_Pos))     /*!< UART2 reset is one of the SYS_ResetModule parameter */
#define UART3_RST   (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_UART3RST_Pos))     /*!< UART3 reset is one of the SYS_ResetModule parameter */
#define UART4_RST   (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_UART4RST_Pos))     /*!< UART4 reset is one of the SYS_ResetModule parameter */
#define CANFD0_RST  (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_CANFD0RST_Pos))    /*!< CANFD0 reset is one of the SYS_ResetModule parameter */
#define USBD_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_USBDRST_Pos))      /*!< USBD reset is one of the SYS_ResetModule parameter */
#define EADC_RST    (SYS_RST_REG_ENC(4UL) | SYS_RST_POS_ENC(SYS_IPRST1_EADCRST_Pos))      /*!< EADC reset is one of the SYS_ResetModule parameter */
#define USCI0_RST   (SYS_RST_REG_ENC(8UL) | SYS_RST_POS_ENC(SYS_IPRST2_USCI0RST_Pos))     /*!< USCI0 reset is one of the SYS_ResetModule parameter */
#define BPWM0_RST   (SYS_RST_REG_ENC(8UL) | SYS_RST_POS_ENC(SYS_IPRST2_BPWM0RST_Pos))     /*!< BPWM0 reset is one of the SYS_ResetModule parameter */

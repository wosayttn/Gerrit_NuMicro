...
static inline void PSIO_SET_INTCTL(PSIO_T *psio, uint32_t u32SC, uint32_t u32Int, uint32_t u32Slot)
{
    ...
    u32Int &= PSIO_INT1;
    u32SlotOffset = u32Int * ((uint32_t)PSIO_INTCTL_CONI1SS_Pos -
                              (uint32_t)PSIO_INTCTL_CONI0SS_Pos);
    u32SCOffset = u32Int * ((uint32_t)PSIO_INTCTL_CONI1SCS_Pos -
...
static inline void PSIO_SWITCH_MODE(PSIO_T *psio, uint32_t u32Pin, uint32_t u32SwPoint, uint32_t u32SwMode, uint32_t u32SwCP)
{
    ...
    u32PinIndex = u32Pin & PSIO_PIN7;
    u32SwPoint &= PSIO_SWITCH_P1;
    u32ModeOffset = u32SwPoint * ((uint32_t)PSIO_GNCT_GENCTL_MODESW1_Pos -
                                  (uint32_t)PSIO_GNCT_GENCTL_MODESW0_Pos);
    u32CpOffset = u32SwPoint * ((uint32_t)PSIO_GNCT_GENCTL_SW1CP_Pos -

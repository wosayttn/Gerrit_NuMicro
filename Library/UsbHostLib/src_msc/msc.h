...
#define MSC_SCLASS_RBC            ((uint8_t)0x01U)   /* Typically, flash devices      */
#define MSC_SCLASS_8020           ((uint8_t)0x02U)   /* CD-ROM                        */
#define MSC_SCLASS_QIC            ((uint8_t)0x03U)   /* QIC-157 Tapes                 */
#define MSC_SCLASS_UFI            ((uint8_t)0x04U)   /* Floppy                        */
#define MSC_SCLASS_8070           ((uint8_t)0x05U)   /* Removable media               */
#define MSC_SCLASS_SCSI           ((uint8_t)0x06U)   /* Transparent                   */

/* Mass Storage Class Sub-protocol */
#define MSC_SPROTO_CBI            ((uint8_t)0x00U)   /* Control/Bulk/Interrupt        */
#define MSC_SPROTO_CB             ((uint8_t)0x01U)   /* Control/Bulk w/o interrupt    */
#define MSC_SPROTO_BULK           ((uint8_t)0x50U)   /* Bulk only                     */
#define MSC_SPROTO_DPCM_USB       ((uint8_t)0xF0U)   /* Combination CB/SDDR09         */

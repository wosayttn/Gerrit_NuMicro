...
extern int usbh_uac2_get_clock_source_id(UAC_DEV_T *uac, uint8_t target);
extern int usbh_uac2_clock_set_freq(UAC_DEV_T *uac, uint8_t target, uint32_t freq);
extern int usbh_uac2_clock_get_freq(UAC_DEV_T *uac, uint8_t target, uint32_t *freq);

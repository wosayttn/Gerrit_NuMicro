 ...
 */
#define REQ_TYPE_OUT                   ((uint8_t)0x00U)
#define REQ_TYPE_IN                    ((uint8_t)0x80U)
/*
 *  bmRequestType[6:5]  - Type
 */
#define REQ_TYPE_STD_DEV               ((uint8_t)0x00U)
#define REQ_TYPE_CLASS_DEV             ((uint8_t)0x20U)
#define REQ_TYPE_VENDOR_DEV            ((uint8_t)0x40U)
/*
 *  bmRequestType[4:0]  - Recipient
 */
#define REQ_TYPE_TO_DEV                ((uint8_t)0x00U)
#define REQ_TYPE_TO_IFACE              ((uint8_t)0x01U)
#define REQ_TYPE_TO_EP                 ((uint8_t)0x02U)
#define REQ_TYPE_TO_OTHER              ((uint8_t)0x03U)
/*
 *  Standard Requests
 */
 ...
 */
#define USB_CLASS_AUDIO                ((uint8_t)0x01U)
#define USB_CLASS_COMM                 ((uint8_t)0x02U)
#define USB_CLASS_HID                  ((uint8_t)0x03U)
#define USB_CLASS_PRINTER              ((uint8_t)0x07U)
#define USB_CLASS_MASS_STORAGE         ((uint8_t)0x08U)
#define USB_CLASS_HUB                  ((uint8_t)0x09U)
#define USB_CLASS_DATA                 ((uint8_t)0x0AU)
#define USB_CLASS_VIDEO                ((uint8_t)0x0EU)

...
extern int32_t  usbh_cdc_send_data(struct cdc_dev_t *cdev, uint8_t *buff, uint32_t buff_len);
...
extern int  usbh_umas_read(int drv_no, uint32_t sec_no, uint16_t sec_cnt, uint8_t *buff);
extern int  usbh_umas_write(int drv_no, uint32_t sec_no, uint16_t sec_cnt, uint8_t *buff);

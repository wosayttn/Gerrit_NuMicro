...
#define UVC_EP_DESC_MIN_LEN     7U           /* USB 2.0 endpoint descriptor minimum length                       */
#define UVC_CS_DESC_MIN_LEN     3U           /* Class-specific descriptor header length                          */
#define UVC_FRAME_DESC_MIN_LEN  26U          /* UVC uncompressed/MJPEG frame descriptor minimum length           */
#define UVC_STILL_DESC_BASE_LEN 5U           /* Still-image descriptor length before size patterns                */

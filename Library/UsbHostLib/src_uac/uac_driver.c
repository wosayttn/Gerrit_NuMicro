...
/**
 * @brief  Disconnect callback: release UAC device resources when the interface is removed.
 *
 * @static_deviation
 ...
 *                       to UAC_DEV_T here is an architectural requirement. The object registered
 *                       to context is created and owned by this driver's own probe flow and

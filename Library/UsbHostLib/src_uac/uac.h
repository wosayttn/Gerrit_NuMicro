...
#define SUBCLS_UNDEFINED              ((uint8_t)0x00U)
#define SUBCLS_AUDIOCONTROL           ((uint8_t)0x01U)
#define SUBCLS_AUDIOSTREAMING         ((uint8_t)0x02U)
#define SUBCLS_MIDISTREAMING          ((uint8_t)0x03U)

/* Audio Interface Protocol Code (A.3)                */
#define PR_PROTOCOL_UNDEFINED         ((uint8_t)0x00U)
#define PR_PROTOCOL_IP_VERSION_02_00  ((uint8_t)0x20U)  /* UAC 2.0 IP version */
...
#define CS_INTERFACE                  ((uint8_t)0x24U)
#define CS_ENDPOINT                   ((uint8_t)0x25U)

/* Audio Class-Specific AC Interface Descriptor Subtypes (A.5) */
#define AC_DESCRIPTOR_UNDEFINED       0x00
#define HEADER                        ((uint8_t)0x01U)
#define INPUT_TERMINAL                ((uint8_t)0x02U)
#define OUTPUT_TERMINAL               ((uint8_t)0x03U)
#define MIXER_UNIT                    0x04
#define SELECTOR_UNIT                 0x05
#define FEATURE_UNIT                  ((uint8_t)0x06U)
...
#define AS_GENERAL                    ((uint8_t)0x01U)
#define FORMAT_TYPE                   ((uint8_t)0x02U)
...
#define UAC_TT_USB_STREAMING        ((uint16_t)0x0101U)  /* A Terminal dealing with a signal carried

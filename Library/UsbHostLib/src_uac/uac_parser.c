...
/**
 * @brief Parse the audio class control interface descriptor.
 * @param[in]  uac  Audio Class device
 * @param[in]  bptr Pointer to the descriptor buffer.
 *
 ...
 * <b>Justification:</b> The validated class-specific descriptor buffer is interpreted
 *                       as the descriptor type selected by bDescriptorSubtype.
 */
...
/**
 * @brief Parse the audio class 2 control interface descriptor.
 *
 * @param[in]  uac  Audio Class device
 * @param[in]  bptr Pointer to the descriptor buffer.
 *
 ...
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> The validated UAC2 descriptor buffer is interpreted as the
 *                       class-specific descriptor type selected by bDescriptorSubtype.
 */
static int  uac2_parse_ac_interface(UAC_DEV_T *uac, uint8_t *bptr)
{
    ...
    switch (((CS_HDR_T *)bptr)->bDescriptorSubtype)
    {
        ...
        case INPUT_TERMINAL:
            ...
            else if ((ac2_itd->wTerminalType & 0x200U) == 0x200U)
            {
                UAC_DBGMSG("MICROPHONE input terminal found, ID=0x%x\n", ac2_itd->bTerminalID);
        ...
        case OUTPUT_TERMINAL:
            ...
            else if ((ac2_otd->wTerminalType & 0x300U) == 0x300U)
            {
                UAC_DBGMSG("SPEAKER output terminal found, ID=0x%x\n", ac2_otd->bTerminalID);
...
/**
 * @brief Set the microphone feature unit.
 * @param[in] uac  Audio Class device
 * @return int  Success or error code
 * @retval 0  Success
 * @retval < 0  Error code indicating failure
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> The validated UAC2 descriptor buffer is interpreted as the
...
/**
 * @brief Parse the audio class streaming interface descriptor.
 *
 * @param[in] asif  Audio Class streaming interface
 * @param[in] bptr  Pointer to the descriptor buffer
 *
 * @return   Success or not.
 * @retval   0  Success
...
/**
 * @brief Parse the audio class 2 streaming interface descriptor.
 *
 * @param[in] asif  Audio Class streaming interface
 * @param[in] bptr  Pointer to the descriptor buffer
 *
...
/**
 * @brief Find the terminal descriptor by terminal ID.
 *
 * @param[in] uac  Audio Class device
 * @param[in] bTerminalID  Terminal ID to find
 *
 * @return Pointer to the terminal descriptor, or USBNULL if not found.
 * @retval  Pointer to the terminal descriptor if found
 * @retval  USBNULL if not found
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> The validated UAC2 descriptor buffer is interpreted as the
 ...
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> The USB configuration buffer is interpreted as the
 *                       validated configuration and interface descriptor
 *                       layouts while parsing an Audio Streaming interface.
 *
 * @static_deviation

...
/**
 * @brief Handle hub status interrupt for the given UTR (USB Transfer Request).
 * @param[in,out] utr Pointer to the UTR structure containing transfer details.
 * @return None.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.5<br>
 * <b>Justification:</b> The transfer-request context is intentionally stored as void *
 *                       and restored as the hub context established for this callback.
 */

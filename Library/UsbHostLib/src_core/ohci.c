...
/**
 * @brief  Abort a pending transfer identified either by its UTR or by an endpoint handle.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.5<br>
 * <b>Justification:</b> EP_INFO_T::hw_pipe is a generic void* handle used by the USB Host
 *                       common framework so different Host Controller drivers (OHCI/EHCI) can
 *                       attach their own hardware Endpoint Descriptor object; casting it back to
 *                       ED_T here is an architectural requirement of this HCD's own hw_pipe
 *                       objects, which it exclusively creates and owns.
 */
...
/// @endcond HIDDEN_SYMBOLS
/**
 * @brief  Submit a control transfer on the OHCI Host Controller.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.5<br>
 * <b>Justification:</b> EP_INFO_T::hw_pipe is a generic void* handle used by the USB Host

 ...
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 10.4<br>
 * <b>Justification:</b> The hardware register mask is compared with the controller's
 *                       zero-valued status representation in this platform register check.
  */
 ...
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 10.1<br>
 * <b>Justification:</b> Legacy controller-state literals are used with vendor register
 *                       bit-position macros to program the defined host-controller state.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 10.4<br>
 * <b>Justification:</b> Legacy controller-state literals are compared with vendor register
 *                       bit fields whose essential types are fixed by the hardware API.
 *
 * @static_deviation

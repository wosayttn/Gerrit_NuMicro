...
/**
 * @brief  Parse CDC class-specific interface descriptors.
 * @param[in] cdev   The CDC device to be parsed.
 * @param[in] buffer Pointer to the descriptor buffer.
 *
 * @return   The number of bytes parsed from the descriptor buffer.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> USB configuration descriptors are traversed from a
 *                       common header and converted to their CDC-specific
 *                       layout only after the descriptor type is validated.
 */
...
/**
 * @brief  Parse the configuration descriptors of a CDC device.
 * @param[in] cdev   The CDC device to be parsed.
 ...
 * <b>Rule:</b>          MISRA C:2012 Rule 11.3<br>
 * <b>Justification:</b> USB configuration descriptors are traversed from a
 *                       common header and converted to their validated
 *                       configuration or interface layout before use.
 */

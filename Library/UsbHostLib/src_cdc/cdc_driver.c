...
/**
 * @brief  Allocate a CDC device instance.
 * @return   Pointer to the allocated CDC device instance, or USBNULL if allocation failed.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.5<br>
 * <b>Justification:</b> The USB host memory allocator returns void * for
 *                       generic pool management; this function restores the
 *                       allocated CDC device type.
 */
static CDC_DEV_T *alloc_cdc_device(void)
{
    ...
    cdev = (CDC_DEV_T *)usbh_alloc_mem((int32_t)sizeof(CDC_DEV_T));
...
{
    (void)usbh_free_mem(cdev, (int32_t)sizeof(CDC_DEV_T));
}
...
/**
 * @brief  Disconnect a CDC interface.
 * @param[in] iface   The interface to be disconnected.
 *
 * @static_deviation
 * <b>Rule:</b>          MISRA C:2012 Rule 11.5<br>
 * <b>Justification:</b> Interface context is stored as void * by the generic
 *                       USB host layer; this function restores the CDC device
 *                       type before releasing its resources.
 */

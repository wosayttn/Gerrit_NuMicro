...
/**
  ...
  * <b>Justification:</b> `remove` is a standard C library I/O hook required by the
  * IAR C runtime retargeting interface. It is defined with external linkage as part
  * of the toolchain low-level I/O conventions without a prior local header declaration.
  *
  * @static_deviation
  * <b>Rule:</b> MISRA C:2012 Rule 21.2<br>
  * <b>Justification:</b> `remove` is a reserved C standard library identifier implemented
  * as a dummy stub in the IAR low-level I/O retargeting interface to satisfy linker dependencies.
  */

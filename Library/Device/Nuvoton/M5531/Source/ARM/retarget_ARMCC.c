...
/**
  ...
  * <b>Justification:</b> Standard I/O device names and `_sys_*` retargeting functions
  * are defined with external linkage as required by the ARM C library (ARMCC/Arm Compiler)
  * low-level I/O retargeting interface specification. Their prototypes and linkage are part
  * of the toolchain C runtime convention and cannot be made static.
  */
...
/**
  ...
  * <b>Justification:</b> snprintf is used to format the termination exit code into a
  * bounded buffer for debug UART output in the C runtime exit handler. This standard
  * I/O usage is confined to the retargeting layer for diagnostics upon program termination.
  */
/* cppcheck-suppress misra-c2012-8.4 */
 ...
 * @static_deviation
 * <b>Rule:</b> MISRA C:2012 Rule 8.4<br>
 * <b>Justification:</b> `_ttywrch` is a standard ARM C library retarget hook for console
 *                      output defined with external linkage as required by the ARM C runtime.
 */
/* cppcheck-suppress misra-c2012-8.4 */

...
typedef struct
{
     ...
     * |        |          |0110 = L6 mode.
     * |        |          |0111 = L7 mode.
     * |        |          |1000 = L8 mode. (Default)
     * |        |          |Others = L8 mode.
     * |[5]     |BYPASS    |Bypass Mode Enable Bit
     * |        |          |0 = Internal crystal 32K clock is from 32K oscillator output.
     * |        |          |1 = internal crystal 32K clock is from X32K_IN pin.
     * |        |          |Note: This bit is used for Nuvoton Lab test only, it wonu2019t release to end-customer.
     * |        |          |Must enable LXTEN for LXT32K STB in BYPASS mode.
     ...
     * |[10:9]  |HY        |XTL32K HY Setting
     * |        |          |XTL32K macro interface HY control.
     * |        |          |(GM type comparator hysteresis control)
     * |[22:16] |IC        |XTL32K IC Setting
     * |        |          |XTL32K macro interface IC control. This field only active under GAINTM is set to 1.
     * |[23]    |GAINTM    |XTL32K Gain Test Mode
     * |        |          |0 = XTL32K gain control by fix logic.
     * |        |          |1 = XTL32K gain control by IC & IF.
     * |[30:24] |IC_Turbo  |XTL32K IC Turbo Setting
     * |        |          |XTL32K macro interface IC control. This field only active under GAINTM is set to 1.
     * @var RTC_T::DSTCTL
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[25:24] |ICOMP     |XTL32K ICOMP Setting
     * |        |          |XTL32K macro interface ICOMP control.
     * |        |          |(GM type comparator current control)
     * |[27:26] |RFSEL     |XTL32K RFSEL Setting
     * |        |          |XTL32K macro interface RFSEL control.
     * |        |          |(Select feedback resistor)
     * |[29]    |STEN      |XTL32K STEN Setting
     * |        |          |XTL32K macro interface STEN control.
     * |        |          |(start up control)
     * |[30]    |X32KOFF   |X32K Logic OFF
     * |        |          |0: X32K Logic ON.
     * |        |          |1: X32K Logic OFF.
     * |[31]    |RTCSPEED  |RTC_TIME High Speed Test Mode
     * |        |          |RTC day, hour, min and sec digits speed up x64.
     * |        |          |0 = RTC time with normal speed.
     * |        |          |1 = RTC time with high speed.
     * @var RTC_T::ACCCTL
     * Offset: 0x200  RTC Access Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |TRD       |Time counter of read data
     * |[14:8]  |TWR       |Time Counter Of Write Data
     * |        |          |Note : Minimal Value 0x01 .
     * |[19:16] |RDIV      |PRDATA sampling clock
     * @var RTC_T::VERSION
    ...
    __I  uint32_t RESERVE3[55];
    __IO uint32_t TEST;                  /*!< [0x01f0] RTC Test Control Register                                        */
    __I  uint32_t RESERVE4[3];
    __IO uint32_t ACCCTL;                /*!< [0x0200] RTC Access Control Register                                      */
    __I  uint32_t RESERVE5[894];
...
#define RTC_LXTCTL_HY_Pos                (9)                                               /*!< RTC_T::LXTCTL: HY Position             */
#define RTC_LXTCTL_HY_Msk                (0x3ul << RTC_LXTCTL_HY_Pos)                      /*!< RTC_T::LXTCTL: HY Mask                 */

#define RTC_LXTCTL_IC_Pos                (16)                                              /*!< RTC_T::LXTCTL: IC Position             */
#define RTC_LXTCTL_IC_Msk                (0x7ful << RTC_LXTCTL_IC_Pos)                     /*!< RTC_T::LXTCTL: IC Mask                 */

#define RTC_LXTCTL_GAINTM_Pos            (23)                                              /*!< RTC_T::LXTCTL: GAINTM Position         */
#define RTC_LXTCTL_GAINTM_Msk            (0x1ul << RTC_LXTCTL_GAINTM_Pos)                  /*!< RTC_T::LXTCTL: GAINTM Mask             */

#define RTC_LXTCTL_IC_Turbo_Pos          (24)                                              /*!< RTC_T::LXTCTL: IC_Turbo Position       */
#define RTC_LXTCTL_IC_Turbo_Msk          (0x7ful << RTC_LXTCTL_IC_Turbo_Pos)               /*!< RTC_T::LXTCTL: IC_Turbo Mask           */
...
#define RTC_TEST_ICOMP_Pos               (24)                                              /*!< RTC_T::TEST: ICOMP Position            */
#define RTC_TEST_ICOMP_Msk               (0x3ul << RTC_TEST_ICOMP_Pos)                     /*!< RTC_T::TEST: ICOMP Mask                */

#define RTC_TEST_RFSEL_Pos               (26)                                              /*!< RTC_T::TEST: RFSEL Position            */
#define RTC_TEST_RFSEL_Msk               (0x3ul << RTC_TEST_RFSEL_Pos)                     /*!< RTC_T::TEST: RFSEL Mask                */

#define RTC_TEST_STEN_Pos                (29)                                              /*!< RTC_T::TEST: STEN Position             */
#define RTC_TEST_STEN_Msk                (0x1ul << RTC_TEST_STEN_Pos)                      /*!< RTC_T::TEST: STEN Mask                 */

#define RTC_TEST_X32KOFF_Pos             (30)                                              /*!< RTC_T::TEST: X32KOFF Position          */
#define RTC_TEST_X32KOFF_Msk             (0x1ul << RTC_TEST_X32KOFF_Pos)                   /*!< RTC_T::TEST: X32KOFF Mask              */

#define RTC_TEST_RTCSPEED_Pos            (31)                                              /*!< RTC_T::TEST: RTCSPEED Position         */
#define RTC_TEST_RTCSPEED_Msk            (0x1ul << RTC_TEST_RTCSPEED_Pos)                  /*!< RTC_T::TEST: RTCSPEED Mask             */

#define RTC_ACCCTL_TRD_Pos               (0)                                               /*!< RTC_T::ACCCTL: TRD Position            */
#define RTC_ACCCTL_TRD_Msk               (0xfful << RTC_ACCCTL_TRD_Pos)                    /*!< RTC_T::ACCCTL: TRD Mask                */

#define RTC_ACCCTL_TWR_Pos               (8)                                               /*!< RTC_T::ACCCTL: TWR Position            */
#define RTC_ACCCTL_TWR_Msk               (0x7ful << RTC_ACCCTL_TWR_Pos)                    /*!< RTC_T::ACCCTL: TWR Mask                */

#define RTC_ACCCTL_RDIV_Pos              (16)                                              /*!< RTC_T::ACCCTL: RDIV Position           */
#define RTC_ACCCTL_RDIV_Msk              (0xful << RTC_ACCCTL_RDIV_Pos)                    /*!< RTC_T::ACCCTL: RDIV Mask               */

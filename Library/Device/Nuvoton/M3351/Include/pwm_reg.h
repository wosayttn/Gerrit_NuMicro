 ...
 * |        |          |Note: This bit can be cleared by software writing 1. 
 * @var PWM_T::IFA0
 * Offset: 0x130  PWM Interrupt Flag Accumulator Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var PWM_T::IFA2
 * Offset: 0x138  PWM Interrupt Flag Accumulator Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |IFACNT    |PWM_CHn Interrupt Flag Counter
 ...
 * |        |          |1 = PWM_CHn interrupt flag accumulator Enabled.
 * @var PWM_T::IFA4
 * Offset: 0x140  PWM Interrupt Flag Accumulator Register 4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |IFACNT    |PWM_CHn Interrupt Flag Counter
 ...
 * |        |          |Note: This bit will auto cleared by hardware.
 * @var PWM_T::PBUF
 * Offset: 0x304~0x318  PWM PERIOD0 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var PWM_T::CMPBUF
 * Offset: 0x31C~~0x330  PWM CMPDAT0 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
...
//    __IO uint32_t CLKPSC[3];             /*!< [0x0014~0x001c] PWM Clock Pre-scale Register 0_1                                 */
...
//    __IO uint32_t BRKCTL[3];             /*!< [0x00c8~0x00d0] PWM Brake Edge Detect Control Register 0_1                       */
    ...
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t IFA[6];                  /*!< [0x0130~0x0144] PWM Interrupt Flag Accumulator Register 0                        */
    /// @cond HIDDEN_SYMBOLS
...
//    __I  uint32_t PDMACAP[3];            /*!< [0x0240~0x0248] PWM Capture Channel 01 PDMA Register                             */
    ...
    __IO uint32_t CAPNF[6];                /*!< [0x0258~0x026c] PWM Capture Input Noise Filter Register 0                        */
    __IO uint32_t EXTETCTL[6];             /*!< [0x0270~0x0284] PWM External Event Trigger Control Register 0                    */
    ...
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE13[28];
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t SELFTEST;              /*!< [0x0300] PWM Self-test Mode Enable                                        */
    __I  uint32_t PBUF[6];                 /*!< [0x0304~0x0318] PWM PERIOD0 Buffer                                               */
    __I  uint32_t CMPBUF[6];               /*!< [0x031c~0x0330] PWM CMPDAT0 Buffer                                               */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE14[13];
    /// @endcond //HIDDEN_SYMBOLS
...
#define PWM_BRKCTL_VBSNEBEN_Pos       (6)                                               /*!< PWM_T::BRKCTL: VBSNEBEN Position    */
#define PWM_BRKCTL_VBSNEBEN_Msk       (0x1ul << PWM_BRKCTL_VBSNEBEN_Pos)             /*!< PWM_T::BRKCTL: VBSNEBEN Mask        */
...
#define PWM_BRKCTL_VBSNLBEN_Pos       (14)                                              /*!< PWM_T::BRKCTL: VBSNLBEN Position    */
#define PWM_BRKCTL_VBSNLBEN_Msk       (0x1ul << PWM_BRKCTL_VBSNLBEN_Pos)             /*!< PWM_T::BRKCTL: VBSNLBEN Mask        */
...
#define PWM_BRKCTL_VBSREBEN_Pos       (23)                                              /*!< PWM_T::BRKCTL: VBSREBEN Position    */
#define PWM_BRKCTL_VBSREBEN_Msk       (0x1ul << PWM_BRKCTL_VBSREBEN_Pos)             /*!< PWM_T::BRKCTL: VBSREBEN Mask        */
...
#define PWM_BRKCTL_VBSRLBEN_Pos       (31)                                              /*!< PWM_T::BRKCTL: VBSRLBEN Position    */
#define PWM_BRKCTL_VBSRLBEN_Msk       (0x1ul << PWM_BRKCTL_VBSRLBEN_Pos)             /*!< PWM_T::BRKCTL: VBSRLBEN Mask        */
...
#define PWM_IFA0_IFACNT_Msk              (0xfffful << PWM_IFA0_IFACNT_Pos)                 /*!< PWM_T::IFA0: IFACNT Mask               */
...
#define PWM_IFA2_IFACNT_Msk              (0xfffful << PWM_IFA2_IFACNT_Pos)                 /*!< PWM_T::IFA2: IFACNT Mask               */
...
#define PWM_IFA4_IFACNT_Msk              (0xfffful << PWM_IFA4_IFACNT_Pos)                 /*!< PWM_T::IFA4: IFACNT Mask               */
...
#define PWM_IFACNT_ACUCNT_Pos           (0)                                               /*!< PWM_T::IFACNT: ACUCNT Position        */
#define PWM_IFACNT_ACUCNT_Msk           (0xfffful << PWM_IFACNT_ACUCNT_Pos)              /*!< PWM_T::IFACNT: ACUCNT Mask            */

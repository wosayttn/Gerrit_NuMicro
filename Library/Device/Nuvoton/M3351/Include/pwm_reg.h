...
//    __IO uint32_t BRKCTL4_5;             /*!< [0x00d0] PWM Brake Edge Detect Control Register 4_5                       */
    ...
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t IFA[6];                  /*!< [0x0130~0x0144] PWM Interrupt Flag Accumulator Register 0/2/4                        */
    /// @cond HIDDEN_SYMBOLS
...
//    __I  uint32_t PDMACAP[3];            /*!< [0x0240~0x0248] PWM Capture Channel 01 PDMA Register                             */
    ...
    __I  uint32_t PBUF[6];                 /*!< [0x0304~0x0318] PWM PERIOD0 Buffer 0/2/4                                      */
    __I  uint32_t CMPBUF[6];               /*!< [0x031c~0x0330] PWM CMPDAT0 Buffer 0~5                                        */
} PWM_T;

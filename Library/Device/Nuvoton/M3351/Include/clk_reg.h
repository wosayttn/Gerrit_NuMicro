 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * @var CLK_T::PLLCTL1
 * Offset: 0x44  PLL Control Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |101 = Low leakage Standby Power-down mode is selected (LLSPD).
 * |        |          |110 = Reserved.
 * |        |          |111 = Reserved.
 * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
 ...
 * |        |          |00 = Wake-up pin disabled at Standby Power-down mode.
 * |        |          |01 = Wake-up pin rising edge enabled at Standby Power-down mode.
 * |        |          |10 = Wake-up pin falling edge enabled at Standby Power-down mode.
 * |        |          |11 = Wake-up pin both edge enabled at Standby Power-down mode.
 * |        |          |Note: These bits are write protected. Refer to the SYS_REGLCTL register.
 ...
 * |        |          |This flag indicates that wake-up of chip from Standby Power-down mode was requested by a transition of the WAKEUP pin (GPC.0).
 ...
 * |        |          |This flag indicates that wake-up of chip from Standby Power-down mode was requested by a transition of the WAKEUP pin (PB.0).
 * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
 * |[4]     |PINWK2    |Pin2 Wake-up Flag (Read Only)
 * |        |          |This flag indicates that wake-up of chip from Standby Power-down mode was requested by a transition of the WAKEUP pin (PB.2).
 * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
 * |[5]     |PINWK3    |Pin3 Wake-up Flag (Read Only)
 * |        |          |This flag indicates that wake-up of chip from Standby Power-down mode was requested by a transition of the WAKEUP pin (PB.12).
 * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
 * |[6]     |PINWK4    |Pin4 Wake-up Flag (Read Only)
 * |        |          |This flag indicates that wake-up of chip from Standby Power-down mode was requested by a transition of the WAKEUP pin (PF.6).
 * |        |          |Note: This flag needs to be cleared by setting CLRWK(CLK_PMUSTS[31] when entering SPD mode.
 ...
 * |        |          |When GPIO enters standby power-down mode, all I/O status are hold to keep normal operating status
 * |        |          |After chip is woken up from standby power-down mode, the I/O are still keep hold status until user set this bit to release I/O hold status.
 * |        |          |Note: This bit is auto cleared by hardware.
 * @var CLK_T::PMUINTC
 ...
 */
    ...
    __IO uint32_t PLLCTL1;               /*!< [0x0044] PLL Control Register 1                                           */
...
#define CLK_PLLCTL1_FRDIV_Pos            (16)                                              /*!< CLK_T::PLLCTL1: FRDIV Position         */
#define CLK_PLLCTL1_FRDIV_Msk            (0xffful << CLK_PLLCTL1_FRDIV_Pos)                /*!< CLK_T::PLLCTL1: FRDIV Mask             */

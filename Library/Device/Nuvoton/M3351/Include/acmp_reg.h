...
typedef struct
{
    ...
    * |        |          | MODESEL = 2'b00, NSEL0 load from ROMMAP46[7]
    * |        |          | MODESEL = 2'b01, NSEL0 load from ROMMAP46[23]
    * |        |          | MODESEL = 2'b10, NSEL0 load from ROMMAP47[7]
    * |        |          | MODESEL = 2'b11, NSEL0 load from ROMMAP47[23]
    * |        |          |2
    ...
    * |        |          | MODESEL = 2'b00, PSEL0 load from ROMMAP46[15]
    * |        |          | MODESEL = 2'b01, PSEL0 load from ROMMAP46[31]
    * |        |          | MODESEL = 2'b10, PSEL0 load from ROMMAP47[15]
    * |        |          | MODESEL = 2'b11, PSEL0 load from ROMMAP47[31]
    * |        |          |3
    ...
    * |        |          | MODESEL = 2'b00, NCODE1 load from ROMMAP48[3:0]
    ...
    * |        |          | MODESEL = 2'b00, NSEL1 load from ROMMAP48[7]
    * |        |          | MODESEL = 2'b01, NSEL1 load from ROMMAP48[23]
    * |        |          | MODESEL = 2'b10, NSEL1 load from ROMMAP49[7]
    * |        |          | MODESEL = 2'b11, NSEL1 load from ROMMAP49[23]
    * |        |          |3
    ...
    * |        |          | MODESEL = 2'b00, PSEL1 load from ROMMAP48[15]
    * |        |          | MODESEL = 2'b01, PSEL1 load from ROMMAP48[31]
    * |        |          | MODESEL = 2'b10, PSEL1 load from ROMMAP49[15]
    * |        |          | MODESEL = 2'b11, PSEL1 load from ROMMAP49[31]
    * |        |          |3
    ...
    * |        |          |Note: 1. HYSSEL (ACMP_CTL0[26:24]) = 3'b000. HYSN0 is not from ROMMAP and keep 4'b0000.
    * |        |          | 2. Update HYSN0:
    * |        |          | a.ACMP enable or MODESEL (ACMP_CTL0[29:28]) change or HYSSEL (ACMP_CTL0[26:24]) change.
    * |        |          |1
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b001 from ROMu2026u2026.MAP50[3:0].
    * |        |          |2
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b001 from ROMu2026u2026.MAP51[3:0].
    * |        |          |3
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b010 from ROMu2026u2026.MAP50[11:8].
    * |        |          |4
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b010 from ROMu2026u2026.MAP51[11:8].
    * |        |          |5
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b011 from ROMu2026u2026.MAP50[19:16].
    * |        |          |6
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b011 from ROMu2026u2026.MAP51[19:16].
    * |        |          |7
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b100 from ROMu2026u2026.MAP50[27:24].
    * |        |          |8
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b100 from ROMu2026u2026.MAP51[27:24].
    * |        |          | b. 4'b0000 reload by reset.
    ...
    * |        |          |Note: 1. HYSSEL (ACMP_CTL0[26:24]) = 3'b000. HYSP0 is not from ROMMAP and keep 4'b0000.
    * |        |          | 2. Update HYSP0:
    * |        |          | a.ACMP enable or MODESEL (ACMP_CTL0[29:28]) change or HYSSEL (ACMP_CTL0[26:24]) change.
    * |        |          |1
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b001 from ROMu2026u2026.MAP50[7:4].
    * |        |          |2
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b001 from ROMu2026u2026.MAP51[7:4].
    * |        |          |3
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b010 from ROMu2026u2026.MAP50[15:12].
    * |        |          |4
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b010 from ROMu2026u2026.MAP51[15:12].
    * |        |          |5
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b011 from ROMu2026u2026.MAP50[23:20].
    * |        |          |6
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b011 from ROMu2026u2026.MAP51[23:20].
    * |        |          |7
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL0[26:24])=3'b100 from ROMu2026u2026.MAP50[3128].
    * |        |          |8
    * |        |          |MODESEL (ACMP_CTL0[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL0[26:24])=3'b100 from ROMu2026u2026.MAP51[31:28].
    * |        |          | b. 4'b0000 reload by reset.
    * |        |          | c. Software write register.
    ...
    * |        |          |Note: 1. HYSSEL (ACMP_CTL1[26:24]) = 3'b000. HYSN0 is not from ROMMAP and keep 4'b0000.
    * |        |          | 2. Update HYSN1:
    * |        |          | a.ACMP enable or MODESEL (ACMP_CTL0[29:28]) change or HYSSEL (ACMP_CTL0[26:24]) change.
    * |        |          |1
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b001 from ROMu2026u2026.MAP52[3:0].
    * |        |          |2
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b001 from ROMu2026u2026.MAP53[3:0].
    * |        |          |3
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b010 from ROMu2026u2026.MAP52[11:8].
    * |        |          |4
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b010 from ROMu2026u2026.MAP53[11:8].
    * |        |          |5
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b011 from ROMu2026u2026.MAP52[19:16].
    * |        |          |6
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b011 from ROMu2026u2026.MAP53[19:16].
    * |        |          |7
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b100 from ROMu2026u2026.MAP52[27:24].
    * |        |          |8
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b100 from ROMu2026u2026.MAP53[27:24].
    * |        |          | b. 4'b0000 reload by reset.
    * |        |          | c. Software write register.
    ...
    * |        |          |Note: 1. HYSSEL (ACMP_CTL1[26:24]) = 3'b000. HYSP0 is not from ROMMAP and keep 4'b0000.
    * |        |          | 2. Update HYSP1:
    * |        |          | a.ACMP enable or MODESEL (ACMP_CTL1[29:28]) change or HYSSEL (ACMP_CTL0[26:24]) change.
    * |        |          |1
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b001 from ROMu2026u2026.MAP52[7:4].
    * |        |          |2
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b001 from ROMu2026u2026.MAP53[7:4].
    * |        |          |3
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b010 from ROMu2026u2026.MAP52[15:12].
    * |        |          |4
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b010 from ROMu2026u2026.MAP53[15:12].
    * |        |          |5
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b011 from ROMu2026u2026.MAP52[23:20].
    * |        |          |6
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b011 from ROMu2026u2026.MAP53[23:20].
    * |        |          |7
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b00 or 2'b01 and HYSSEL (ACMP_CTL1[26:24])=3'b100 from ROMu2026u2026.MAP52[3128].
    * |        |          |8
    * |        |          |MODESEL (ACMP_CTL1[29:28])=2'b10 or 2'b11 and HYSSEL (ACMP_CTL1[26:24])=3'b100 from ROMu2026u2026.MAP53[31:28].
    * |        |          | b. 4'b0000 reload by reset.
    * |        |          | c. Software write register.
    * @var ACMP_T::TEST
    ...
    * |        |          |Note: 1.NEGSEL (ACMP_CTL0[6:4]) or NEGSEL (ACMP_CTL1[6:4]) must select to 3'b001 in CRV test mode
    * |        |          | 2.NEGSEL (ACMP_CTL0[6:4]) or NEGSEL (ACMP_CTL1[6:4]) must select to 3'b010 in VBG test mode.
    * |        |          | 3.ACMPEN (ACMP_CTL0[0]) or ACMPEN (ACMP_CTL1[0]) must select to 1'b1 in VBG test mode.
    ...
    */
    ...
    __I  uint32_t CALSTS;                /*!< [0x0014] Analog Comparator Calibration Status Register                    */
    __I  uint32_t RESERVE0[1014];
    __IO uint32_t COFF;                  /*!< [0x0ff0] Analog Comparator Calibration Offset Register                    */
    __IO uint32_t HYSOFF;                /*!< [0x0ff4] Analog Comparator Hysteresis Offset                              */
    __IO uint32_t TEST;                  /*!< [0x0ff8] Analog Comparator Test Mode Control Register                     */
...
#define ACMP_HYSOFF_HYSN0_Pos            (0)                                               /*!< ACMP_T::HYSOFF: HYSN0 Position         */
#define ACMP_HYSOFF_HYSN0_Msk            (0xful << ACMP_HYSOFF_HYSN0_Pos)                  /*!< ACMP_T::HYSOFF: HYSN0 Mask             */

#define ACMP_HYSOFF_HYSP0_Pos            (4)                                               /*!< ACMP_T::HYSOFF: HYSP0 Position         */
#define ACMP_HYSOFF_HYSP0_Msk            (0xful << ACMP_HYSOFF_HYSP0_Pos)                  /*!< ACMP_T::HYSOFF: HYSP0 Mask             */

#define ACMP_HYSOFF_HYSN1_Pos            (8)                                               /*!< ACMP_T::HYSOFF: HYSN1 Position         */
#define ACMP_HYSOFF_HYSN1_Msk            (0xful << ACMP_HYSOFF_HYSN1_Pos)                  /*!< ACMP_T::HYSOFF: HYSN1 Mask             */

#define ACMP_HYSOFF_HYSP1_Pos            (12)                                              /*!< ACMP_T::HYSOFF: HYSP1 Position         */
#define ACMP_HYSOFF_HYSP1_Msk            (0xful << ACMP_HYSOFF_HYSP1_Pos)                  /*!< ACMP_T::HYSOFF: HYSP1 Mask             */
...
#define ACMP_TEST_PDNPAIR0_Pos           (2)                                               /*!< ACMP_T::TEST: PDNPAIR0 Position        */
#define ACMP_TEST_PDNPAIR0_Msk           (0x1ul << ACMP_TEST_PDNPAIR0_Pos)                 /*!< ACMP_T::TEST: PDNPAIR0 Mask            */

#define ACMP_TEST_PDNPAIR1_Pos           (3)                                               /*!< ACMP_T::TEST: PDNPAIR1 Position        */
#define ACMP_TEST_PDNPAIR1_Msk           (0x1ul << ACMP_TEST_PDNPAIR1_Pos)                 /*!< ACMP_T::TEST: PDNPAIR1 Mask            */
...
#define ACMP_TEST_PDPPAIR0_Pos           (10)                                              /*!< ACMP_T::TEST: PDPPAIR0 Position        */
#define ACMP_TEST_PDPPAIR0_Msk           (0x1ul << ACMP_TEST_PDPPAIR0_Pos)                 /*!< ACMP_T::TEST: PDPPAIR0 Mask            */

#define ACMP_TEST_PDPPAIR1_Pos           (11)                                              /*!< ACMP_T::TEST: PDPPAIR1 Position        */
#define ACMP_TEST_PDPPAIR1_Msk           (0x1ul << ACMP_TEST_PDPPAIR1_Pos)                 /*!< ACMP_T::TEST: PDPPAIR1 Mask            */

#define ACMP_TEST_TESTHYSSEL0_Pos        (14)                                              /*!< ACMP_T::TEST: TESTHYSSEL0 Position     */
#define ACMP_TEST_TESTHYSSEL0_Msk        (0x1ul << ACMP_TEST_TESTHYSSEL0_Pos)              /*!< ACMP_T::TEST: TESTHYSSEL0 Mask         */

#define ACMP_TEST_TESTHYSSEL1_Pos        (15)                                              /*!< ACMP_T::TEST: TESTHYSSEL1 Position     */
#define ACMP_TEST_TESTHYSSEL1_Msk        (0x1ul << ACMP_TEST_TESTHYSSEL1_Pos)              /*!< ACMP_T::TEST: TESTHYSSEL1 Mask         */

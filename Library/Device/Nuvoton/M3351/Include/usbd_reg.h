...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |BISTEN    |BIST Mode Enable Bit
     * |        |          |0 = BIST is disabled.
     * |        |          |1 = BIST is enabled begin to perform BIST on selected memory group.
     * |[1]     |FINISH    |BIST Operation Finish
     * |        |          |It indicates the end of the BIST operation.
     * |        |          |0 = When the BIST controller doesnu2019t finish all operation, this bit will keep as low.
     ...
     * |        |          |0 = VBUS de-bounce control enabled .
     * |        |          |1 = VBUS de-bounce control disabled.
     * @var USBD_T::PHYTYPE
     * Offset: 0xAC  USB PHY Type Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |PHYTYPE   |PHY Type Selection Bit
     * |        |          |0 = NUVOTON CR30 PHY.
     * |        |          |1 = OTG PHY.
     * @var USBD_T::VERSION
     ...
     * |        |          |0x04:(Current Sub Version Number)
    ...
    __IO uint32_t PHYTYPE;               /*!< [0x00ac] USB PHY Type Control                                             */
    __I  uint32_t RESERVE4[276];
    USBD_EP_T     EP[23];                /*!< [0x500~0x68c] USB End Point 0 ~ 22 Configuration Register                 */
    __I  uint32_t RESERVE5[611];
...
#define USBD_PHYTYPE_PHYTYPE_Pos         (0)                                               /*!< USBD_T::PHYTYPE: PHYTYPE Position      */
#define USBD_PHYTYPE_PHYTYPE_Msk         (0x1ul << USBD_PHYTYPE_PHYTYPE_Pos)               /*!< USBD_T::PHYTYPE: PHYTYPE Mask          */

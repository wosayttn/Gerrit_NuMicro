...
typedef struct
{
    ...
    * |[4]     |LOOKBACK  |Look Back Control
    * |        |          |Set this bit, the TX and RX are connected.
    * |        |          |0 = Look back control disabled.
    * |        |          |1 = Look back control enabled.
    ...
    * |[2]     |IRDALOOP  |IrDA Loop Control
    * |        |          |0 = IrDA Loop Disable.
    * |        |          |1 = IrDA Loop Enable.
    * |[3]     |RXDEBEN   |RX De-bounce Enable Bit
    * |        |          |0 = RX De-bounce Disable.
    * |        |          |1 = RX De-bounce Enable.
    ...
    * |        |          |Note 2: This bit is valid when FUNCSEL (UART_FUNCSEL[2:0]) is select IrDA function.
    * |[7]     |TPS       |TPS Control
    * |        |          |This control feature is remove. But Read and write is reserved.
    * @var UART_T::ALTCTL
    ...
    * |[5]     |LINAUTO   |LIN Auto Header Control
    * |        |          |0 = LIN Auto Header Disable.
    * |        |          |1 = LIN Auto Header Enable.
    ...
    * |[31]    |OLDDESIGN |Penfing Old Design
    * |        |          |0 = Penfing Old Design Disable.
    * |        |          |1 = Penfing Old Design Enable.
    * @var UART_T::LINCTL
    ...
    * |        |          |If the LINIEN (UART_INTEN[8]) = 1, an interrupt will be generated.
    * |[15]    |LINLBDL   |LIN Length of Break Detect
    * |        |          |0 = Detect Break 11 Bits.
    * |        |          |1 = Detect Break 10 Bits.
    ...
    * |        |          |Note 2: When WKAOTOEN (UART_AUTOCTL[8]) is reset to u20180u2019, Bus Idle Time-out Wake-up event will not wake up the system
    * |        |          |Moreover, Bus Idle Time-out Wake-up event will gate the UART clock off if WKAOTOEN (UART_AUTOCTL[8]) and TRIGEN (UART_AUTOCTL[4]) are both reset to u20180u2019.
    ...
    * |        |          |0x03:(Current Sub Version Number)
...
#define UART_INTEN_ndbgack_Pos          (31)                                              /*!< UART_T::INTEN: ndbgack Position       */
#define UART_INTEN_ndbgack_Msk          (0x1ul << UART_INTEN_ndbgack_Pos)                 /*!< UART_T::INTEN: ndbgack Mask           */
...
#define UART_IRDA_TPS_Pos               (7)                                               /*!< UART_T::IRDA: TPS Position            */
#define UART_IRDA_TPS_Msk               (0x1ul << UART_IRDA_TPS_Pos)                      /*!< UART_T::IRDA: TPS Mask                */
...
#define UART_ALTCTL_LINAUTO_Pos         (5)                                               /*!< UART_T::ALTCTL: LINAUTO Position      */
#define UART_ALTCTL_LINAUTO_Msk         (0x1ul << UART_ALTCTL_LINAUTO_Pos)                /*!< UART_T::ALTCTL: LINAUTO Mask          */
...
#define UART_FUNCSEL_OLDDESIGN_Pos      (31)                                              /*!< UART_T::FUNCSEL: OLDDESIGN Position   */
#define UART_FUNCSEL_OLDDESIGN_Msk      (0x1ul << UART_FUNCSEL_OLDDESIGN_Pos)             /*!< UART_T::FUNCSEL: OLDDESIGN Mask       */
...
#define UART_LINCTL_LINLBDL_Pos         (15)                                              /*!< UART_T::LINCTL: LINLBDL Position      */
#define UART_LINCTL_LINLBDL_Msk         (0x1ul << UART_LINCTL_LINLBDL_Pos)                /*!< UART_T::LINCTL: LINLBDL Mask          */

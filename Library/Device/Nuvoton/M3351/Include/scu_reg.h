...
typedef struct
{
     ...
     * |        |          |Write 1 to set OTG to non-secure state.
     ...
     * |        |          |Note: Write 1 to clear the interrupt flag.
     * |[16]    |HSUSBHIF  |HSUSBD Security Violation Interrupt Status
     * |        |          |0 = No HSUSBH violation interrupt event.
     * |        |          |1 = There is at least a HSUSBH violation interrupt event.
     * |        |          |Note: Write 1 to clear the interrupt flag.
...
#define SCU_PNSSET0_USBH_Pos             (24)                                              /*!< SCU_T::PNSSET0: USBH Position          */
...
#define SCU_PNSSET2_EADC1_Pos            (4)                                               /*!< SCU_T::PNSSET2: EADC1 Position         */
...
#define SCU_PNSSET2_PWM0_Pos             (24)                                              /*!< SCU_T::PNSSET2: EPWM0 Position         */
#define SCU_PNSSET2_PWM0_Msk             (0x1ul << SCU_PNSSET2_PWM0_Pos)                  /*!< SCU_T::PNSSET2: EPWM0 Mask             */

#define SCU_PNSSET2_PWM1_Pos             (25)                                              /*!< SCU_T::PNSSET2: EPWM1 Position         */
#define SCU_PNSSET2_PWM1_Msk             (0x1ul << SCU_PNSSET2_PWM1_Pos)                  /*!< SCU_T::PNSSET2: EPWM1 Mask             */
...
#define SCU_PNSSET5_TRNG_Pos             (24)                                              /*!< SCU_T::PNSSET5: TRNG Position          */

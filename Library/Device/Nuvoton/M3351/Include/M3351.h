...
#include "partition_M3351_template.h"         /* User defined setup for Secure/Non-Secure Zones */
#include "mpu_config_M3351_template.h"        /* User defined setup for MPU regions */
...
#if defined (SCU_INIT_PNSSET0_VAL) && (SCU_INIT_PNSSET0_VAL & BIT15 )
# define DFMC DFMC_NS
#else
# define DFMC DFMC_S
#endif
...
#if defined (SCU_INIT_PNSSET2_VAL) && (SCU_INIT_PNSSET2_VAL & BIT11 )
...
#if defined (SCU_INIT_PNSSET3_VAL) && (SCU_INIT_PNSSET3_VAL & BIT22)
# define UART6 UART6_NS
#else
# define UART6 UART6_S
#endif

#if defined (SCU_INIT_PNSSET3_VAL) && (SCU_INIT_PNSSET3_VAL & BIT23)
# define UART7 UART7_NS
#else
# define UART7 UART7_S
#endif

#if defined (SCU_INIT_PNSSET3_VAL) && (SCU_INIT_PNSSET3_VAL & BIT24)
# define UART8 UART8_NS
#else
# define UART8 UART8_S
#endif

#if defined (SCU_INIT_PNSSET3_VAL) && (SCU_INIT_PNSSET3_VAL & BIT25)
...
#if defined (SCU_INIT_PNSSET4_VAL) && (SCU_INIT_PNSSET4_VAL & BIT11 )

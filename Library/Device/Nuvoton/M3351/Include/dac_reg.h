 ...
 * |        |          |1000 = PWM0 trigger.
 * |        |          |1001 = PWM1 trigger.
 * |[9]     |TENBITEN  |10-bit Mode Enable Bit
 * |        |          |0 = 12 bit mode.
 * |        |          |1 = 10 bit mode. 
 ...
 * @var DAC_T::CGCTL
 * Offset: 0xFE4  DAC0 Current Generator Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[9:8]   |BIASTRIM  |DAC Current Generator Bias Trim Bits
 * |        |          |00 = 13uA.
 * |        |          |01 = 26uA.
 * |        |          |10 = 39uA.
 * |        |          |11 = 52uA.
 * @var DAC_T::FPGA_DATAIN
 * Offset: 0xFEC  FPGA DAC7641 DAC0 16 bit data
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |DAC_FPGA_DATAIN|DAC FPGA DAC7641 Data
 * |        |          |Software read this register to get current 16 bit digital data in DAC7641.
 * |        |          |Note: This register is used for FPGA test only.
 * @var DAC_T::TEST
 * Offset: 0xFF0  DAC0 Test Mode Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |RDACEN    |DAC Enable Bar
 * |        |          |0 = RDAC Enabled.
 * |        |          |1 = RDAC Disabled for output buffer test.
 * |        |          |N ote: It is used for Nuvoton Lab test only, for detail operation please refer to DAC design report from Sankalp.
 * |[1]     |BUFTESTEN |DAC Output Buffer Test Mode Enable Bit
 * |        |          |0 = Buffer test mode Disabled.
 * |        |          |1 = Buffer test mode Enabled.
 * |        |          |Note: It is used for Nuvoton Lab test only, for detail operation please refer to DAC design report from Sankalp
 * @var DAC_T::VERSION
 * Offset: 0xFFC  DAC Design Version Number
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |MINOR     |DAC RTL Design MINOR Version Number
 * |        |          |Minor version number is dependent on ECO version control
 * |        |          |0x0000: (current Minor Version Number)
 * |[23:16] |SUB       |DAC RTL Design MINOR Version Number
 * |        |          |Sub version number is relative to key feature
 * |        |          |0x01: (current Sub Version Number)
 * |[31:24] |MAJOR     |DAC RTL Design MAJOR Version Number
 ...
 */
    ...
    __I  uint32_t RESERVE0[1011];
    __IO uint32_t CGCTL;                 /*!< [0x0fe4] DAC0 Current Generator Control Register                          */
    __I  uint32_t RESERVE1[1];
    __I  uint32_t FPGA_DATAIN;           /*!< [0x0fec] FPGA DAC7641 DAC0 16 bit data                                    */
    __IO uint32_t TEST;                  /*!< [0x0ff0] DAC0 Test Mode Register                                          */
    __I  uint32_t RESERVE2[2];
    __I  uint32_t VERSION;               /*!< [0x0ffc] DAC Design Version Number                                        */
...
#define DAC_CTL_TENBITEN_Pos             (9)                                               /*!< DAC_T::CTL: TENBITEN Position          */
#define DAC_CTL_TENBITEN_Msk             (0x1ul << DAC_CTL_TENBITEN_Pos)                   /*!< DAC_T::CTL: TENBITEN Mask              */
...
#define DAC_CGCTL_BIASTRIM_Pos           (8)                                               /*!< DAC_T::CGCTL: BIASTRIM Position        */
#define DAC_CGCTL_BIASTRIM_Msk           (0x3ul << DAC_CGCTL_BIASTRIM_Pos)                 /*!< DAC_T::CGCTL: BIASTRIM Mask            */

#define DAC_FPGA_DATAIN_DAC_FPGA_DATAIN_Pos (0)                                            /*!< DAC_T::FPGA_DATAIN: DAC_FPGA_DATAIN Position*/
#define DAC_FPGA_DATAIN_DAC_FPGA_DATAIN_Msk (0xfffful << DAC_FPGA_DATAIN_DAC_FPGA_DATAIN_Pos) /*!< DAC_T::FPGA_DATAIN: DAC_FPGA_DATAIN Mask*/

#define DAC_TEST_RDACEN_Pos              (0)                                               /*!< DAC_T::TEST: RDACEN Position           */
#define DAC_TEST_RDACEN_Msk              (0x1ul << DAC_TEST_RDACEN_Pos)                    /*!< DAC_T::TEST: RDACEN Mask               */

#define DAC_TEST_BUFTESTEN_Pos           (1)                                               /*!< DAC_T::TEST: BUFTESTEN Position        */
#define DAC_TEST_BUFTESTEN_Msk           (0x1ul << DAC_TEST_BUFTESTEN_Pos)                 /*!< DAC_T::TEST: BUFTESTEN Mask            */

#define DAC_VERSION_MINOR_Pos            (0)                                               /*!< DAC_T::VERSION: MINOR Position         */
#define DAC_VERSION_MINOR_Msk            (0xfffful << DAC_VERSION_MINOR_Pos)               /*!< DAC_T::VERSION: MINOR Mask             */

#define DAC_VERSION_SUB_Pos              (16)                                              /*!< DAC_T::VERSION: SUB Position           */
#define DAC_VERSION_SUB_Msk              (0xfful << DAC_VERSION_SUB_Pos)                   /*!< DAC_T::VERSION: SUB Mask               */

#define DAC_VERSION_MAJOR_Pos            (24)                                              /*!< DAC_T::VERSION: MAJOR Position         */
#define DAC_VERSION_MAJOR_Msk            (0xfful << DAC_VERSION_MAJOR_Pos)                 /*!< DAC_T::VERSION: MAJOR Mask             */

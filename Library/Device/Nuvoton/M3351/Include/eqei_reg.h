...
typedef struct
{
     ...
     * |        |          |Note: This bit is only cleared by writing 1 to it.
     * @var EQEI_T::VERSION
     * Offset: 0xFFC  EQEI RTL Design Version Number
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MINOR     |EQEI RTL Design MINOR Version Number
     * |        |          |Minor version number is dependent on ECO version control
     * |        |          |0x0000: (current Minor Version Number)
     * |[23:16] |SUB       |EQEI RTL Design MINOR Version Number
     * |        |          |Sub version number is relative to key feature
     * |        |          |0x01: (current Sub Version Number)
     * |[31:24] |MAJOR     |EQEI RTL Design MAJOR Version Number
    ...
    __I  uint32_t VERSION;               /*!< [0x0ffc] EQEI RTL Design Version Number                                   */
...
#define EQEI_VERSION_MINOR_Pos           (0)                                               /*!< EQEI_T::VERSION: MINOR Position        */
#define EQEI_VERSION_MINOR_Msk           (0xfffful << EQEI_VERSION_MINOR_Pos)              /*!< EQEI_T::VERSION: MINOR Mask            */

#define EQEI_VERSION_SUB_Pos             (16)                                              /*!< EQEI_T::VERSION: SUB Position          */
#define EQEI_VERSION_SUB_Msk             (0xfful << EQEI_VERSION_SUB_Pos)                  /*!< EQEI_T::VERSION: SUB Mask              */

#define EQEI_VERSION_MAJOR_Pos           (24)                                              /*!< EQEI_T::VERSION: MAJOR Position        */
#define EQEI_VERSION_MAJOR_Msk           (0xfful << EQEI_VERSION_MAJOR_Pos)                /*!< EQEI_T::VERSION: MAJOR Mask            */

 ...
 * |        |          |Setting this bit to 1 will generate a reset signal to the SPI2 controller
 * |        |          |User needs to set this bit to 0 to release from reset state.
 ...
 * Offset: 0xC4  System SRAM Secure ECC Error Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * Offset: 0xC8  System SRAM Secure ECC Check Error Address Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var SYS_T::SRAM_PMU
 * Offset: 0xCC  System SRAM SPD mode retention control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |Bank0     |BANK0 Retention Control
 * |        |          |1:SPD mode Retention
 * |        |          |0:SPD mode non Retention
 * |[1]     |Bank1     |BANK1 Retention Control
 * |        |          |1:SPD mode Retention
 * |        |          |0:SPD mode non Retention
 * |[3:2]   |Bank2     |BANK2 Retention Control(This setting is only effective when the ECC function is disabled. When ECC is enabled, the 0u201316KB range follows the control of BANK0, and the 16u201332KB range follows the control of BANK1.)
 * |        |          |3u2019b11:SPD mode Retention(0~32Kbyte)
 * |        |          |2u2019b10:SPD mode Retention(16~32Kbyte)
 * |        |          |2u2019b01:SPD mode Retention(0~16Kbyte)
 * |        |          |2u2019b00:SPD mode non Retention
 ...
 * |[5]     |USBHBEF   |USBH SRAM BIST Fail Flag (Read Only)
 * |        |          |0 = USBH SRAM BIST test pass.
 * |        |          |1 = USBH SRAM BIST test fail.
 * |[10]    |SRBISTEF2 |System Bnak2 SRAM BIST Fail Flag (Read Only)
 ...
 * |[21]    |USBHBEND  |USBH SRAM BIST Test Finish (Read Only)
 * |        |          |0 = USBH SRAM BIST is active.
 ...
 * Offset: 0xDC  System SRAM ECC function Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var SYS_T::HIRCTCTL
 ...
 * Offset: 0xF4  System SRAM Non-Secure ECC Error Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * Offset: 0xF8  System SRAM Non-Secure ECC Check Error Address Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |ERRADDR   |System SRAM ECC Error Address (Read Only)
 ...
 */
    ...
    __IO uint32_t SRAM_INTCTL;           /*!< [0x00c0] System SRAM Secure Interrupt Enable Control Register             */
    __IO uint32_t SRAM_STATUS;           /*!< [0x00c4] System SRAM Secure ECC Error Status Register                     */
    __I  uint32_t SRAM_ERRADDR;          /*!< [0x00c8] System SRAM Secure ECC Check Error Address Register              */
    __IO uint32_t SRAM_PMU;              /*!< [0x00cc] System SRAM SPD mode retention control Register                  */
    ...
    __IO uint32_t SRAM_ECCEN;            /*!< [0x00dc] System SRAM ECC function Control Register                        */
    ...
    __IO uint32_t SRAM_NSSTATUS;         /*!< [0x00f4] System SRAM Non-Secure ECC Error Status Register                 */
    __I  uint32_t SRAM_NSERRADDR;        /*!< [0x00f8] System SRAM Non-Secure ECC Check Error Address Register          */
...
#define SYS_SRAM_PMU_Bank0_Pos           (0)                                               /*!< SYS_T::SRAM_PMU: Bank0 Position        */
#define SYS_SRAM_PMU_Bank0_Msk           (0x1ul << SYS_SRAM_PMU_Bank0_Pos)                 /*!< SYS_T::SRAM_PMU: Bank0 Mask            */

#define SYS_SRAM_PMU_Bank1_Pos           (1)                                               /*!< SYS_T::SRAM_PMU: Bank1 Position        */
#define SYS_SRAM_PMU_Bank1_Msk           (0x1ul << SYS_SRAM_PMU_Bank1_Pos)                 /*!< SYS_T::SRAM_PMU: Bank1 Mask            */

#define SYS_SRAM_PMU_Bank2_Pos           (2)                                               /*!< SYS_T::SRAM_PMU: Bank2 Position        */
#define SYS_SRAM_PMU_Bank2_Msk           (0x3ul << SYS_SRAM_PMU_Bank2_Pos)                 /*!< SYS_T::SRAM_PMU: Bank2 Mask            */

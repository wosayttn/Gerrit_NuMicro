...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[6]     |TXUDRIEN  |Slave Transmit Under Run Error Interrupt Enable Bit
     ...
     * @var UUART_T::IUR
     * Offset: 0x84  USCI Internal Use Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4:0]   |TDIPTR    |Transmitter Data Input Pointer
     * |        |          |This bit field indicates the transmit FIFO entry that will be used for the next transmit data coming from the INx addresses.
     * |[9:5]   |TDOPTR    |Transmitter Data Output Pointer
     * |        |          |This bit field indicates the transmit FIFO entry that will be used for the next transmit data to be output to transmit data buffer.
     * |[14:10] |RDIPTR    |Receiver Data Input Pointer
     * |        |          |This bit field indicates the receive FIFO entry that will be used for the next receive data coming from RX_BUF.
     * |[19:15] |RDOPTR    |Receiver Data Output Pointer
     * |        |          |This bit field indicates the receive FIFO entry that will be used for the next receive data to be output at the OUTR addresses.
     * |[30]    |SELFTEST  |Self-test Enable Bit
     ...
     * |[31]    |HDPRSEL   |Half-duplex PDMA Read Mode Selection
     * |        |          |When SPI master device operates in half-duplex transmission with PDMA function, this bit field is used to select whether the serial bus clock of the next word data follows the last bit of current data.
     * |        |          |0 = The next data transmission will start after RX PDMA acknowledgement of current data.
     * |        |          |1 = The next word data follows the last bit of current data.
     * @var UUART_T::VERSION
     * Offset: 0xFFC  USCI Version Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MINOR     |USCI RTL Design MINOR Version Number
     * |        |          |Minor version number is dependent on ECO version control
     * |        |          |0x0002: (current Minor Version Number)
     * |[23:16] |SUB       |USCI RTL Design MINOR Version Number
     * |        |          |Sub version number is relative to key feature
     * |        |          |0x01: (current Sub Version Number)
     * |[31:24] |MAJOR     |USCI RTL Design MAJOR Version Number
    ...
    __IO uint32_t IUR;                   /*!< [0x0084] USCI Internal Use Register                                       */
    __I  uint32_t RESERVE5[989];
    __I  uint32_t VERSION;               /*!< [0x0ffc] USCI Version Control Register                                    */
...
#define UUART_BUFCTL_TXUDRIEN_Pos        (6)                                               /*!< UUART_T::BUFCTL: TXUDRIEN Position     */
#define UUART_BUFCTL_TXUDRIEN_Msk        (0x1ul << UUART_BUFCTL_TXUDRIEN_Pos)              /*!< UUART_T::BUFCTL: TXUDRIEN Mask         */
...
#define UUART_WKCTL_WKADDREN_Pos         (1)                                               /*!< UUART_T::WKCTL: WKADDREN Position      */
#define UUART_WKCTL_WKADDREN_Msk         (0x1ul << UUART_WKCTL_WKADDREN_Pos)               /*!< UUART_T::WKCTL: WKADDREN Mask          */
...
#define UUART_IUR_TDIPTR_Pos             (0)                                               /*!< UUART_T::IUR: TDIPTR Position          */
#define UUART_IUR_TDIPTR_Msk             (0x1ful << UUART_IUR_TDIPTR_Pos)                  /*!< UUART_T::IUR: TDIPTR Mask              */

#define UUART_IUR_TDOPTR_Pos             (5)                                               /*!< UUART_T::IUR: TDOPTR Position          */
#define UUART_IUR_TDOPTR_Msk             (0x1ful << UUART_IUR_TDOPTR_Pos)                  /*!< UUART_T::IUR: TDOPTR Mask              */

#define UUART_IUR_RDIPTR_Pos             (10)                                              /*!< UUART_T::IUR: RDIPTR Position          */
#define UUART_IUR_RDIPTR_Msk             (0x1ful << UUART_IUR_RDIPTR_Pos)                  /*!< UUART_T::IUR: RDIPTR Mask              */

#define UUART_IUR_RDOPTR_Pos             (15)                                              /*!< UUART_T::IUR: RDOPTR Position          */
#define UUART_IUR_RDOPTR_Msk             (0x1ful << UUART_IUR_RDOPTR_Pos)                  /*!< UUART_T::IUR: RDOPTR Mask              */

#define UUART_IUR_SELFTEST_Pos           (30)                                              /*!< UUART_T::IUR: SELFTEST Position        */
#define UUART_IUR_SELFTEST_Msk           (0x1ul << UUART_IUR_SELFTEST_Pos)                 /*!< UUART_T::IUR: SELFTEST Mask            */

#define UUART_IUR_HDPRSEL_Pos            (31)                                              /*!< UUART_T::IUR: HDPRSEL Position         */
#define UUART_IUR_HDPRSEL_Msk            (0x1ul << UUART_IUR_HDPRSEL_Pos)                  /*!< UUART_T::IUR: HDPRSEL Mask             */

#define UUART_VERSION_MINOR_Pos          (0)                                               /*!< UUART_T::VERSION: MINOR Position       */
#define UUART_VERSION_MINOR_Msk          (0xfffful << UUART_VERSION_MINOR_Pos)             /*!< UUART_T::VERSION: MINOR Mask           */

#define UUART_VERSION_SUB_Pos            (16)                                              /*!< UUART_T::VERSION: SUB Position         */
#define UUART_VERSION_SUB_Msk            (0xfful << UUART_VERSION_SUB_Pos)                 /*!< UUART_T::VERSION: SUB Mask             */

#define UUART_VERSION_MAJOR_Pos          (24)                                              /*!< UUART_T::VERSION: MAJOR Position       */
#define UUART_VERSION_MAJOR_Msk          (0xfful << UUART_VERSION_MAJOR_Pos)               /*!< UUART_T::VERSION: MAJOR Mask           */

 ...
 * |        |          |If ISPDAT = 0x0000_0000, it means that (1) the checksum calculation is in progress, or (2) the memory range for checksumA calculation is incorrect
 * @var DFMC_T::ISPCMD
 ...
 * |[10]    |EEP_SPE   |EEPROM Emulation SRAM Pairty check error. (Write Protect)
 ...
 * |        |          |When ISPFF (FMC_ISPCTL[6]) is 1, ISPDAT = 0xff.
 ...
 * |        |          |Two EEPROM eumlation total erase times.The number is two pages total, So if the number is 100 it means each page erase 50 times.
 * |[29:20] |EEPWPTR   |Current page write pointer
 * |        |          |(When >= 1022 EEPROM emulation will do the page full processing automotically)
...
/*---------------------- ?????????????????????????????????????????? -------------------------*/
/**
    @addtogroup DFMC_NSBA ??????????????????????????????????????????(DFMC_NSBA)
    Memory Mapped Structure for DFMC_NSBA Controller
@{ */
...
/**
 * @var DFMC_NSBA_T::DFMC_ISPCTL
 * Offset: 0x00  Non-sec ISP Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |NS_ISPEN  |Non-sec ISP Enable Bit (Write Protect)
 * |        |          |ISP function enable bit. Set this bit to enable ISP function.
 * |        |          |0 = ISP function Disabled.
 * |        |          |1 = ISP function Enabled.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[3]     |NS_DATAEN |Non-sec Data Flash Update Enable Bit (Write Protect)
 * |        |          |0 = Data Flash cannot be updated.
 * |        |          |1 = Data Flash can be updated.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 ...
 * |        |          |l Mass erase is not executed in Data Flash
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[24]    |NS_ISPIFEN|Non-sec ISP Interrupt Enable bit (Write Protect)
 * |        |          |0 = ISP Interrupt Disabled.
 * |        |          |1 = ISP Interrupt Enabled.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[25]    |NS_EEPEMU_EN|Non-sec EEP emulation Enable bit (Read only)
 * |        |          |This bit is load from (CFG[6:5])
 * |        |          |0 = EEPROM emulation disable
 * |        |          |1 = EEPROM emulation enable
 * @var DFMC_NSBA_T::DFMC_ISPADDR
 * Offset: 0x04  Non-sec ISP Address Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |NS_ISPADDR|ISP Address
 * |        |          |The M3351 is equipped with embedded Data Flash. ISPADDR[1:0] must be kept 00 for ISP 32-bit operation.
 * |        |          |The ISPADDR[1:0] can be any user wanted value in EEPROM emulate ISP 8 bit program
 ...
 * |        |          |For Data Flash32-bit Program, ISP address needs word alignment (4-byte).
 * @var DFMC_NSBA_T::DFMC_ISPDAT
 * Offset: 0x08  Non-sec ISP Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |NS_ISPDAT |ISP Data
 * |        |          |Write data to this register before ISP program operation.
 * |        |          |Read data from this register after ISP read operation.
 * |        |          |When ISPFF (DFMC_ISPCTL[6]) is 1, ISPDAT = 0xffff_ffff
 ...
 * @var DFMC_NSBA_T::DFMC_ISPCMD
 * Offset: 0x0C  Non-sec ISP Command Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |0x31= EEPROM emulation 8 bit program
 * |        |          |0x32 = EEPROM emulation 32 bit program
 * |        |          |0x33 = EEPROM emulation initial
 * |        |          |The other commands are invalid.
 * @var DFMC_NSBA_T::DFMC_ISPTRG
 * Offset: 0x10  Non-sec ISP Trigger Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |1 = ISP is progressed.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * @var DFMC_NSBA_T::DFMC_ISPSTS
 * Offset: 0x40  Non-sec ISP Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var DFMC_NSBA_T::DFMC_MPDATE
 * Offset: 0x90  Non-sec ISP Data Error Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[6:0]   |NS_ISPDATE|Non-sec ISP Data Error
 * |        |          |Read data from this register after ISP 32-bit read operation or ECCSEBCF(FMC_ECCSTS[0]) is high can know which bit is error
 * |        |          |ISPDATE does not continuously store the position information of ECC errors
 * |        |          |Therefore, if the user wants to know which bit generated the error, they need to read it before the next ISP action after an ECC single-bit error occurs, or access that position again.
 * |        |          |When ISPFF (FMC_ISPCTL[6]) is 1, ISPDATE = 0xff.
 * |        |          |This register is the ECC 7-bit data.
 * @var DFMC_NSBA_T::DFMC_ECCCTL
 * Offset: 0x130  Non-sec DFMC Error Code Correction Control
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |NS_SEBDINTEN|Non-sec Single Error Bits Detection Interrupt Enable (Write Protect)
 * |        |          |1 = Single Error Bit Detection Interrupt Enabled.
 * |        |          |0 = Single Error Bit Detection Interrupt Disabled.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[1]     |NS_DEBDINTEN|Non-sec Double Error Bits Detection Interrupt Enable (Write Protect)
 * |        |          |1 = Double Error Bits Detection Interrupt Enabled.
 * |        |          |0 = Double Error Bits Detection Interrupt Disabled.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * @var DFMC_NSBA_T::DFMC_ECCSTS
 * Offset: 0x134  Non-sec DFMC Error Code Correction status
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |NS_ECCSEBCF|Non-sec ECC Single Error Bits Correction Flag
 * |        |          |This bit is set by hardware when FMC detects and corrects a ECC single error bits fault when CPU access Flash or ISP read
 * |        |          |It need to be cleared by writing 1 to ECCSEBCF
 * |        |          |When ECCSEBCF and SEBDINTEN(FMC_ECCCTL[0])=1 cause interrupt.
 * |        |          |1 = FMC detects and corrects ECC single error bits fault.
 * |        |          |0 = FMC does not detect ECC single error bits fault.
 * |[1]     |NS_ECCDEBDF|Non-sec ECC Double Error Bits Detection Flag
 * |        |          |This bit is set by hardware when FMC detects a ECC double error bits fault when CPU access Flash or ISP read
 * |        |          |It need to be cleared by writing 1 to ECCDEBDF
 * |        |          |When ECCDEBDF and DEBDINTEN(FMC_ECCCTL[1])=1 cause interrupt.
 * |        |          |1 = FMC detects ECC double error bits fault.
 * |        |          |0 = FMC does not detect ECC double error bits fault.
 * @var DFMC_NSBA_T::DFMC_ECCSEFAR
 * Offset: 0x138  Non-sec DFMC ECC Single Error fault Adress Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |NS_ECCSEFAR|Non-sec ECC Single Error Fault Address Register (Read Only)
 * |        |          |When FMC detects a ECCSEBCF(FMC_ECCSTS[0]) would record fault address at the register
 * |        |          |The register is cleared by writing 1 to ECCSEBCF
 * |        |          |ECCSEFAR is 64-bit alignment so ECCSEFAR[2:0] are always 0.
 * @var DFMC_NSBA_T::DFMC_ECCDEFAR
 * Offset: 0x13C  Non-sec DFMC ECC Double Error fault Adress Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |NS_ECCDEFAR|Non-sec ECC Double Error Fault Address Register (Read Only)
 * |        |          |When FMC detects a ECCDEBDF(FMC_ECCSTS[1]) would record fault address at the register
 * |        |          |The register is cleared by writing 1 to ECCDEBDF
 * |        |          |ECCDEBDF is 64-bit alignment so ECCDEFAR[2:0] are always 0.
 * @var DFMC_NSBA_T::DFMC_EEP_STS
 * Offset: 0x140  Non-sec DFMC EEPROM Emulation Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[19:0]  |NS_PETIMES|Non-sec page erase times
 * |        |          |Two EEPROM eumlation total erase times.The number is two pages total, So if the number is 100 it means each page erase 50 times.
 * |[29:20] |NS_EEPWPTR|Non-sec current page write pointer
 * |        |          |(When >= 1022 EEPROM emulation will do the page full processing automotically)
 * |[30]    |NS_EEP_PF |Non-sec EEPROM Emulation in the page full processing
 * |        |          |This bit is set by hardware if EEPROM program and flash page full
 * |        |          |EEPROM emulation will automatic start the page full processing it need program current EEPPROM emulation SRAM data to next page and Erase current page.
 * |        |          |0: Not in page full processing
 * |        |          |1: in the page full processing
 */
    __IO uint32_t DFMC_ISPCTL;           /*!< [0x0000] Non-sec ISP Control Register                                     */
    __IO uint32_t DFMC_ISPADDR;          /*!< [0x0004] Non-sec ISP Address Register                                     */
    __IO uint32_t DFMC_ISPDAT;           /*!< [0x0008] Non-sec ISP Data Register                                        */
    __IO uint32_t DFMC_ISPCMD;           /*!< [0x000c] Non-sec ISP Command Register                                     */
    __IO uint32_t DFMC_ISPTRG;           /*!< [0x0010] Non-sec ISP Trigger Control Register                             */
    __I  uint32_t RESERVE0[11];
    __IO uint32_t DFMC_ISPSTS;           /*!< [0x0040] Non-sec ISP Status Register                                      */
    __I  uint32_t RESERVE1[19];
    __IO uint32_t DFMC_MPDATE;           /*!< [0x0090] Non-sec ISP Data Error Register                                  */
    __I  uint32_t RESERVE2[39];
    __IO uint32_t DFMC_ECCCTL;           /*!< [0x0130] Non-sec DFMC Error Code Correction Control                       */
    __IO uint32_t DFMC_ECCSTS;           /*!< [0x0134] Non-sec DFMC Error Code Correction status                        */
    __I  uint32_t DFMC_ECCSEFAR;         /*!< [0x0138] Non-sec DFMC ECC Single Error fault Adress Register              */
    __I  uint32_t DFMC_ECCDEFAR;         /*!< [0x013c] Non-sec DFMC ECC Double Error fault Adress Register              */
    __I  uint32_t DFMC_EEP_STS;          /*!< [0x0140] Non-sec DFMC EEPROM Emulation Status Register                    */

} DFMC_NSBA_T;

/**
    @addtogroup DFMC_NSBA_CONST DFMC_NSBA Bit Field Definition
    Constant Definitions for DFMC_NSBA Controller
@{ */

#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPEN_Pos (0)                                             /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPEN Position*/
#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPEN_Msk (0x1ul << DFMC_NSBA_DFMC_ISPCTL_NS_ISPEN_Pos)   /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPEN Mask*/

#define DFMC_NSBA_DFMC_ISPCTL_NS_DATAEN_Pos (3)                                            /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_DATAEN Position*/
#define DFMC_NSBA_DFMC_ISPCTL_NS_DATAEN_Msk (0x1ul << DFMC_NSBA_DFMC_ISPCTL_NS_DATAEN_Pos) /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_DATAEN Mask*/

#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPFF_Pos (6)                                             /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPFF Position*/
#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPFF_Msk (0x1ul << DFMC_NSBA_DFMC_ISPCTL_NS_ISPFF_Pos)   /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPFF Mask*/

#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPIFEN_Pos (24)                                          /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPIFEN Position*/
#define DFMC_NSBA_DFMC_ISPCTL_NS_ISPIFEN_Msk (0x1ul << DFMC_NSBA_DFMC_ISPCTL_NS_ISPIFEN_Pos) /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_ISPIFEN Mask*/

#define DFMC_NSBA_DFMC_ISPCTL_NS_EEPEMU_EN_Pos (25)                                        /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_EEPEMU_EN Position*/
#define DFMC_NSBA_DFMC_ISPCTL_NS_EEPEMU_EN_Msk (0x1ul << DFMC_NSBA_DFMC_ISPCTL_NS_EEPEMU_EN_Pos) /*!< DFMC_NSBA_T::DFMC_ISPCTL: NS_EEPEMU_EN Mask*/

#define DFMC_NSBA_DFMC_ISPADDR_NS_ISPADDR_Pos (0)                                          /*!< DFMC_NSBA_T::DFMC_ISPADDR: NS_ISPADDR Position*/
#define DFMC_NSBA_DFMC_ISPADDR_NS_ISPADDR_Msk (0xfffffffful << DFMC_NSBA_DFMC_ISPADDR_NS_ISPADDR_Pos) /*!< DFMC_NSBA_T::DFMC_ISPADDR: NS_ISPADDR Mask*/

#define DFMC_NSBA_DFMC_ISPDAT_NS_ISPDAT_Pos (0)                                            /*!< DFMC_NSBA_T::DFMC_ISPDAT: NS_ISPDAT Position*/
#define DFMC_NSBA_DFMC_ISPDAT_NS_ISPDAT_Msk (0xfffffffful << DFMC_NSBA_DFMC_ISPDAT_NS_ISPDAT_Pos) /*!< DFMC_NSBA_T::DFMC_ISPDAT: NS_ISPDAT Mask*/

#define DFMC_NSBA_DFMC_ISPCMD_NS_CMD_Pos (0)                                               /*!< DFMC_NSBA_T::DFMC_ISPCMD: NS_CMD Position*/
#define DFMC_NSBA_DFMC_ISPCMD_NS_CMD_Msk (0x7ful << DFMC_NSBA_DFMC_ISPCMD_NS_CMD_Pos)      /*!< DFMC_NSBA_T::DFMC_ISPCMD: NS_CMD Mask  */

#define DFMC_NSBA_DFMC_ISPTRG_NS_ISPGO_Pos (0)                                             /*!< DFMC_NSBA_T::DFMC_ISPTRG: NS_ISPGO Position*/
#define DFMC_NSBA_DFMC_ISPTRG_NS_ISPGO_Msk (0x1ul << DFMC_NSBA_DFMC_ISPTRG_NS_ISPGO_Pos)   /*!< DFMC_NSBA_T::DFMC_ISPTRG: NS_ISPGO Mask*/

#define DFMC_NSBA_DFMC_MPDATE_NS_ISPDATE_Pos (0)                                           /*!< DFMC_NSBA_T::DFMC_MPDATE: NS_ISPDATE Position*/
#define DFMC_NSBA_DFMC_MPDATE_NS_ISPDATE_Msk (0x7ful << DFMC_NSBA_DFMC_MPDATE_NS_ISPDATE_Pos) /*!< DFMC_NSBA_T::DFMC_MPDATE: NS_ISPDATE Mask*/

#define DFMC_NSBA_DFMC_ECCCTL_NS_SEBDINTEN_Pos (0)                                         /*!< DFMC_NSBA_T::DFMC_ECCCTL: NS_SEBDINTEN Position*/
#define DFMC_NSBA_DFMC_ECCCTL_NS_SEBDINTEN_Msk (0x1ul << DFMC_NSBA_DFMC_ECCCTL_NS_SEBDINTEN_Pos) /*!< DFMC_NSBA_T::DFMC_ECCCTL: NS_SEBDINTEN Mask*/

#define DFMC_NSBA_DFMC_ECCCTL_NS_DEBDINTEN_Pos (1)                                         /*!< DFMC_NSBA_T::DFMC_ECCCTL: NS_DEBDINTEN Position*/
#define DFMC_NSBA_DFMC_ECCCTL_NS_DEBDINTEN_Msk (0x1ul << DFMC_NSBA_DFMC_ECCCTL_NS_DEBDINTEN_Pos) /*!< DFMC_NSBA_T::DFMC_ECCCTL: NS_DEBDINTEN Mask*/

#define DFMC_NSBA_DFMC_ECCSTS_NS_ECCSEBCF_Pos (0)                                          /*!< DFMC_NSBA_T::DFMC_ECCSTS: NS_ECCSEBCF Position*/
#define DFMC_NSBA_DFMC_ECCSTS_NS_ECCSEBCF_Msk (0x1ul << DFMC_NSBA_DFMC_ECCSTS_NS_ECCSEBCF_Pos) /*!< DFMC_NSBA_T::DFMC_ECCSTS: NS_ECCSEBCF Mask*/

#define DFMC_NSBA_DFMC_ECCSTS_NS_ECCDEBDF_Pos (1)                                          /*!< DFMC_NSBA_T::DFMC_ECCSTS: NS_ECCDEBDF Position*/
#define DFMC_NSBA_DFMC_ECCSTS_NS_ECCDEBDF_Msk (0x1ul << DFMC_NSBA_DFMC_ECCSTS_NS_ECCDEBDF_Pos) /*!< DFMC_NSBA_T::DFMC_ECCSTS: NS_ECCDEBDF Mask*/

#define DFMC_NSBA_DFMC_ECCSEFAR_NS_ECCSEFAR_Pos (0)                                        /*!< DFMC_NSBA_T::DFMC_ECCSEFAR: NS_ECCSEFAR Position*/
#define DFMC_NSBA_DFMC_ECCSEFAR_NS_ECCSEFAR_Msk (0xfffffffful << DFMC_NSBA_DFMC_ECCSEFAR_NS_ECCSEFAR_Pos) /*!< DFMC_NSBA_T::DFMC_ECCSEFAR: NS_ECCSEFAR Mask*/

#define DFMC_NSBA_DFMC_ECCDEFAR_NS_ECCDEFAR_Pos (0)                                        /*!< DFMC_NSBA_T::DFMC_ECCDEFAR: NS_ECCDEFAR Position*/
#define DFMC_NSBA_DFMC_ECCDEFAR_NS_ECCDEFAR_Msk (0xfffffffful << DFMC_NSBA_DFMC_ECCDEFAR_NS_ECCDEFAR_Pos) /*!< DFMC_NSBA_T::DFMC_ECCDEFAR: NS_ECCDEFAR Mask*/

#define DFMC_NSBA_DFMC_EEP_STS_NS_PETIMES_Pos (0)                                          /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_PETIMES Position*/
#define DFMC_NSBA_DFMC_EEP_STS_NS_PETIMES_Msk (0xffffful << DFMC_NSBA_DFMC_EEP_STS_NS_PETIMES_Pos) /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_PETIMES Mask*/

#define DFMC_NSBA_DFMC_EEP_STS_NS_EEPWPTR_Pos (20)                                         /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_EEPWPTR Position*/
#define DFMC_NSBA_DFMC_EEP_STS_NS_EEPWPTR_Msk (0x3fful << DFMC_NSBA_DFMC_EEP_STS_NS_EEPWPTR_Pos) /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_EEPWPTR Mask*/

#define DFMC_NSBA_DFMC_EEP_STS_NS_EEP_PF_Pos (30)                                          /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_EEP_PF Position*/
#define DFMC_NSBA_DFMC_EEP_STS_NS_EEP_PF_Msk (0x1ul << DFMC_NSBA_DFMC_EEP_STS_NS_EEP_PF_Pos) /*!< DFMC_NSBA_T::DFMC_EEP_STS: NS_EEP_PF Mask*/

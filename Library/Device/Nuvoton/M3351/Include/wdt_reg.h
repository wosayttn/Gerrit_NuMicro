 ...
 */
    ...
    __I  uint32_t VERSION;               /*!< [0x0ffc] WDT RTL Design Version Register                                  */
...
#define WDT_VERSION_MINOR_Pos            (0)                                               /*!< WDT_T::VERSION: MINOR Position         */
#define WDT_VERSION_MINOR_Msk            (0xfffful << WDT_VERSION_MINOR_Pos)               /*!< WDT_T::VERSION: MINOR Mask             */

#define WDT_VERSION_SUB_Pos              (16)                                              /*!< WDT_T::VERSION: SUB Position           */
#define WDT_VERSION_SUB_Msk              (0xfful << WDT_VERSION_SUB_Pos)                   /*!< WDT_T::VERSION: SUB Mask               */

#define WDT_VERSION_MAJOR_Pos            (24)                                              /*!< WDT_T::VERSION: MAJOR Position         */
#define WDT_VERSION_MAJOR_Msk            (0xfful << WDT_VERSION_MAJOR_Pos)                 /*!< WDT_T::VERSION: MAJOR Mask             */

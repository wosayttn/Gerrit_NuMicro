...
#define CACHE_PARITY_CTTPB_Msk           (0x1 << CACHE_PARITY_CTTPB_Pos)

#define CACHE_PARITY_CDTPB_Pos           (8)
#define CACHE_PARITY_CDTPB_Msk           (0x3 << CACHE_PARITY_CDTPB_Pos)

#define CACHE_PARITY_CPTEN_Pos           (0)
#define CACHE_PARITY_CPTEN_Msk           (0x1 << CACHE_PARITY_CPTEN_Pos)

...
void FMC_NSCBA_Setup(void)
{
    ...
    bUpdateNSCBA = (SCU->FNSADDR != FMC_SECURE_END) ? TRUE : FALSE;

    if (bUpdateNSCBA == FALSE)
    {
        bUpdateNSCBA = ((FMC->ISPSTS & FMC_ISPSTS_MIRBOUND_Msk) != (FMC_INIT_MIRROR_BOUND << FMC_ISPSTS_MIRBOUND_Pos)) ? TRUE : FALSE;
    }
    ...
    /* Skip NSCBA Setup according config */
#if (DFMC_INIT_NSCBA == 1) && (DFMC_SECURE_END > DFMC_DATA_FLASH_BASE)
    uint32_t u32Config14;
    uint32_t u32DFMC_NSCBAConfig = ((DFMC_SECURE_END - DFMC_DATA_FLASH_BASE) / 0x1000UL) - 1UL;

    /* Check if NSCBA value with current active NSCBA */
    if ((SCU->DFNSADDR & 0xFUL) != u32DFMC_NSCBAConfig)
    {
        uint32_t u32DFMC_EnableEEPROM = BIT5;    /* CONFIG14.DFMC_EE[5]: Data Flash EEPROM Function Enable Bit; 0: Enable, 1: Disable */

#if (DFMC_ENABLE_EEPROM == 1UL)
        u32DFMC_EnableEEPROM = 0UL;    /* CONFIG14.DFMC_EE[5]: Data Flash EEPROM Function Enable Bit; 0: Enable, 1: Disable */
#endif
        ...
        if ((u32Config14 & 0x6FUL) == ((DFMC_SECURE_EEPROM << 6UL) | u32DFMC_EnableEEPROM | u32DFMC_NSCBAConfig))
        {
            return ;
        }
        ...
        /* Set new base */
        FMC->ISPDAT = ~0x6FUL | ((DFMC_SECURE_EEPROM << 6UL) | u32DFMC_EnableEEPROM | u32DFMC_NSCBAConfig);
        FMC->ISPCMD = FMC_ISPCMD_PROGRAM;
        FMC->ISPTRG = FMC_ISPTRG_ISPGO_Msk;
...
#if ((SCU_INIT_PNSSET0_VAL & SCU_PNSSET0_PDMA0_Msk) == SCU_PNSSET0_PDMA0_Msk)
    {
        NVIC_ITNS_CONF(PDMA0_IRQn);     /* Int of PDMA0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET0_VAL & SCU_PNSSET0_USBH_Msk) == SCU_PNSSET0_USBH_Msk)
    {
        NVIC_ITNS_CONF(USBH_IRQn);      /* Int of USBH_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET0_VAL & SCU_PNSSET0_EBI_Msk) == SCU_PNSSET0_EBI_Msk)
    {
        /* EBI does not have IRQ */
    }
#endif

#if ((SCU_INIT_PNSSET1_VAL & SCU_PNSSET1_CANFD0_Msk) == SCU_PNSSET1_CANFD0_Msk)
    {
...
#if ((SCU_INIT_PNSSET1_VAL & SCU_PNSSET1_CANFD1_Msk) == SCU_PNSSET1_CANFD1_Msk)
    {
...
#if ((SCU_INIT_PNSSET1_VAL & SCU_PNSSET1_CRC_Msk) == SCU_PNSSET1_CRC_Msk)
    {
        NVIC_ITNS_CONF(CRC_IRQn);       /* Int of CRC_INT           */
    }
#endif

#if ((SCU_INIT_PNSSET1_VAL & SCU_PNSSET1_CACHE_Msk) == SCU_PNSSET1_CACHE_Msk)
    {
        NVIC_ITNS_CONF(CACHE_IRQn);     /* Int of CACHE_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_RTC_Msk) == SCU_PNSSET2_RTC_Msk)
    {
        NVIC_ITNS_CONF(RTC_IRQn);       /* Int of RTC_INT           */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_WDT1_Msk) == SCU_PNSSET2_WDT1_Msk)
    {
        NVIC_ITNS_CONF(WDT1_IRQn);      /* Int of WDT1_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_EADC0_Msk) == SCU_PNSSET2_EADC0_Msk)
    {
...
#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_ACMP01_Msk) == SCU_PNSSET2_ACMP01_Msk)
    {
        NVIC_ITNS_CONF(ACMP01_IRQn);    /* Int of ACMP01_INT        */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_DAC_Msk) == SCU_PNSSET2_DAC_Msk)
    {
        NVIC_ITNS_CONF(DAC0_IRQn);      /* Int of DAC0_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_EADC1_Msk) == SCU_PNSSET2_EADC1_Msk)
    {
...
#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_TIMER01_Msk) == SCU_PNSSET2_TIMER01_Msk)
    {
...
#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_TIMER23_Msk) == SCU_PNSSET2_TIMER23_Msk)
    {
...
#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_BPWM0_Msk) == SCU_PNSSET2_BPWM0_Msk)
    {
        NVIC_ITNS_CONF(BPWM0_IRQn);     /* Int of BPWM0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_BPWM1_Msk) == SCU_PNSSET2_BPWM1_Msk)
    {
        NVIC_ITNS_CONF(BPWM1_IRQn);     /* Int of BPWM1_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_PWM0_Msk) == SCU_PNSSET2_PWM0_Msk)
    {
...
#if ((SCU_INIT_PNSSET2_VAL & SCU_PNSSET2_PWM1_Msk) == SCU_PNSSET2_PWM1_Msk)
    {
...
#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_QSPI0_Msk) == SCU_PNSSET3_QSPI0_Msk)
    {
        NVIC_ITNS_CONF(QSPI0_IRQn);     /* Int of QSPI0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_SPI0_Msk) == SCU_PNSSET3_SPI0_Msk)
    {
        NVIC_ITNS_CONF(SPI0_IRQn);      /* Int of SPI0_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_SPI1_Msk) == SCU_PNSSET3_SPI1_Msk)
    {
        NVIC_ITNS_CONF(SPI1_IRQn);      /* Int of SPI1_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART0_Msk) == SCU_PNSSET3_UART0_Msk)
    {
        NVIC_ITNS_CONF(UART0_IRQn);     /* Int of UART0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART1_Msk) == SCU_PNSSET3_UART1_Msk)
    {
        NVIC_ITNS_CONF(UART1_IRQn);     /* Int of UART1_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART2_Msk) == SCU_PNSSET3_UART2_Msk)
    {
        NVIC_ITNS_CONF(UART2_IRQn);     /* Int of UART2_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART3_Msk) == SCU_PNSSET3_UART3_Msk)
    {
        NVIC_ITNS_CONF(UART3_IRQn);     /* Int of UART3_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART4_Msk) == SCU_PNSSET3_UART4_Msk)
    {
        NVIC_ITNS_CONF(UART4_IRQn);     /* Int of UART4_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART5_Msk) == SCU_PNSSET3_UART5_Msk)
    {
        NVIC_ITNS_CONF(UART5_IRQn);     /* Int of UART5_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART6_Msk) == SCU_PNSSET3_UART6_Msk)
    {
        NVIC_ITNS_CONF(UART6_IRQn);     /* Int of UART6_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART7_Msk) == SCU_PNSSET3_UART7_Msk)
    {
        NVIC_ITNS_CONF(UART7_IRQn);     /* Int of UART7_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART8_Msk) == SCU_PNSSET3_UART8_Msk)
    {
        NVIC_ITNS_CONF(UART8_IRQn);     /* Int of UART8_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET3_VAL & SCU_PNSSET3_UART9_Msk) == SCU_PNSSET3_UART9_Msk)
    {
        NVIC_ITNS_CONF(UART9_IRQn);     /* Int of UART9_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_I2C0_Msk) == SCU_PNSSET4_I2C0_Msk)
    {
        NVIC_ITNS_CONF(I2C0_IRQn);      /* Int of I2C0_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_I2C1_Msk) == SCU_PNSSET4_I2C1_Msk)
    {
        NVIC_ITNS_CONF(I2C1_IRQn);      /* Int of I2C1_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_I2C2_Msk) == SCU_PNSSET4_I2C2_Msk)
    {
        NVIC_ITNS_CONF(I2C2_IRQn);      /* Int of I2C2_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_I3C0_Msk) == SCU_PNSSET4_I3C0_Msk)
    {
        NVIC_ITNS_CONF(I3C0_IRQn);      /* Int of I3C0_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_LLSI0_Msk) == SCU_PNSSET4_LLSI0_Msk)
    {
...
#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_LLSI1_Msk) == SCU_PNSSET4_LLSI1_Msk)
    {
...
#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_ELLSI0_Msk) == SCU_PNSSET4_ELLSI0_Msk)
    {
        NVIC_ITNS_CONF(ELLSI0_IRQn);    /* Int of ELLSI0_INT        */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_ELLSI1_Msk) == SCU_PNSSET4_ELLSI1_Msk)
    {
        NVIC_ITNS_CONF(ELLSI1_IRQn);    /* Int of ELLSI1_INT        */
    }
#endif

#if ((SCU_INIT_PNSSET4_VAL & SCU_PNSSET4_WWDT1_Msk) == SCU_PNSSET4_WWDT1_Msk)
    {
        NVIC_ITNS_CONF(WWDT1_IRQn);     /* Int of WWDT1_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET5_VAL & SCU_PNSSET5_EQEI0_Msk) == SCU_PNSSET5_EQEI0_Msk)
    {
        NVIC_ITNS_CONF(EQEI0_IRQn);     /* Int of EQEI0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET5_VAL & SCU_PNSSET5_EQEI1_Msk) == SCU_PNSSET5_EQEI1_Msk)
    {
        NVIC_ITNS_CONF(EQEI1_IRQn);     /* Int of EQEI1_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET5_VAL & SCU_PNSSET5_ECAP0_Msk) == SCU_PNSSET5_ECAP0_Msk)
    {
        NVIC_ITNS_CONF(ECAP0_IRQn);     /* Int of ECAP0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET5_VAL & SCU_PNSSET5_TRNG_Msk) == SCU_PNSSET5_TRNG_Msk)
    {
        NVIC_ITNS_CONF(TRNG_IRQn);      /* Int of TRNG_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET6_VAL & SCU_PNSSET6_USBD_Msk) == SCU_PNSSET6_USBD_Msk)
    {
        NVIC_ITNS_CONF(USBD_IRQn);      /* Int of USBD_INT          */
    }
#endif

#if ((SCU_INIT_PNSSET6_VAL & SCU_PNSSET6_USCI0_Msk) == SCU_PNSSET6_USCI0_Msk)
    {
        NVIC_ITNS_CONF(USCI0_IRQn);     /* Int of USCI0_INT         */
    }
#endif

#if ((SCU_INIT_PNSSET6_VAL & SCU_PNSSET6_USCI1_Msk) == SCU_PNSSET6_USCI1_Msk)
    {
        NVIC_ITNS_CONF(USCI1_IRQn);     /* Int of USCI1_INT         */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT0) == BIT0)
    {
        NVIC_ITNS_CONF(GPA_IRQn);       /* Int of PA                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT1) == BIT1)
    {
        NVIC_ITNS_CONF(GPB_IRQn);       /* Int of PB                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT2) == BIT2)
    {
        NVIC_ITNS_CONF(GPC_IRQn);       /* Int of PC                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT3) == BIT3)
    {
        NVIC_ITNS_CONF(GPD_IRQn);       /* Int of PD                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT4) == BIT4)
    {
        NVIC_ITNS_CONF(GPE_IRQn);       /* Int of PE                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT5) == BIT5)
    {
        NVIC_ITNS_CONF(GPF_IRQn);       /* Int of PF                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT6) == BIT6)
    {
        NVIC_ITNS_CONF(GPG_IRQn);       /* Int of PG                */
    }
#endif

#if ((SCU_INIT_IONSSET_VAL & BIT7) == BIT7)
    {
        NVIC_ITNS_CONF(GPH_IRQn);       /* Int of PH                */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT0) == BIT0)
    {
        NVIC_ITNS_CONF(EINT0_IRQn);     /* Int of EINT0             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT1) == BIT1)
    {
        NVIC_ITNS_CONF(EINT1_IRQn);     /* Int of EINT1             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT2) == BIT2)
    {
        NVIC_ITNS_CONF(EINT2_IRQn);     /* Int of EINT2             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT3) == BIT3)
    {
        NVIC_ITNS_CONF(EINT3_IRQn);     /* Int of EINT3             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT4) == BIT4)
    {
        NVIC_ITNS_CONF(EINT4_IRQn);     /* Int of EINT4             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT5) == BIT5)
    {
        NVIC_ITNS_CONF(EINT5_IRQn);     /* Int of EINT5             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT6) == BIT6)
    {
        NVIC_ITNS_CONF(EINT6_IRQn);     /* Int of EINT6             */
    }
#endif

#if ((SCU_INIT_EINTNS_VAL & BIT7) == BIT7)
    {
...
#define VSRC_USBH   (SCU_BASE + 0xC0)     // 15
...
/* SCU violation interrupt status register is 32-bit but only 21 bits are used.
   Reserved bits are set to VSRC_NULL. */
static const uint32_t s_au32VSrcIdx[32] =
{
    ...
    VSRC_NULL,  VSRC_NULL,  VSRC_CACHE, VSRC_DFLASH, VSRC_DFMC,   VSRC_NULL, VSRC_NULL, VSRC_NULL,
    VSRC_NULL,  VSRC_NULL,  VSRC_NULL,  VSRC_NULL,   VSRC_NULL,   VSRC_NULL, VSRC_NULL, VSRC_NULL
};

#if (CHECK_SCU_VIOLATION == 1)
static const uint32_t s_au32VAddrIdx[] =
{
    ...
    if (u32Reg != 0UL)
    {
        ...
        for (i = 0; i < (sizeof(s_au32VSrcIdx) / sizeof(s_au32VSrcIdx[0])); i++)
        {
            if ((u32Reg & (1UL << i)) != 0UL)
            {
                ...
                {
#if (CHECK_SCU_VIOLATION == 1)
                    uint32_t u32VioSrc = M32(s_au32VSrcIdx[i]);
                    debug_printf("[Warning] Secure violation: %s access %s@0x%08X illegally.\n", s_astrMasterName[u32VioSrc], s_astrSlaveName[i], M32(s_au32VAddrIdx[i]));
#endif
                    SCU->SVINTSTS = (1UL << i);
                }
                else
...
#endif /* defined (__SAUREGION_PRESENT) && (__SAUREGION_PRESENT == 1UL) */

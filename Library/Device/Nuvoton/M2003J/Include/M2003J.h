...
/**
  \mainpage NuMicro M2003J Series CMSIS BSP Driver Reference
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M2003J Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_M2003J.h"                    /* System Header                              */
...
#define SRAM0_BASE            (SRAM_BASE)                   /*!< SRAM0 Base Address       */
#define SRAM1_BASE            ((uint32_t)0x20008000UL)      /*!< SRAM1 Base Address       */
...
#define CLK_BASE              (AHBPERIPH_BASE + 0x01000UL)
#define NMI_BASE              (AHBPERIPH_BASE + 0x00300UL)
#define GPIO_BASE             (AHBPERIPH_BASE + 0x04000UL)
#define GPIOA_BASE            (GPIO_BASE + 0x000UL)
#define GPIOB_BASE            (GPIO_BASE + 0x040UL)
#define GPIOC_BASE            (GPIO_BASE + 0x080UL)
#define GPIOD_BASE            (GPIO_BASE + 0x0C0UL)
#define GPIOE_BASE            (GPIO_BASE + 0x100UL)
#define GPIOF_BASE            (GPIO_BASE + 0x140UL)
#define GPIOG_BASE            (GPIO_BASE + 0x180UL)
#define GPIO_INT_BASE         (GPIO_BASE + 0x440UL)
#define GPIO_PIN_DATA_BASE    (GPIO_BASE + 0x800UL)
...
#define WWDT_BASE             (APBPERIPH_BASE + 0x02000UL)
...
#define TIMER45_BASE          (APBPERIPH_BASE + 0x12000UL)
#define TIMER67_BASE          (APBPERIPH_BASE + 0x13000UL)
#define TIMER8_BASE           (APBPERIPH_BASE + 0x15000UL)
...
#define USCI4_BASE            (APBPERIPH_BASE + 0x94000UL)
...
#define TIMER4               ((TIMER_T *)           TIMER45_BASE)
#define TIMER5               ((TIMER_T *)           (TIMER45_BASE+ 0x100UL))
#define TIMER6               ((TIMER_T *)           TIMER67_BASE)
#define TIMER7               ((TIMER_T *)           (TIMER67_BASE+ 0x100UL))
...
#define UI2C4                ((UI2C_T *)            USCI4_BASE)
#define USPI4                ((USPI_T *)            USCI4_BASE)
#define UUART4               ((UUART_T *)           USCI4_BASE)

...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |Cachemissmonitor|Cache miss monitor counter.
     */
...
#define CACHE_MISS_Cachemissmonitor_Pos  (0)                                               /*!< CACHE_T::MISS: Cachemissmonitor Position*/
#define CACHE_MISS_Cachemissmonitor_Msk  (0xfffful << CACHE_MISS_Cachemissmonitor_Pos)     /*!< CACHE_T::MISS: Cachemissmonitor Mask   */

...
{
    (void)u32DestLen,(void)u32SrcLen,(void)u32TransCount;
...
{
    (void)pdma,(void)u32DestInterval,(void)u32SrcInterval,(void)u32RepeatCount;
    (pdma)->DSCT[u32Ch].CTL |= PDMA_DSCT_CTL_STRIDEEN_Msk;
...
{
    (void)pdma,(void)u32OnOff,(void)u32TimeOutCnt;
    switch(u32Ch)
    {
//        case 0UL:

...
extern LED_FUNC Mode_Function[LED_MODE_COUNT];
...
#endif
extern uint8_t StripALEDData[LED_STRIPA_LEN];
extern volatile LED_Setting_T StripA_LEDSetting;
...
#endif
extern uint8_t StripBLEDData[LED_STRIPB_LEN];
extern volatile LED_Setting_T StripB_LEDSetting;
...
#endif
extern uint8_t FAN1LEDData[LED_FAN1LED_LEN];
extern volatile LED_Setting_T FAN1_LEDSetting;
...
#endif
extern uint8_t FAN2LEDData[LED_FAN2LED_LEN];
extern volatile LED_Setting_T FAN2_LEDSetting;
...
#endif
extern uint8_t FAN3LEDData[LED_FAN3LED_LEN];
extern volatile LED_Setting_T FAN3_LEDSetting;
...
#endif
extern uint8_t FAN4LEDData[LED_FAN4LED_LEN];
extern volatile LED_Setting_T FAN4_LEDSetting;
...
#endif
extern uint8_t FAN5LEDData[LED_FAN5LED_LEN];
extern volatile LED_Setting_T FAN5_LEDSetting;
...
#endif
extern uint8_t FAN6LEDData[LED_FAN6LED_LEN];
extern volatile LED_Setting_T FAN6_LEDSetting;
...
#endif
extern uint8_t FAN7LEDData[LED_FAN7LED_LEN];
extern volatile LED_Setting_T FAN7_LEDSetting;
...
#endif
extern uint8_t FAN8LEDData[LED_FAN8LED_LEN];
extern volatile LED_Setting_T FAN8_LEDSetting;

extern uint8_t *LED_Data_Array_Mapping[TOTAL_LED_AREA];
extern const uint32_t LED_Data_Array_Size[TOTAL_LED_AREA];
extern LLSI_T *LLSI_Port_Mapping[TOTAL_LED_AREA];
...
extern volatile LED_Gen2_Setting_T LED_Gen2_Port_Setting[LED_GEN2_MAX_SUPPORT_PORT];

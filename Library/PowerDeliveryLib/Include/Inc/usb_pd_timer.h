...
enum pd_task_timer {
	...
	/** 
	  * SW ADD for SNK Keep Alive Message Time Out 
		**/
  PE_TIMER_SNK_KEEP_ALIVE_TIMEOUT, 
  ...
  /*
	 * Time allotted for the Source to recover.
	 */
	TC_TIMER_SRC_RECOVER_TIME, 
	
	/*
	 * Time to discharge
	 */
	TC_TIMER_VBUS_FALLING_TIME, 

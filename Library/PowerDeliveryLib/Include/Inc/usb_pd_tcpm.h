...
#endif
    u32Tmp = (uint32_t)polarity & BIT(0);
    return (enum tcpc_cc_polarity)u32Tmp;
}
 ...
 */
static inline bool cc_is_rp(enum tcpc_cc_voltage_status cc)
{
 ...
 */
static inline bool cc_is_open(enum tcpc_cc_voltage_status cc1,
 ...
 */
static inline bool cc_is_snk_dbg_acc(enum tcpc_cc_voltage_status cc1,
                                     enum tcpc_cc_voltage_status cc2)
{
 ...
 */
static inline bool cc_is_src_dbg_acc(enum tcpc_cc_voltage_status cc1,
                                     enum tcpc_cc_voltage_status cc2)
{
 ...
 */
static inline bool cc_is_audio_acc(enum tcpc_cc_voltage_status cc1,
                                   enum tcpc_cc_voltage_status cc2)
{
 ...
 */
static inline bool cc_is_at_least_one_rd(enum tcpc_cc_voltage_status cc1,
                                         enum tcpc_cc_voltage_status cc2)
{
    return (cc1 == TYPEC_CC_VOLT_RD) || (cc2 == TYPEC_CC_VOLT_RD);
}
 ...
 */
static inline bool cc_is_only_one_rd(enum tcpc_cc_voltage_status cc1,
                                     enum tcpc_cc_voltage_status cc2)
{

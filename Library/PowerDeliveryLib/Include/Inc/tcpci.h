...
//#define TCPC_REG_VBUS_SINK_DISCONNECT_THRESH_DEFAULT 0x008C /* 3.5 V @ 2.56V Vref 2.56/1024  */
#define TCPC_REG_VBUS_SINK_DISCONNECT_THRESH_DEFAULT 0x006D /* 3.5 V @ 3.3V Vref 3.3/1024 */

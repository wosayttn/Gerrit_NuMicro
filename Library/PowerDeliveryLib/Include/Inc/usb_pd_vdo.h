...
union active_cable_vdo2_rev30
{
    struct
    {
        ...
        unsigned int usb_20_support : 1;
        uint8_t usb_20_hub_hop : 2;
        unsigned int usb_40_support : 1;
        unsigned int active_elem : 1;
...
union enter_usb_data_obj
{
    struct
    {
        ...
        unsigned int cable_current : 2;
        unsigned int cable_type : 2;
        unsigned int cable_speed : 3;
        uint8_t reserved2 : 1;

...
#define RDO_AUG(n, op_ma, max_mv, flags) \
                (RDO_OBJ_POS(n) | (flags) | \
...
#else
#define PD_T_SENDER_RESPONSE        (29*MSEC) /* For pass TEST.PD.PROT.SRC.2 Get_Source_Cap_No_Request */
																							/* For pass TEST.PD.PROT.SRC.3 SenderResponse Timer_Deadline */
																							/* For pass TEST.PD.PROT.SRC3.02 SenderResponseTimer Timeout */ 	
...
enum pd_dpm_request
{
    ...
    /* SW Add */
    DPM_REQUEST_FR_SWAP = BIT(27),
    DPM_REQUEST_PPS_REQUEST = BIT(28),      //CONFIG_SNK_PPS
    /* SW Add */
#endif
};

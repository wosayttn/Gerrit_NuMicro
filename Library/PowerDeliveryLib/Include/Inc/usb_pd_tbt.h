...
union tbt_mode_resp_device
{
    struct
    {
        ...
        uint32_t tbt_adapter    : 1;    /* enum tbt_adapter_type */
        uint32_t reserved0      : 9;
        uint32_t intel_spec_b0  : 1;    /* enum vendor_specific_support */
        uint32_t reserved1      : 3;
        uint32_t vendor_spec_b0 : 1;    /* enum vendor_specific_support */
        uint32_t vendor_spec_b1 : 1;    /* enum vendor_specific_support */
    };
    uint32_t raw_value;
};
...
union tbt_mode_resp_cable
{
    ...
    {
        uint32_t tbt_alt_mode       : 16;
        uint32_t tbt_cable_speed    : 3;    /* enum tbt_compat_cable_speed */
        uint32_t tbt_rounded        : 2;    /* enum tbt_compat_rounded_support */
        uint32_t tbt_cable          : 1;    /* enum tbt_cable_type */
        uint32_t retimer_type       : 1;    /* enum usb_retimer_type */
        uint32_t lsrx_comm          : 1;    /* enum link_lsrx_comm */
        uint32_t reserved1          : 1;
        uint32_t tbt_active_passive : 1;    /* enum tbt_active_passive_cable */
...
union tbt_dev_mode_enter_cmd
{
    struct
    {
        ...
        uint32_t lsrx_comm       : 1;   /* enum link_lsrx_comm */
        uint32_t tbt_adapter     : 1;   /* enum tbt_adapter_type */
        uint32_t cable           : 1;   /* enum tbt_enter_cable_type */
        uint32_t intel_spec_b0   : 1;   /* enum vendor_specific_support */
        uint32_t reserved1       : 3;
        uint32_t vendor_spec_b0  : 1;   /* enum vendor_specific_support */
        uint32_t vendor_spec_b1  : 1;   /* enum vendor_specific_support */

...
#define SYMBOL_NVT_14                                       ((45)<<4 | (4)<<0)
#define SYMBOL_NUMICRO_15                                   ((9)<<4 | (3)<<0)
#define SYMBOL_WIFI_16                                      ((45)<<4 | (5)<<0)
#define SYMBOL_SOUND_17                                     ((45)<<4 | (6)<<0)
#define SYMBOL_BAT_FRAME_18                                 ((45)<<4 | (0)<<0)
#define SYMBOL_BAT_1_18                                     ((45)<<4 | (2)<<0)
#define SYMBOL_BAT_2_18                                     ((45)<<4 | (3)<<0)
#define SYMBOL_BAT_3_18                                     ((45)<<4 | (1)<<0)

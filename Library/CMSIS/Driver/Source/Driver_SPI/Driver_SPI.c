...
#define RTE_SPI0_PORT                                   0
#define RTE_SPI1_PORT                                   1
//#define SPI2_PORT                                       2
//#define SPI3_PORT                                       3

// Local driver functions declarations (for instances)
#define SPI_INFO_DEFINE(n)                                                                \
    static SPI_RESOURCES SPI_RES_NAME(n) = { SPI_CONCAT2(SPI, n),                         \
                                             { \
                                               SPI_CONCAT3(RTE_SPI, n, _XFER_MODE),       \
																							 0,                                         \
                                             },                                           \
                                             {0},                                         \
                                             {0},                                         \
                                             {-1,                                         \
                                              -1,                                         \
                                              SPI_CONCAT3(RTE_SPI, n, _RX_PDMA),          \
                                              SPI_CONCAT3(RTE_SPI, n, _TX_PDMA),          \
                                              SPI_CONCAT3(RTE_SPI, n, _RX_PDMA_PORT),     \
                                              SPI_CONCAT3(RTE_SPI, n, _TX_PDMA_PORT),     \
                                              SPI_CONCAT3(RTE_SPI, n, _RX_PDMA_CHANNEL),  \
                                              SPI_CONCAT3(RTE_SPI, n, _TX_PDMA_CHANNEL),  \
                                              SPI_CONCAT3(PDMA_SPI, n, _RX),              \
                                              SPI_CONCAT3(PDMA_SPI, n, _TX),              \
                                              }                                           \
                                             };

// Local driver functions declarations (for instances)
#if (RTE_SPI0 == 1)
    SPI_INFO_DEFINE(RTE_SPI0_PORT)
#endif
#if (RTE_SPI1 == 1)
    SPI_INFO_DEFINE(RTE_SPI1_PORT)
#endif
...
static const SPI_RESOURCES *const spi_res_list[] =
{
    ...
    &SPI_RES_NAME(RTE_SPI0_PORT),
#else
    NULL,
#endif

#if defined(RTE_SPI1) && (RTE_SPI1 == 1)
    &SPI_RES_NAME(RTE_SPI1_PORT),
#else
    NULL,
#endif
...
#if (RTE_SPI0 == 1)
    FUNCS_DECLARE(RTE_SPI0_PORT)
#endif
#if (RTE_SPI1 == 1)
    FUNCS_DECLARE(RTE_SPI1_PORT)
#endif
...
#if (RTE_SPI0 == 1)
FUNCS_DEFINE(RTE_SPI0_PORT)
SPI_DRIVER(RTE_SPI0_PORT)

void SPI0_IRQHandler(void)
{
    SPI_IRQHandler(RTE_SPI0_PORT);
}
#endif
#if (RTE_SPI1 == 1)
FUNCS_DEFINE(RTE_SPI1_PORT)
SPI_DRIVER(RTE_SPI1_PORT)

void SPI1_IRQHandler(void)
{
    SPI_IRQHandler(RTE_SPI1_PORT);
}
#endif

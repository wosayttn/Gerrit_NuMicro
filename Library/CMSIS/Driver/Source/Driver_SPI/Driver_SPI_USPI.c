...
#if (!(RTE_SPI0) && !(RTE_SPI1) && !(RTE_SPI2) && !(RTE_SPI3) && !(RTE_SPI4))
...
#define RTE_USPI0                           RTE_SPI3
#define RTE_USPI1                           RTE_SPI4

#define SPI_TO_USPI_INSTANCE(n)             ((n == USPI0_PORT) ? 0 : ((n == USPI1_PORT) ? 1 : 0))
#define SPI_TO_USPI(n)                      ((n == USPI0_PORT) ? USPI0 : ((n == USPI1_PORT) ? USPI1 : USPI0))
#define SPI_TO_USPI_CLK_SRC(n)              ((n == USPI0_PORT) ? RTE_USPI0_CLK_SRC : ((n == USPI1_PORT) ? RTE_USPI1_CLK_SRC : RTE_USPI0_CLK_SRC))
#define SPI_TO_USPI_PDMA_RX(n)              ((n == USPI0_PORT) ? RTE_USPI0_RX_PDMA : ((n == USPI1_PORT) ? RTE_USPI1_RX_PDMA : RTE_USPI0_RX_PDMA))
#define SPI_TO_USPI_PDMA_TX(n)              ((n == USPI0_PORT) ? RTE_USPI0_TX_PDMA : ((n == USPI1_PORT) ? RTE_USPI1_TX_PDMA : RTE_USPI0_TX_PDMA))
#define SPI_TO_USPI_PDMA_RX_PORT(n)         ((n == USPI0_PORT) ? RTE_USPI0_RX_PDMA_PORT : ((n == USPI1_PORT) ? RTE_USPI1_RX_PDMA_PORT : RTE_USPI0_RX_PDMA_PORT))
#define SPI_TO_USPI_PDMA_TX_PORT(n)         ((n == USPI0_PORT) ? RTE_USPI0_TX_PDMA_PORT : ((n == USPI1_PORT) ? RTE_USPI1_TX_PDMA_PORT : RTE_USPI0_TX_PDMA_PORT))
#define SPI_TO_USPI_PDMA_RX_CH(n)           ((n == USPI0_PORT) ? RTE_USPI0_RX_PDMA_CHANNEL : ((n == USPI1_PORT) ? RTE_USPI1_RX_PDMA_CHANNEL : RTE_USPI0_RX_PDMA_CHANNEL))
#define SPI_TO_USPI_PDMA_TX_CH(n)           ((n == USPI0_PORT) ? RTE_USPI0_TX_PDMA_CHANNEL : ((n == USPI1_PORT) ? RTE_USPI1_TX_PDMA_CHANNEL : RTE_USPI0_TX_PDMA_CHANNEL))
#define SPI_TO_USPI_PDMA_RX_NUM(n)          ((n == USPI0_PORT) ? PDMA_USCI0_RX : ((n == USPI1_PORT) ? PDMA_USCI1_RX : PDMA_USCI0_RX))
#define SPI_TO_USPI_PDMA_TX_NUM(n)          ((n == USPI0_PORT) ? PDMA_USCI0_TX : ((n == USPI1_PORT) ? PDMA_USCI1_TX : PDMA_USCI0_TX))
...
// Local driver functions declarations (for instances)
#if (RTE_USPI0 == 1)
    SPI_INFO_DEFINE(USPI0_PORT)
#endif

#if (RTE_USPI1 == 1)
    SPI_INFO_DEFINE(USPI1_PORT)
#endif

// List of available SPI instance infos
static const SPI_RESOURCES *const spi_res_list[] =
{
#if defined(RTE_USPI0) && (RTE_USPI0 == 1)
    &SPI_RES_NAME(USPI0_PORT),
#else
    NULL,
#endif

#if defined(RTE_USPI1) && (RTE_USPI1 == 1)
    &SPI_RES_NAME(USPI1_PORT),
#else
    NULL,
#endif
...
#if (RTE_USPI0 == 1)
    FUNCS_DECLARE(USPI0_PORT)
#endif

#if (RTE_USPI1 == 1)
    FUNCS_DECLARE(USPI1_PORT)
#endif
...
#if (RTE_USPI0 == 1)
FUNCS_DEFINE(USPI0_PORT)
SPI_DRIVER(USPI0_PORT)

void USCI0_IRQHandler(void)
{
    SPI_IRQHandler(USPI0_PORT);
}
#endif

#if (RTE_USPI1 == 1)
FUNCS_DEFINE(USPI1_PORT)
SPI_DRIVER(USPI1_PORT)

void USCI1_IRQHandler(void)
{
    SPI_IRQHandler(USPI1_PORT);
}
#endif

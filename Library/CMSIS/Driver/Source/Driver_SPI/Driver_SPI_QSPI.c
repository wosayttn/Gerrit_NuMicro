...
#define RTE_QSPI0                           RTE_SPI2
//#define RTE_QSPI1                           RTE_SPI4

// SPI Resources
#define SPI_TO_QSPI_INSTANCE(n)             ((n == QSPI0_PORT) ? 0 : 1)
#define SPI_TO_QSPI(n)                      ((n == QSPI0_PORT) ? QSPI0 : QSPI0)
#define SPI_TO_QSPI_CLK_SRC(n)              ((n == QSPI0_PORT) ? RTE_QSPI0_CLK_SRC : RTE_QSPI0_CLK_SRC)
#define SPI_TO_QSPI_XFER_MODE(n)            ((n == QSPI0_PORT) ? RTE_QSPI0_XFER_MODE : RTE_QSPI0_XFER_MODE)
#define SPI_TO_QSPI_PDMA_RX(n)              ((n == QSPI0_PORT) ? RTE_QSPI0_RX_PDMA : RTE_QSPI0_RX_PDMA)
#define SPI_TO_QSPI_PDMA_TX(n)              ((n == QSPI0_PORT) ? RTE_QSPI0_RX_PDMA : RTE_QSPI0_TX_PDMA)
#define SPI_TO_QSPI_PDMA_RX_PORT(n)         ((n == QSPI0_PORT) ? RTE_QSPI0_RX_PDMA_PORT : RTE_QSPI0_RX_PDMA_PORT)
#define SPI_TO_QSPI_PDMA_TX_PORT(n)         ((n == QSPI0_PORT) ? RTE_QSPI0_TX_PDMA_PORT : RTE_QSPI0_TX_PDMA_PORT)
#define SPI_TO_QSPI_PDMA_RX_CH(n)           ((n == QSPI0_PORT) ? RTE_QSPI0_RX_PDMA_CHANNEL : RTE_QSPI0_RX_PDMA_CHANNEL)
#define SPI_TO_QSPI_PDMA_TX_CH(n)           ((n == QSPI0_PORT) ? RTE_QSPI0_TX_PDMA_CHANNEL : RTE_QSPI0_TX_PDMA_CHANNEL)
#define SPI_TO_QSPI_PDMA_RX_NUM(n)          ((n == QSPI0_PORT) ? PDMA_QSPI0_RX : PDMA_QSPI0_RX)
#define SPI_TO_QSPI_PDMA_TX_NUM(n)          ((n == QSPI0_PORT) ? PDMA_QSPI0_TX : PDMA_QSPI0_TX)
...
// Local driver functions declarations (for instances)
#if (RTE_QSPI0 == 1)
    SPI_INFO_DEFINE(QSPI0_PORT)
#endif

#if (RTE_QSPI1 == 1)
    SPI_INFO_DEFINE(QSPI1_PORT)
#endif

// List of available SPI instance infos
static const SPI_RESOURCES *const spi_res_list[] =
{
#if defined(RTE_QSPI0) && (RTE_QSPI0 == 1)
    &SPI_RES_NAME(QSPI0_PORT),
#else
    NULL,
#endif // RTE_QSPI0

#if defined(RTE_QSPI1) && (RTE_QSPI1 == 1)
    &SPI_RES_NAME(QSPI1_PORT),
#else
    NULL,
#endif // RTE_QSPI0
...
#if (RTE_QSPI0 == 1)
    FUNCS_DECLARE(QSPI0_PORT)
#endif

#if (RTE_QSPI1 == 1)
    FUNCS_DECLARE(QSPI1_PORT)
#endif
...
#if (RTE_QSPI0 == 1)
FUNCS_DEFINE(QSPI0_PORT)
SPI_DRIVER(QSPI0_PORT)

void QSPI0_IRQHandler(void)
{
    QSPI_IRQHandler(QSPI0_PORT);
}
#endif

#if (RTE_QSPI1 == 1)
FUNCS_DEFINE(QSPI1_PORT)
SPI_DRIVER(QSPI1_PORT)

void QSPI1_IRQHandler(void)
{
    QSPI_IRQHandler(QSPI1_PORT);
}
#endif

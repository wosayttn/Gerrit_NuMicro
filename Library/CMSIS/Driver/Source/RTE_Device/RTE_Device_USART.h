 ...
 * @version  V1.00
 * @brief    RTE Device Configuration for Nuvoton M3351 UART/SCUART/LPUART/UUART
 *
...
//-------- <<< Use Configuration Wizard in Context Menu >>> --------------------
    ...
    //     <i>  Selects PDMA Channel
    //   </e>
    #define RTE_USART15_RX_PDMA               0
    #define RTE_USART15_RX_PDMA_NUMBER        0
    #define RTE_USART15_RX_PDMA_CHANNEL       14
    ...
    //     <i>  Selects PDMA Channel
    //   </e>
    #define RTE_USART15_TX_PDMA               0
    #define RTE_USART15_TX_PDMA_NUMBER        1
    #define RTE_USART15_TX_PDMA_CHANNEL       14
    // </e>
#endif

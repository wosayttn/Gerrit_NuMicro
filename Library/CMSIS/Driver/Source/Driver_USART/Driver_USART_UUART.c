...
#define USART_TO_UUART(n)                (n == 14 ? UUART0 : UUART1)
#define USART_TO_UUART_PDMA_RX(n)        (n == 14 ? PDMA_USCI0_RX : PDMA_USCI1_RX)
#define USART_TO_UUART_PDMA_TX(n)        (n == 14 ? PDMA_USCI0_TX : PDMA_USCI1_TX)
// Macros

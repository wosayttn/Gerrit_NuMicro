...
To experience the powerful features of M3331 in few minutes, please refer to NuMaker-PFM-M3331 Board Quick Start Guide. You can select the sample code of your interest to download and execute on the M3331 board. You can open the project files to build them with Keil® MDK, IAR or Eclipse, and then download and trace them on the M3331 board to see how it works.

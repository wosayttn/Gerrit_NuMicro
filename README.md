...
In Visual Studio Code, Nuvoton provides Nuvoton NuMicro Cortex-M Pack as a complete development toolkit for NuMicro Cortex-M microcontrollers. Please follow the [NuMicro Cortex-M Pack Environment Setup Guide](https://github.com/OpenNuvoton/Nuvoton_Tools/blob/master/Documents/VSCode_Extensions/Nuvoton_NuMicro_Cortex-M-Pack.md) to set up a NuMicro Cortex-M Pack project.

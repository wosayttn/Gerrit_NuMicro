                                     ...
                                     mbedtls_operation_t cipher_operation)
{
    ...
    PSA_DEBUG_LOG("PSA_CORE",
                  "Calling psa_driver_wrapper_cipher_%s_setup, alg=0x%08x\n",
                  (cipher_operation == MBEDTLS_ENCRYPT) ? "encrypt" : "decrypt",
                  (unsigned) alg);
    ...
    PSA_DEBUG_LOG("PSA_CORE", "Wrapper returned status=%d\n", (int) status);
                                ...
                                size_t *output_length)
{
    ...
    PSA_DEBUG_LOG("PSA_CORE",
                  "Calling psa_driver_wrapper_cipher_encrypt, alg=0x%08x input_len=%zu iv_len=%zu\n",
                  (unsigned) alg, input_length, default_iv_length);
    ...
    PSA_DEBUG_LOG("PSA_CORE",
                  "psa_driver_wrapper_cipher_encrypt returned status=%d\n",
                  (int) status);
                                ...
                                size_t *output_length)
{
    ...
    status = psa_driver_wrapper_cipher_decrypt(
        ...
        output, output_size, output_length);
    PSA_DEBUG_LOG("PSA_CORE",
                  "psa_driver_wrapper_cipher_decrypt returned status=%d\n",
                  (int) status);

...
typedef struct {
  /* Additional space for reciprocal, correction, scale and shift values. */
...
#ifdef WITH_JPEGACC
  /* Reciprocal quantization table storage for accelerated quantization. */
  void * dct_recp_table;
#endif
} jpeg_component_info;
...
struct jpeg_compress_struct {
  ...
  /* ptrs to reciprocal coefficient quantization tables, or NULL if not defined */
#endif

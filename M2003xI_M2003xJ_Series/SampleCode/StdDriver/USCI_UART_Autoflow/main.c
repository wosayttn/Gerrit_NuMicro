...
void USCI_AutoFlow_FunctionTest(void)
{
    ...
    printf("|    the other is slave. Master will send 1k bytes of data to |\n");
    printf("|    the slave. Slave will check if received data is correct  |\n");
...
void USCI_AutoFlow_FunctionRxTest(void)
{
    ...
    /* Wait to receive 1k bytes of data */

...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(TMR1_MODULE, CLK_TMRSEL0_TMR1SEL_HIRC, 0);
    CLK_SetModuleClock(TMR2_MODULE, CLK_TMRSEL0_TMR2SEL_HIRC, 0);
    CLK_SetModuleClock(TMR3_MODULE, CLK_TMRSEL0_TMR3SEL_HIRC, 0);

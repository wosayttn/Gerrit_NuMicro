 ...
 * @file     main.c
 * @version  V1.00
 * @brief    Two Single-Wire data transfer test.
 *
...
void UART1_Init()
{
    ...
    /*Set PB2 IO status to Pull-up for SingleWire */
...
/* UART Test Sample                                                                                        */
/* Test Item                                                                                               */
/* Debug port controls the Single wire 1(UART1) send data to Single wire 1(UART1)                          */
/*---------------------------------------------------------------------------------------------------------*/

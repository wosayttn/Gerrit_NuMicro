 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Demonstrate how to set I2C two-level buffer in Slave mode to receive 256 bytes data from a master.
...
void I2C0_IRQHandler(void)
{
    ...
    else if (u32Status==0xA8)                                   /* Own SLA+R has been received; ACK has been returned */
    {
    ...
    else if (u32Status==0x60)                                   /* Own SLA+W has been received; ACK has been returned */
    {
        g_u8SlvDataLen = 0;
    }
    else

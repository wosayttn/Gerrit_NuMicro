...
#define RS485_ADDRESS1     0xC0
#define RS485_ADDRESS2     0xA2
#define RS485_ADDRESS3     0xB1
#define RS485_ADDRESS4     0xD3
...
void RS485_9bitModeSlave(void)
{
    ...
    printf("| Receive address and data bytes.                           |\n");
    printf("+-----------------------------------------------------------+\n");
...
void RS485_9bitModeMaster(void)
{
    ...
    printf("+-----------------------------------------------------------+\n");
    printf("| The function will send different addresses with 10 data   |\n");
...
void RS485_FunctionTest(void)
{
    ...
    /*
        ...
        Master:
            ...
            5.RTS pin is low in idle state. When master is sending, RTS pin will be pulled high.
        ...
        Note: User can measure transmitted data waveform on TX and RX pin.
              RTS pin is used by RS485 transceiver to control transmission direction.
              RTS pin is low in idle state. When master is sending data, RTS pin will be pulled high.

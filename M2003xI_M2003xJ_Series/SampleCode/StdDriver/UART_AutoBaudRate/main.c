...
uint32_t GetUartBaudrate(UART_T *uart)
{
    ...
    uint32_t u32ClkTbl[] = {0ul, __LIRC, __LXT, __HXT, __HIRC};
    ...
    {
    case UART0_BASE:
        u8UartClkSrcSel = (CLK->UARTSEL & CLK_UARTSEL_UART0SEL_Msk) >> CLK_UARTSEL_UART0SEL_Pos;
        u8UartClkDivNum = (CLK->UARTDIV & CLK_UARTDIV_UART0DIV_Msk) >> CLK_UARTDIV_UART0DIV_Pos;
        break;
    case UART1_BASE:
        u8UartClkSrcSel = (CLK->UARTSEL & CLK_UARTSEL_UART1SEL_Msk) >> CLK_UARTSEL_UART1SEL_Pos;
        u8UartClkDivNum = (CLK->UARTDIV & CLK_UARTDIV_UART1DIV_Msk) >> CLK_UARTDIV_UART1DIV_Pos;
        break;
    default:
        return 0;
    }

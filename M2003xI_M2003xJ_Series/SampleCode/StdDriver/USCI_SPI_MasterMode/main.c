...
int main()
{
    ...
    printf("USCI_SPI controller will transfer %d data to an off-chip slave device.\n", TEST_COUNT);
    printf("Meanwhile, the USCI_SPI controller will receive %d data from the off-chip slave device.\n", TEST_COUNT);
    ...
    printf("The data transfer is done.\n");
...
void USCI_SPI_Init(void)
{
    ...
    USPI_Open(USPI0, USPI_MASTER, USPI_MODE_0, 16, 1000000);

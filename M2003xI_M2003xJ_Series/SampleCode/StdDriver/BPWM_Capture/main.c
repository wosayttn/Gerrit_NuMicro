 ...
 * @file     main.c
 * @version  V0.10
 * @brief    Use BPWM0 Channel 0(PA.5) to capture the Timer0 (PB.5) Waveform.
 *
...
void SYS_Init(void)
{
    ...
    /* Switch the core clock to 40 MHz */
...
int32_t main(void)
{
    ...
    printf("    BPWM0_CH0(PA.5 BPWM0 channel 0) <--> TM0(PB.5 TIMER0 toggle out pin)\n\n");
    printf("Use BPWM0 Channel 0(PA.5) to capture the TIMER0 toggle out pin(PB.5) Waveform\n");

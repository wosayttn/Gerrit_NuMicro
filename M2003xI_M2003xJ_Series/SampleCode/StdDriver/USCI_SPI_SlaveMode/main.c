...
int main()
{
    ...
    printf("USCI_SPI controller will transfer %d data to an off-chip master device.\n", TEST_COUNT);
    printf("Meanwhile, the USCI_SPI controller will receive %d data from the off-chip master device.\n", TEST_COUNT);

...
void IrDA_FunctionTest(void)
{
    ...
    /*
        ...
        Input char on terminal will be sent to the UART0 of master.
        After the master receiving, the input character will send to UART0 again.
        At the same time, it also sends to UART1 TX pin by IrDA mode.
        Slave will print received character after UART1 send it out.
    ...
    */
    ...
    printf("|    terminal input and Slave will print received data on     |\n");
...
void IrDA_FunctionTxTest(void)
{
    ...
    printf("+-----------------------------------------------------------+\n");
    printf("| 1). Input character by UART0 terminal.                    |\n");
    printf("| 2). UART1 will send a char according to step 1.           |\n");
    printf("| 3). Repeat step 1. (Press '0' to exit)                    |\n");
    printf("+-----------------------------------------------------------+\n\n");
...
void IrDA_FunctionRxTest(void)
{
    ...
    printf("+-----------------------------------------------------------+\n");
    printf("| 1). Polling RDA_Flag to check data input through UART     |\n");

...
void USCI_UART_FunctionTest(void)
{
    ...
    /*
        ...
        USCI-UART0 is set to debug port. USCI-UART0 enables RX and TX end interrupt.
        When inputting terminal to the terminal screen, RX end interrupt will happen and

...
#define I2C1_PDMA_RX_CH     0
#define I2C0_PDMA_RX_CH     1
#define I2C1_PDMA_TX_CH     1
...
volatile uint8_t g_u8TestMasterMode;
...
{
    if(u32Status == 0x60)                       /* Own SLA+W has been received; ACK has been returned */
    {
        /*
            Note:
...
void PDMA_Init(void)
{
    if(g_u8TestMasterMode == 1)
    {
        ...
        PDMA_Open(PDMA0, 1 << I2C0_PDMA_RX_CH); // Channel 1 for I2C0 RX
    ...
    {
        /* Open PDMA Channel */
        PDMA_Open(PDMA0, 1 << I2C1_PDMA_RX_CH); // Channel 0 for I2C1 RX
...
void I2C_PDMA(void)
{
    ...
    printf("|  [1] Master    [0] Slave                                    |\n");
    printf("+-------------------------------------------------------------+\n\n");
    g_u8TestMasterMode = getchar() - 0x30;
    ...
    if(g_u8TestMasterMode == 1)
    {
        printf("Enter any key to start Master PDMA Tx mode test.\n");
        getchar();
        ...
        printf("Enter any key to start Master PDMA Rx mode test.\n");
        getchar();
    ...
    else
    {
        ...
        printf("Slave PDMA Rx mode test end");
        ...
        printf("Enter any key to exit Slave PDMA Tx mode test.\n");
        getchar();

...
void UART1_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->INTSTS;

    if (u32IntSrc & 0x11)
    {
        while (((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < 64))
        {
            uart_rcvbuf[bufhead++] = ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->DAT;
        }
    }
...
void PutString(void)
{
    ...
    for (i = 0; i < 64; i++)
    {
        while ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FIFOSTS & (0x1ul << (23))));

        ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->DAT = response_buff[i];
    }
}
...
void UART_Init()
{
    ...
    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FUNCSEL = ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FUNCSEL & (~(0x7ul << (0)))) | ((0x0UL << (0))));

    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->LINE = (3UL) | (0x0UL << (3)) | (0x0UL << (2));

    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FIFO = (0x3UL << (4)) | (0x3UL << (16));

    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((40000000UL)) + ((115200)/2ul)) / (115200))-2ul));

    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->TOUT = (((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->TOUT & ~(0xfful << (0))) | (0x40);
    __NVIC_SetPriority(UART1_IRQn, 2);
    __NVIC_EnableIRQ(UART1_IRQn);

    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}

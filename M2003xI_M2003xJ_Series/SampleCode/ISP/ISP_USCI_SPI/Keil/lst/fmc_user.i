...
void UpdateConfig(uint32_t *data, uint32_t *res)
{
    ...
    FMC_Proc(0x22UL, 0x0F300000UL, 0x0F300000UL + 8, 0);
    FMC_Proc(0x21UL, 0x0F300000UL, 0x0F300000UL + u32Size, data);

    if (res)
    {
        FMC_Proc(0x00UL, 0x0F300000UL, 0x0F300000UL + u32Size, res);
    }

...
#ifndef __SYSTEM_M2003J_H__
#define __SYSTEM_M2003J_H__
...
/*----------------------------------------------------------------------------
  Define clocks
 *----------------------------------------------------------------------------*/
#define __LIRC      (32000UL)       /*!< Internal 32KHz RC Oscillator Frequency */
#define __HXT       (12000000UL)    /*!< External Crystal Clock Frequency     */
#define __HIRC      (40000000UL)    /*!< Internal 40M RC Oscillator Frequency */
#define __LXT       (32768UL)       /*!< External Crystal Clock Frequency 32.768KHz */
#define __HSI       (40000000UL)    /*!< Default output is 40MHz for PLL */

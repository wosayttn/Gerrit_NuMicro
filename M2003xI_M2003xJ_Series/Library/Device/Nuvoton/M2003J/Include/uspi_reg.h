...
#define USPI_IUR_TDIPTR_Pos              (0)                                               /*!< USPI_T::IUR: TDIPTR Position           */
#define USPI_IUR_TDIPTR_Msk              (0x1ful << USPI_IUR_TDIPTR_Pos)                   /*!< USPI_T::IUR: TDIPTR Mask               */

#define USPI_IUR_TDOPTR_Pos              (5)                                               /*!< USPI_T::IUR: TDOPTR Position           */
#define USPI_IUR_TDOPTR_Msk              (0x1ful << USPI_IUR_TDOPTR_Pos)                   /*!< USPI_T::IUR: TDOPTR Mask               */

#define USPI_IUR_RDIPTR_Pos              (10)                                              /*!< USPI_T::IUR: RDIPTR Position           */
#define USPI_IUR_RDIPTR_Msk              (0x1ful << USPI_IUR_RDIPTR_Pos)                   /*!< USPI_T::IUR: RDIPTR Mask               */

#define USPI_IUR_RDOPTR_Pos              (15)                                              /*!< USPI_T::IUR: RDOPTR Position           */
#define USPI_IUR_RDOPTR_Msk              (0x1ful << USPI_IUR_RDOPTR_Pos)                   /*!< USPI_T::IUR: RDOPTR Mask               */

#define USPI_IUR_SELFTEST_Pos            (30)                                              /*!< USPI_T::IUR: SELFTEST Position         */
#define USPI_IUR_SELFTEST_Msk            (0x1ul << USPI_IUR_SELFTEST_Pos)                  /*!< USPI_T::IUR: SELFTEST Mask             */

#define USPI_IUR_HDPRSEL_Pos             (31)                                              /*!< USPI_T::IUR: HDPRSEL Position          */
#define USPI_IUR_HDPRSEL_Msk             (0x1ul << USPI_IUR_HDPRSEL_Pos)                   /*!< USPI_T::IUR: HDPRSEL Mask              */

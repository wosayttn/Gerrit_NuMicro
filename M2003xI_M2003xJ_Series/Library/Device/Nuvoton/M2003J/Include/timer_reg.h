...
typedef struct
{
     ...
     * |        |          |The Timer0/2/4/6 will be in event counter mode and counting with external clock source or event
     * |        |          |Also, Timer1/3/5/7 will be in trigger-counting mode of capture function.
     * |        |          |0 = Inter-Timer Trigger Capture mode Disabled.
     * |        |          |1 = Inter-Timer Trigger Capture mode Enabled.
     * |        |          |Note: For Timer1/3/5/7, this bit is ineffective and the read back value is always 0.
     ...
     * |        |          |When user updates CMPDAT while timer is running in periodic mode, the limitations as following list,
     ...
     * |        |          |000 = Event Counter input source is from external TMx (x= 0~8) pin.
     * |        |          |001~111 = Reserved.
     * |[21:20] |CAPLSEL   |Capture Trigger Length Selection
     * |        |          |00 = TMx_EXT (x= 0,2,4,6) pin input capture length 1 selection.
     * |        |          |01 = TMx_EXT (x= 0,2,4,6) pin input capture length 2 selection.
     * |        |          |10 = TMx_EXT (x= 0,2,4,6) pin input capture length 3 selection.
     * |        |          |11 = TMx_EXT (x= 0,2,4,6) pin input capture length 4 selection.
     ...
     * |        |          |0 = Time-out interrupt signal is used to internal trigger BPWM, PDMA and ADC.
     * |        |          |1 = Capture interrupt signal is used to internal trigger BPWM, PDMA and ADC.
     * |[1]     |TRGBPWM   |Trigger BPWM Enable Bit
     ...
     * |        |          |Note: If TRGSSEL (TIMERx_TRGCTL[0]) = 0, time-out interrupt signal as BPWM counter clock source.
     * |        |          |If TRGSSEL (TIMERx_TRGCTL[0]) = 1, capture interrupt signal as BPWM counter clock source.
     ...
     * |[3]     |TRGPDMA   |Trigger PDMA Enable Bit
     ...
     * @var TIMER_T::CAP1
     * Offset: 0x78  Timer0 Capture Data 1 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CAPDATn   |Timer Capture Data n Register
     * |        |          |When CAPEN (TIMERx_EXTCTL[3]) bit is set and CAPLSEL(TIMERx_EXTCTL[21:20]) not equal to 00b, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT pin matched the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, CAPIF (TIMERx_EINTSTS[0]) will set to 1 and the current timer counter value CNT (TIMERx_CNT[23:0]) will be auto-loaded into this CAPDATn field.
     * @var TIMER_T::CAP2
     * Offset: 0x7C  Timer0 Capture Data 2 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CAPDATn   |Timer Capture Data n Register
     * |        |          |When CAPEN (TIMERx_EXTCTL[3]) bit is set and CAPLSEL(TIMERx_EXTCTL[21:20]) not equal to 00b, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT pin matched the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, CAPIF (TIMERx_EINTSTS[0]) will set to 1 and the current timer counter value CNT (TIMERx_CNT[23:0]) will be auto-loaded into this CAPDATn field.
     * @var TIMER_T::CAP3
     * Offset: 0x80  Timer0 Capture Data 3 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CAPDATn   |Timer Capture Data n Register
     * |        |          |When CAPEN (TIMERx_EXTCTL[3]) bit is set and CAPLSEL(TIMERx_EXTCTL[21:20]) not equal to 00b, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT pin matched the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, CAPIF (TIMERx_EINTSTS[0]) will set to 1 and the current timer counter value CNT (TIMERx_CNT[23:0]) will be auto-loaded into this CAPDATn field.
     * @var TIMER_T::CTL
     * Offset: 0x100  TIMER Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |PSC       |Prescale Counter
     ...
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     * @var TIMER_T::CMP
     * Offset: 0x104  TIMER Comparator Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CMPDAT    |Timer Comparator Value
     ...
     * |        |          |But if timer is operating at other modes, the 24-bit up counter will restart counting from 0 and using newest CMPDAT value to be the timer compared value while user writes a new value into CMPDAT field.
     * @var TIMER_T::INTSTS
     * Offset: 0x108  TIMER Interrupt Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |TIF       |Timer Interrupt Flag
     ...
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * @var TIMER_T::CNT
     * Offset: 0x10C  TIMER Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CNT       |Timer Data Register
     ...
     * |        |          |1 = Reset operation triggered by writing TIMERx_CNT is in progress.
     * @var TIMER_T::CAP
     * Offset: 0x110  TIMER Capture Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CAPDAT    |Timer Capture Data Register
     * |        |          |When CAPEN (TIMERx_EXTCTL[3]) bit is set, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT pin matched the CAPEDGE (TIMERx_EXTCTL[14:12]) setting, CAPIF (TIMERx_EINTSTS[0]) will set to 1 and the current timer counter value CNT (TIMERx_CNT[23:0]) will be auto-loaded into this CAPDAT field.
     * @var TIMER_T::EXTCTL
     * Offset: 0x114  TIMER External Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CNTPHASE  |Timer External Count Phase
     ...
     * |        |          |Note: Set INTERCAPSEL (TIMERx_EXTCTL[10:8]) and CAPSRC (TIMERx_CTL[22]) to select capture source.
     * @var TIMER_T::EINTSTS
     * Offset: 0x118  TIMER External Interrupt Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPIF     |Timer External Capture Interrupt Flag
     ...
     * |        |          |Note: This bit will be cleared automatically when user clear corresponding CAPIF.
     * @var TIMER_T::TRGCTL
     * Offset: 0x11C  TIMER Trigger Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |TRGSSEL   |Trigger Source Select Bit
     ...
     * |        |          |If TRGSSEL (TIMERx_TRGCTL[0]) = 1, capture interrupt signal will trigger PDMA transfer.
     * @var TIMER_T::CAPNF
     * Offset: 0x124  TIMER Capture Input Noise Filter Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
    ...
    __I  uint32_t CAP1;                  /*!< [0x0078] Timer0 Capture Data 1 Register                                   */
    __I  uint32_t CAP2;                  /*!< [0x007c] Timer0 Capture Data 2 Register                                   */
    __I  uint32_t CAP3;                  /*!< [0x0080] Timer0 Capture Data 3 Register                                   */
...
#define TIMER_EXTCTL_SCAPEDGE_Pos        (1)                                               /*!< TIMER_T::EXTCTL: SCAPEDGE Position     */
#define TIMER_EXTCTL_SCAPEDGE_Msk        (0x3ul << TIMER_EXTCTL_SCAPEDGE_Pos)              /*!< TIMER_T::EXTCTL: SCAPEDGE Mask         */
...
#define TIMER_TRGCTL_TRGBPWM_Pos         (1)                                               /*!< TIMER_T::TRGCTL: TRGBPWM Position      */
#define TIMER_TRGCTL_TRGBPWM_Msk         (0x1ul << TIMER_TRGCTL_TRGBPWM_Pos)               /*!< TIMER_T::TRGCTL: TRGBPWM Mask          */
...
#define TIMER_TRGCTL_TRGPDMA_Pos         (3)                                               /*!< TIMER_T::TRGCTL: TRGPDMA Position      */
...
#define TIMER_CAP1_CAPDATn_Pos           (0)                                               /*!< TIMER_T::CAP1: CAPDATn Position        */
#define TIMER_CAP1_CAPDATn_Msk           (0xfffffful << TIMER_CAP1_CAPDATn_Pos)            /*!< TIMER_T::CAP1: CAPDATn Mask            */

#define TIMER_CAP2_CAPDATn_Pos           (0)                                               /*!< TIMER_T::CAP2: CAPDATn Position        */
#define TIMER_CAP2_CAPDATn_Msk           (0xfffffful << TIMER_CAP2_CAPDATn_Pos)            /*!< TIMER_T::CAP2: CAPDATn Mask            */

#define TIMER_CAP3_CAPDATn_Pos           (0)                                               /*!< TIMER_T::CAP3: CAPDATn Position        */
#define TIMER_CAP3_CAPDATn_Msk           (0xfffffful << TIMER_CAP3_CAPDATn_Pos)            /*!< TIMER_T::CAP3: CAPDATn Mask            */
...
//#define TIMER_EXTCTL_INTERCAPSEL_Pos     (8)                                               /*!< TIMER_T::EXTCTL: INTERCAPSEL Position  */
//#define TIMER_EXTCTL_INTERCAPSEL_Msk     (0x7ul << TIMER_EXTCTL_INTERCAPSEL_Pos)           /*!< TIMER_T::EXTCTL: INTERCAPSEL Mask      */
#define TIMER_EXTCTL_ICAPSEL_Pos     (8)                                               /*!< TIMER_T::EXTCTL: INTERCAPSEL Position  */
#define TIMER_EXTCTL_ICAPSEL_Msk     (0x7ul << TIMER_EXTCTL_ICAPSEL_Pos)           /*!< TIMER_T::EXTCTL: INTERCAPSEL Mask      */
...
#define TIMER_VERSION_MINOR_Pos          (0)                                               /*!< TIMER_T::VERSION: MINOR Position       */
#define TIMER_VERSION_MINOR_Msk          (0xfffful << TIMER_VERSION_MINOR_Pos)             /*!< TIMER_T::VERSION: MINOR Mask           */

#define TIMER_VERSION_SUB_Pos            (16)                                              /*!< TIMER_T::VERSION: SUB Position         */
#define TIMER_VERSION_SUB_Msk            (0xfful << TIMER_VERSION_SUB_Pos)                 /*!< TIMER_T::VERSION: SUB Mask             */

#define TIMER_VERSION_MAJOR_Pos          (24)                                              /*!< TIMER_T::VERSION: MAJOR Position       */
#define TIMER_VERSION_MAJOR_Msk          (0xfful << TIMER_VERSION_MAJOR_Pos)               /*!< TIMER_T::VERSION: MAJOR Mask           */
/**@}*/ /* TIMER_CONST */

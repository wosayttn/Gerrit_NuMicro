...
typedef struct
{
    ...
    /**
     * @var GPIO_T::MODE
     * Offset: 0x00/0x40/0x80/0xC0/0x100/0x140/0x180  Port A-G I/O Mode Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|MODEn    |Port A-G I/O Pin[n] Mode Control
     * |        |          |Determine each I/O mode of Px.n pins.
     * |        |          |00 = Px.n is in Input mode (tri-state).
     * |        |          |01 = Px.n is in Push-pull Output mode.
     * |        |          |10 = Px.n is in Open-drain Output mode.
     * |        |          |11 = Px.n is in Quasi-bidirectional mode.
     * |        |          |Note 1: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter.
     * |        |          |Note 2: If MFOS is enabled then GPIO mode setting is ignored.
     * @var GPIO_T::DINOFF
     * Offset: 0x04/0x44/0x84/0xC4/0x104/0x144/0x184  Port A-G Digital Input Path Disable Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n+16]  |DINOFFn   |Port A-G Pin[n] Digital Input Path Disable Bit
     ...
     * @var GPIO_T::DOUT
     * Offset: 0x08/0x48/0x88/0xC8/0x108/0x148/0x188  Port A-G Data Output Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DOUTn     |Port A-G Pin[n] Output Value
     ...
     * |        |          |Note 1: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter.
     * @var GPIO_T::DATMSK
     * Offset: 0x0C/0x4C/0x8C/0xCC/0x10C/0x14C/0x18C  Port A-G Data Output Write Mask
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DATMSKn   |Port A-G Pin[n] Data Output Write Mask
     ...
     * @var GPIO_T::PIN
     * Offset: 0x10/0x50/0x90/0xD0/0x110/0x150/0x190  Port A-G Pin Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |PINn      |Port A-G Pin[n] Pin Value
     * |        |          |Each bit of the register reflects the actual status of the respective Px.n pin.
     * |        |          |0 = The corresponding pin status is low.
     * |        |          |1 = The corresponding pin status is high.
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter..
     * @var GPIO_T::DBEN
     * Offset: 0x14/0x54/0x94/0xD4/0x114/0x154/0x194  Port A-G De-bounce Enable Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DBENn     |Port A-G Pin[n] Input Signal De-bounce Enable Bit
     ...
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter..
     * @var GPIO_T::INTTYPE
     * Offset: 0x18/0x58/0x98/0xD8/0x118/0x158/0x198  Port A-G Interrupt Trigger Type Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |TYPEn     |Port A-G Pin[n] Edge or Level Detection Interrupt Trigger Type Control
     ...
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter..
     * @var GPIO_T::INTEN
     * Offset: 0x1C/0x5C/0x9C/0xDC/0x11C/0x15C/0x19C  Port A-G Interrupt Enable Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |FLIENn    |Port A-G Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Bit
     ...
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter.
     * @var GPIO_T::INTSRC
     * Offset: 0x20/0x60/0xA0/0xE0/0x120/0x160/0x1A0  Port A-G Interrupt Source Flag
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |INTSRCn   |Port A-G Pin[n] Interrupt Source Flag
     * |        |          |Write Operation:
     * |        |          |0 = No action.
     ...
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter..
     * @var GPIO_T::SMTEN
     * Offset: 0x24/0x64/0xA4/0xE4/0x124/0x164/0x1A4  Port A-G Input Schmitt Trigger Enable Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |SMTENn    |Port A-G Pin[n] Input Schmitt Trigger Enable Bit
     * |        |          |0 = Px.n input schmitt trigger function Disabled.
     * |        |          |1 = Px.n input schmitt trigger function Enabled.
     * |        |          |Note: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter.
     * @var GPIO_T::SLEWCTL
     * Offset: 0x28/0x68/0xA8/0xE8/0x128/0x168/0x1A8  Port A-G High Slew Rate Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|HSRENn   |Port A-G Pin[n] High Slew Rate Control
     * |        |          |00 = Px.n output with normal slew rate mode (maximum 16 MHz at 2.7V).
     * |        |          |01 = Px.n output with high slew rate mode (maximum 25 MHz at 2.7V).
     * |        |          |10 = Reserved.
     * |        |          |11 = Reserved.
     * |        |          |Note 1: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter.
     ...
     * @var GPIO_T::PUSEL
     * Offset: 0x30/0x70/0xB0/0xF0/0x130/0x170/0x1B0  Port A-G Pull-up and Pull-down Selection Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|PUSELn   |Port A-G Pin[n] Pull-up and Pull-down Enable Register
     ...
     * |        |          |The independent pull-up control register only valid when MODEn set as input and open-drain mode even if I/O function is switched to multi-function pin
     * |        |          |Ex: UARTx_RXD.
     ...
     * |        |          |Note 2: For more information about Px.n, please refer to the 'PIN CONFIGURATION' chapter., PE.15 pin only support pull-up enabled or disalbed.
     * @var GPIO_T::DBCTL
     * Offset: 0x34/0x74/0xB4/0xF4/0x134/0x174/0x1B4  Port A-G Interrupt De-bounce Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     */
    __IO uint32_t MODE;                  /*!< [0x00/0x40/0x80/0xC0/0x100/0x140/0x180]   Port A-G I/O Mode Control                         */
    __IO uint32_t DINOFF;                /*!< [0x04/0x44/0x84/0xC4/0x104/0x144/0x184]   Port A-G Digital Input Path Disable Control       */
    __IO uint32_t DOUT;                  /*!< [0x08/0x48/0x88/0xC8/0x108/0x148/0x188]   Port A-G Data Output Value                        */
    __IO uint32_t DATMSK;                /*!< [0x0C/0x4C/0x8C/0xCC/0x10C/0x14C/0x18C]   Port A-G Data Output Write Mask                   */
    __I  uint32_t PIN;                   /*!< [0x10/0x50/0x90/0xD0/0x110/0x150/0x190]   Port A-G Pin Value                                */
    __IO uint32_t DBEN;                  /*!< [0x14/0x54/0x94/0xD4/0x114/0x154/0x194]   Port A-G De-bounce Enable Control Register        */
    __IO uint32_t INTTYPE;               /*!< [0x18/0x58/0x98/0xD8/0x118/0x158/0x198]   Port A-G Interrupt Trigger Type Control           */
    __IO uint32_t INTEN;                 /*!< [0x1C/0x5C/0x9C/0xDC/0x11C/0x15C/0x19C]   Port A-G Interrupt Enable Control Register        */
    __IO uint32_t INTSRC;                /*!< [0x20/0x60/0xA0/0xE0/0x120/0x160/0x1A0]   Port A-G Interrupt Source Flag                    */
    __IO uint32_t SMTEN;                 /*!< [0x24/0x64/0xA4/0xE4/0x124/0x164/0x1A4]   Port A-G Input Schmitt Trigger Enable Register    */
    __IO uint32_t SLEWCTL;               /*!< [0x28/0x68/0xA8/0xE8/0x128/0x168/0x1A8]   Port A-G High Slew Rate Control Register          */
    __I  uint32_t RESERVE0[1];
    __IO uint32_t PUSEL;                 /*!< [0x30/0x70/0xB0/0xF0/0x130/0x170/0x1B0]   Port A-G Pull-up and Pull-down Selection Register */
    __IO uint32_t DBCTL;                 /*!< [0x34/0x74/0xB4/0xF4/0x134/0x174/0x1B4]   Port A-G Interrupt De-bounce Control Register     */
...
typedef struct
{
     ...
     * |        |          |000 = Filter clock is HCLK0.
     * |        |          |001 = Filter clock is HCLK0/2.
     * |        |          |010 = Filter clock is HCLK0/4.
     * |        |          |011 = Filter clock is HCLK0/8.
     * |        |          |100 = Filter clock is HCLK0/16.
     * |        |          |101 = Filter clock is HCLK0/32.
     * |        |          |110 = Filter clock is HCLK0/64.
     * |        |          |111 = Filter clock is HCLK0/128.
     ...
     * |        |          |Note:
     * |        |          |Write 1 clear INTx_EDSTS after configuring EINT and then enable INTx_ EDINTEN.
     * @var GPIO_INT_T::INT0_EDSTS
     * Offset: 0x44C  INT0 Edge Detect Interrupt Flag Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EDIF      |INT Edge Detect Interrupt Flag (Write 1 to Clear)
     ...
     * |        |          |Note 1: This bit is cleared by writing 1 to it.
     */
    __IO uint32_t INT0_INNF;             /*!< [0x0440] INT0 Input Noise Filter Register                                 */
    __IO uint32_t INT0_EDETCTL;          /*!< [0x0444] INT0 Edge Detect Control Register                                */
    __IO uint32_t INT0_EDINTEN;          /*!< [0x0448] INT0 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT0_EDSTS;            /*!< [0x044c] INT0 Edge Detect Interrupt Flag Register                         */
    __I  uint32_t RESERVE0[4];
    __IO uint32_t INT1_INNF;             /*!< [0x0460] INT1 Input Noise Filter Register                                 */
    __IO uint32_t INT1_EDETCTL;          /*!< [0x0464] INT1 Edge Detect Control Register                                */
    __IO uint32_t INT1_EDINTEN;          /*!< [0x0468] INT1 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT1_EDSTS;            /*!< [0x046c] INT1 Edge Detect Interrupt Flag Register                         */
    __I  uint32_t RESERVE1[4];
    __IO uint32_t INT2_INNF;             /*!< [0x0480] INT2 Input Noise Filter Register                                 */
    __IO uint32_t INT2_EDETCTL;          /*!< [0x0484] INT2 Edge Detect Control Register                                */
    __IO uint32_t INT2_EDINTEN;          /*!< [0x0488] INT2 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT2_EDSTS;            /*!< [0x048c] INT2 Edge Detect Interrupt Flag Register                         */
    __I  uint32_t RESERVE2[4];
    __IO uint32_t INT3_INNF;             /*!< [0x04a0] INT3 Input Noise Filter Register                                 */
    __IO uint32_t INT3_EDETCTL;          /*!< [0x04a4] INT3 Edge Detect Control Register                                */
    __IO uint32_t INT3_EDINTEN;          /*!< [0x04a8] INT3 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT3_EDSTS;            /*!< [0x04ac] INT3 Edge Detect Interrupt Flag Register                         */
    __I  uint32_t RESERVE3[4];
    __IO uint32_t INT4_INNF;             /*!< [0x04c0] INT4 Input Noise Filter Register                                 */
    __IO uint32_t INT4_EDETCTL;          /*!< [0x04c4] INT4 Edge Detect Control Register                                */
    __IO uint32_t INT4_EDINTEN;          /*!< [0x04c8] INT4 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT4_EDSTS;            /*!< [0x04cc] INT4 Edge Detect Interrupt Flag Register                         */
    __I  uint32_t RESERVE4[4];
    __IO uint32_t INT5_INNF;             /*!< [0x04e0] INT5 Input Noise Filter Register                                 */
    __IO uint32_t INT5_EDETCTL;          /*!< [0x04e4] INT5 Edge Detect Control Register                                */
    __IO uint32_t INT5_EDINTEN;          /*!< [0x04e8] INT5 Edge Detect Interrupt Enable Control Register               */
    __IO uint32_t INT5_EDSTS;            /*!< [0x04ec] INT5 Edge Detect Interrupt Flag Register                         */

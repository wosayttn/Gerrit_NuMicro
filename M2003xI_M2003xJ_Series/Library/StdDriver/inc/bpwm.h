 ...
 * @file     bpwm.h
 * @version  V3.00
 * @brief    M2003J series BPWM driver header file
 *
...
#define BPWM_CLKSRC_TIMER6                        (7UL)    /*!< BPWM Clock source selects to TIMER6 overflow */
#define BPWM_CLKSRC_TIMER7                        (8UL)    /*!< BPWM Clock source selects to TIMER7 overflow */
#define BPWM_CLKSRC_TIMER8                        (9UL)    /*!< BPWM Clock source selects to TIMER8 overflow */
...
#define BPWM_CLKSRC_TIMER4                        (5UL)    /*!< BPWM Clock source selects to TIMER4 overflow \hideinitializer */
#define BPWM_CLKSRC_TIMER5                        (6UL)    /*!< BPWM Clock source selects to TIMER5 overflow \hideinitializer */
#define BPWM_CLKSRC_TIMER6                        (7UL)    /*!< BPWM Clock source selects to TIMER6 overflow \hideinitializer */
#define BPWM_CLKSRC_TIMER7                        (8UL)    /*!< BPWM Clock source selects to TIMER7 overflow \hideinitializer */
#define BPWM_CLKSRC_TIMER8                        (9UL)    /*!< BPWM Clock source selects to TIMER8 overflow \hideinitializer */

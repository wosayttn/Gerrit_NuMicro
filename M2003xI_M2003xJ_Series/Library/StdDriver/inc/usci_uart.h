 ...
 * @file     usci_uart.h
 * @version  V3.00
 * @brief    M2003J series USCI UART (UUART) driver header file
 *
 ...
 *                  It indicates if specified usci_uart port transmission is over or not.
 *    \hideinitializer
 */
 ...
 *                  It indicates if specified usci_uart port receiver is empty or not.
 *    \hideinitializer
 */
 ...
 *    @retval       1       Chip woken up from power-down mode.
 *

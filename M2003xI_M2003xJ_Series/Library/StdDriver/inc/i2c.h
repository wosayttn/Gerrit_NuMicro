 ...
 * @file     i2c.h
 * @version  V1.00
 * @brief    M2003J series I2C driver header file
 *
 ...
 *    @param[in]    i2c     Specify I2C port
 *
 *    @retval       0       I2C Bus time-out has not happened
 *    @retval       1       I2C Bus time-out has happened
 *
 ...
 *    @param[in]    i2c     Specify I2C port
 *
 *    @retval       0       Write command is recorded on the address match wakeup frame
 *    @retval       1       Read command is recorded on the address match wakeup frame.
 *

 ...
 * @file     adc.h
 * @version  V0.10
 * @brief    M2003J Series ADC Driver Header File
 *
...
#define ADC_ADCMPR_CMPMCNT(x)                 (((x)-1) << ADC_ADCMPR_CMPMCNT_Pos)   /*!< Match count for compare function       \hideinitializer */
...
/**
  ...
  * @param[in] u32ChNum ADC Channel, valid value are from 0 to 23 and 29.
  * @return  16-bit data.
...
/**
  ...
  * @param[in] adc          The pointer of the specified ADC module.
  * @param[in] u32ChNum     Specifies the source channel, valid value are from 0 to 23 and 29.
...
/**
  ...
  * @param[in] adc      The pointer of the specified ADC module.
  * @param[in] u32Mask  Channel enable bit. Each bit corresponds to a input channel. Bit 0 is channel 0, bit 1 is channel 1..., bit 29 is channel 29.
  * @return None

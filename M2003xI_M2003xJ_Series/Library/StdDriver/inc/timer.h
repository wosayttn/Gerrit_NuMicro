...
#define TIMER_CAPTURE_FROM_INTERNAL             (0x00UL)                            /*!< Capture source from Internal event ACMP0 \hideinitializer */
...
#define TIMER_TRG_TO_BPWM                       (TIMER_TRGCTL_TRGBPWM_Msk)          /*!< Each timer event as BPWM and EPWM counter clock source \hideinitializer */

 ...
 * @file     uart.h
 * @version  V3.00
 * @brief    M2003J series UART driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
#define UART_LINCTL_BRKFL(x)    (((x)-1UL) << UART_LINCTL_BRKFL_Pos)  /*!< UART_LINCTL setting to set LIN Break Field Length, x = 10 ~ 15, default value is 12 \hideinitializer */
#define UART_LINCTL_BSL(x)      (((x)-1UL) << UART_LINCTL_BSL_Pos)    /*!< UART_LINCTL setting to set LIN Break/Sync Delimiter Length, x = 1 ~ 4 \hideinitializer */
 ...
 *                  It indicates if specified UART port transmission is over or not.
 *    \hideinitializer
 */
 ...
 *
 *    @retval       0 The specified interrupt has not happened.
 *    @retval       1 The specified interrupt has happened.
 *

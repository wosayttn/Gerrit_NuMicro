...
- `ThirdParty/libjpeg/README`
  ...
  - Shows `README for release 9d of 12-Jan-2020`.
  - Contains the legal terms under `LEGAL ISSUES`.
- `ThirdParty/libjpeg/jversion.h`
  - Defines `JVERSION` as `9d  12-Jan-2020`.
  - Defines `JCOPYRIGHT` as `Copyright (C) 2020, Thomas G. Lane, Guido Vollbeding`.
...
- `bom-ref`: `pkg:generic/libjpeg@9d?source=vendored&path=ThirdParty/libjpeg`
- `purl`: `pkg:generic/libjpeg@9d`

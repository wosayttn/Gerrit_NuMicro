# TouchView MP Component Description (for SCA / SBOM)

Component metadata for the **TouchView MP** Windows host-side touch panel mass production utility located under `Tool/TK`.

## 1) Component Identity

- Component name (`name`): `TouchView MP - Tool/TK/TouchView_MP.exe`
...
- Executable: `Tool/TK/TouchView_MP.exe`
- License: `Tool/TK/LICENSE.md`

### Version evidence

- `Tool/TK/TouchView_MP.exe` PE version resource:
...
TouchView MP is a Windows host-side utility for touch panel mass production. The component is distributed as a prebuilt executable; source code is not included in this BSP path.

## 4) Suggested CycloneDX Field Mapping

- `type`: `application`
- `name`: `TouchView MP - Tool/TK/TouchView_MP.exe`
- `version`: `1.0.0.1`
- `scope`: `required`
- `purl`: `pkg:generic/touchview-mp@1.0.0.1?file_path=Tool%2FTK%2FTouchView_MP.exe`
...
| --- | ---: | --- |
| `Tool/TK/TouchView_MP.exe` | 2777088 | `053a8a4646686f719cc6b149f0f8a945431f2ea62109355107b46a237b981a49` |

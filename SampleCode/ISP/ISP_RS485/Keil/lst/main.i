...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->UARTCTL |= (0x1ul << (1));


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->GPIOCTL |= (0x1ul << (1));


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->UARTSEL = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->UARTSEL & (~(0x7ul << (4)))) | (0x4UL<<(4));
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->UARTDIV = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x01000UL))->UARTDIV & (~(0xful << (4)))) | (((1)-1UL) << (4));



    ((GPIO_T *) ((((uint32_t)0x40000000UL) + 0x04000UL) + 0x040UL))->MODE = (((GPIO_T *) ((((uint32_t)0x40000000UL) + 0x04000UL) + 0x040UL))->MODE & ~(0x3ul << (8 << 1))) | (0x1UL << (8 << 1));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPL &= ~((0xFUL << (8)) | (0xFUL << (12)) );
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPL |= ((0x6UL<<(8)) | (0x6UL<<(12)) );

    ((*((volatile uint32_t *)((((((uint32_t)0x40000000UL) + 0x04000UL) + 0x800UL)+(0x40*(1))) + ((8)<<2))))) = (0);
...
_ISP:
    ...
    while (1)
    {
        if (bUartDataReady == (1UL))
        {
            ...
            ((*((volatile uint32_t *)((((((uint32_t)0x40000000UL) + 0x04000UL) + 0x800UL)+(0x40*(1))) + ((8)<<2))))) = (1);
            PutString();

            while ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL))->FIFOSTS & (0x1ul << (28))) == 0);

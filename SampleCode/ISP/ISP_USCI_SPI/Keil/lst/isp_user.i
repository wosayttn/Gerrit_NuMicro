...
static uint8_t aprom_buf[0x200UL] __attribute__((aligned(4)));

uint32_t bUpdateApromCmd;
uint32_t g_apromSize, g_dataFlashAddr, g_dataFlashSize;


static inline uint16_t Checksum(unsigned char *buf, int len)
{
    int i;
    uint16_t c;
...
int ParseCmd(unsigned char *buffer, uint8_t len)
{
    ...
    pSrc += 8;
    srclen -= 8;
    (FMC_Proc(0x00UL, 0x0F300000UL, 0x0F300000UL + 16, (uint32_t *)(response + 8)));
    ...
    {
        ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->RSTSTS = 3;
        ...
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL = i;
    ...
    else if (lcmd == 0x000000FF)
    {
        ...
        PageAddress = StartAddress & (0x100000 - 0x200UL);

        if (PageAddress >= 0x0F300000UL)
        {
            goto out;
        }
        ...
        if ((StartAddress % 0x200UL) >= (0x200UL - LastDataLen))
        {
            (FMC_Proc(0x22UL, PageAddress + 0x200UL, (PageAddress + 0x200UL) + 4, 0));
        }

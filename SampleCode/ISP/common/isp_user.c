...
const uint32_t g_u32DataFlashAddr = FMC_DATA_FLASH_BASE,
...
int ParseCmd(uint8_t *pu8Buffer, uint8_t u8len)
{
    ...
    ReadData(FMC_USER_CONFIG_0, (FMC_USER_CONFIG_0 + (FMC_CONT_CONFIG_CNT * 4)), (uint32_t *)(uint32_t)(pu8Response + 8)); /* Read config */

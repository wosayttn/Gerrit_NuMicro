...
void I2C_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->I2CRST |= (0x1UL << (0));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->I2CRST &= ~(0x1UL << (0));

    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->CTL0 |= (0x1ul << (6));

    u32BusClock = 100000;
    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->CLKDIV = (uint32_t)(((SystemCoreClock * 10) / (u32BusClock * 4) + 5) / 10 - 1);

    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->ADDR0 = (((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->ADDR0 & ~(0x3fful << (1))) | (g_u8DeviceAddr << (1));

    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->CTL0 |= (0x1ul << (7));

    ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->CTL0 & ~0x3C) | (0x0CUL));
...
void I2C0_IRQHandler(void)
{
    ...
    if (((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->TOCTL & (0x1ul << (0)))
    {

        ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL))->TOCTL |= (0x1ul << (0));
    }
    else
    {
        I2C_SlaveTRx(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)), u32Status);
    }
}
...
void I2C_SlaveTRx(I2C_T *i2c, uint32_t u32Status)
{
    ...
    {
        i2c_rcvbuf[g_u8SlvDataLen] = ((i2c)->DAT);
        g_u8SlvDataLen++;
        g_u8SlvDataLen &= 0x3F;

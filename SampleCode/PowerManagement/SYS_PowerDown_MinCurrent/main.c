...
int main(void)
{
    ...
    */
    ...
    /* Enter Power-down mode */
    if (SET_PDMSEL == CLK_PMUCTL_PDMSEL_NPD0)        printf("Enter NPD0 ...\n");
    else if (SET_PDMSEL == CLK_PMUCTL_PDMSEL_NPD1)   printf("Enter NPD1 ...\n");
    else if (SET_PDMSEL == CLK_PMUCTL_PDMSEL_NPD2)   printf("Enter NPD2 ...\n");
    else if (SET_PDMSEL == CLK_PMUCTL_PDMSEL_SPD0)   printf("Enter SPD0 ...\n");
    else if (SET_PDMSEL == CLK_PMUCTL_PDMSEL_SPD1)   printf("Enter SPD1 ...\n");

 ...
 * @file     main.c
 * @version  V1.00
 * @brief    Show how to enter different Power-down mode and wake-up by Wake-up Timer.
 *
...
int main(void)
{
    ...
    /*
        This sample code will enter different Power-down mode and wake-up by Wake-up Timer:

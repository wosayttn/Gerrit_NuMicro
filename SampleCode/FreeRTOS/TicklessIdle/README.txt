...
User can monitor HCLK by PA3 to check if the system enter deeper sleep (clock off).
In the sample code, a thread is created to print the tick count and delay ever 1000ms.

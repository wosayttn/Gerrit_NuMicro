...
volatile uint32_t g_u32WriteRTC_Ticks, g_u32ReadRTC_Ticks = 0;
 ...
 * @return      None
 *
 * @details     The PB default IRQ, declared in startup_m471.s.
 */
...
void vParTestInitialise(void)
{
    ...
    printf("+-------------------------------------+\n");
    printf("CLKO(PA.3) can monitor if the CPU enters Power-Down mode.\n");

...
volatile uint32_t u32SecCntRecord = 0;
 ...
 * @return      None
 *
 * @details     The RTC_IRQHandler is default IRQ of RTC, declared in startup_M2U51.s.
 */
void RTC_IRQHandler(void)
{
    ...
    if(RTC_GET_ALARM_INT_FLAG() == 1)
    {
        ...
        RTC_GetDateAndTime(&sReadRTC);
         ...
         printf("RTC Alarm: %d/%02d/%02d %02d:%02d:%02d\n",
 ...
 * @return      None
 *
 * @details     The PB default IRQ, declared in startup_M2U51.s.
 */
...
//    printf("IO wakeup time: %d/%02d/%02d %02d:%02d:%02d\n",
//           sReadRTC.u32Year, sReadRTC.u32Month, sReadRTC.u32Day, sReadRTC.u32Hour, sReadRTC.u32Minute, sReadRTC.u32Second);
}

/******************************************************************************
 * @file     ccid_vcom.h
 * @brief    USB composite device(CCID smart card reader and VCOM) driver header file
 * @version  V1.00
 *
...
#define VCOM_BULK_OUT_EP_NUM     0x04
#define VCOM_INT_IN_EP_NUM       0x05

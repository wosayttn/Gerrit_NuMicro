 ...
 * @file     main.c
 * @version  V2.0
 * @brief    USB composite device(CCID smart card reader and VCOM) sample code.
 *
...
void UART0_Init()
{
    ...
    UART_ENABLE_INT(UART0, UART_INTEN_TOCNTEN_Msk | UART_INTEN_RDAIEN_Msk);
}
...
int main(void)
{
    ...
    printf("\n\nCPU @ %dHz\n", SystemCoreClock);
    printf("+---------------------------------------------------------------------------------+\n");
    printf("|    NuMicro USB composite device(CCID smart card reader and VCOM) Sample Code    |\n");
    printf("+---------------------------------------------------------------------------------+\n");

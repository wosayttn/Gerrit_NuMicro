 ...
 * @file    main.c
 * @version V1.00
 * @brief   Template for M5531 series MCU
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2023 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
/*
 * This is a template project for M5531 series MCU.
 ...
 * Debug UART
 *   system_M5531.c has three weak functions as below to configure debug UART port.
...
int main(void)
{
    ...
    printf("\n\n   M5531 L1 DCache Test Code - DCache %-3s\n", (NVT_DCACHE_ON == 1) ? "ON" : "OFF");

    printf("+------------------------------------------+\n");
    printf("|           DCache test with PDMA          |\n");
    printf("+------------------------------------------+\n");
    /*
    ...
    else
    {
        ...
        {
            printf("  [OK] DCache not work due to DCache OFF. u32DstSum: %d == u32SrcSum: %d\n", u32DstSum, u32SrcSum);
        }
    }
    ...
    if (u32Addr == FMC_LDROM_END)
    {
        ...
        {
            printf("  [OK] DCache not work due to DCache OFF.\n");
        }
    }

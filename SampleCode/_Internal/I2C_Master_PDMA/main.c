 ...
 * @file     main.c
 * @version  V0.10
 * @brief    Show a Master how to access Slave using PDMA Tx and PDMA Rx mode (Loopback)
 *
...
volatile int32_t g_u32IsTestOver = 0;
...
int32_t main(void)
{
    ...
    */
    ...
    s_pfnI2C0Handler = (I2C_FUNC)I2C_PDMA_MasterRx;

 ...
 * @file     main.c
 * @version  V0.10
 * @brief    Demonstrate how a Slave use PDMA Rx mode receive data from a Master(Loopback).
 *
...
uint8_t g_au8SlvData[I2C_PDMA_RX_LENGTH];
...
int32_t main(void)
{
    ...
    */
    ...
    for (i = 0; i < sizeof(g_au8SlvData); i++)
    {
        g_au8SlvData[i] = 0;
    }

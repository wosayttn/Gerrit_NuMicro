...
const uint8_t gu8ConfigDescriptor[LEN_CONFIGURATION_TOTAL] = {
    LEN_CONFIG,  /* bLength              */
    ...
    (EP_INPUT | COMMON_INT_EP_NUM), /* bEndpointAddress */
    EP_INT,                       /* bmAttributes     */
    GET_BYTE0(COMMON_INT_EP_LEN),
    GET_BYTE1(COMMON_INT_EP_LEN), /* wMaxPacketSize   */
    0x01,                        /* bInterval        */
#endif
    ...
    LEN_IAD,        // bLength: Interface Descriptor size
    DESC_IAD,       // bDescriptorType: IAD
    INTF_NUM_VCOM5, // bFirstInterface
    0x02,           // bInterfaceCount
    0x02,           // bFunctionClass: CDC
    0x02,           // bFunctionSubClass
    0x01,           // bFunctionProtocol
    ...
    LEN_INTERFACE,  /* bLength              */
    DESC_INTERFACE, /* bDescriptorType      */
    INTF_NUM_VCOM5, /* bInterfaceNumber     */
    0x00,           /* bAlternateSetting    */
#if (ENABLE_COMMON_INTERRUPT_EP)
    0x01,           /* bNumEndpoints        */
#else
    ...
    /* BIT1: Whether device can send/receive call management information over a
       Data Class Interface 0 */
    INTF_NUM_VCOM5 + 1, /* Interface number of data class interface optionally
             used for call management */
    ...
    DESC_CDC_CS_INTERFACE, /* bDescriptorType: CS_INTERFACE descriptor type */
    DESC_CDC_UNION,        /* bDescriptorSubType   */
    INTF_NUM_VCOM5,        /* bMasterInterface     */
    INTF_NUM_VCOM5 + 1,    /* bSlaveInterface0     */
    ...
    LEN_INTERFACE,      /* bLength              */
    DESC_INTERFACE,     /* bDescriptorType      */
    INTF_NUM_VCOM5 + 1, /* bInterfaceNumber     */
    0x00,               /* bAlternateSetting    */
    0x02,               /* bNumEndpoints        */
    0x0A,               /* bInterfaceClass      */
    0x00,               /* bInterfaceSubClass   */
    ...
    LEN_IAD,        // bLength: Interface Descriptor size
    DESC_IAD,       // bDescriptorType: IAD
    INTF_NUM_VCOM6, // bFirstInterface
    0x02,           // bInterfaceCount
    0x02,           // bFunctionClass: CDC
    0x02,           // bFunctionSubClass
    0x01,           // bFunctionProtocol
    ...
    LEN_INTERFACE,  /* bLength              */
    DESC_INTERFACE, /* bDescriptorType      */
    INTF_NUM_VCOM6, /* bInterfaceNumber     */
    0x00,           /* bAlternateSetting    */
#if (ENABLE_COMMON_INTERRUPT_EP)
    0x01,           /* bNumEndpoints        */
#else
    ...
    /* BIT1: Whether device can send/receive call management information over a
       Data Class Interface 0 */
    INTF_NUM_VCOM6 + 1, /* Interface number of data class interface optionally
             used for call management */
    ...
    DESC_CDC_CS_INTERFACE, /* bDescriptorType: CS_INTERFACE descriptor type */
    DESC_CDC_UNION,        /* bDescriptorSubType   */
    INTF_NUM_VCOM6,        /* bMasterInterface     */
    INTF_NUM_VCOM6 + 1,    /* bSlaveInterface0     */
    ...
    LEN_INTERFACE,      /* bLength              */
    DESC_INTERFACE,     /* bDescriptorType      */
    INTF_NUM_VCOM6 + 1, /* bInterfaceNumber     */
    0x00,               /* bAlternateSetting    */
    0x02,               /* bNumEndpoints        */
    0x0A,               /* bInterfaceClass      */
    0x00,               /* bInterfaceSubClass   */

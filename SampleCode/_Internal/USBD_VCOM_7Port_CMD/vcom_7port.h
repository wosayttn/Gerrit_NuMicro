 ...
 ******************************************************************************/
#ifndef __USBD_VCOM_7PORT_CMD_H__
#define __USBD_VCOM_7PORT_CMD_H__

/* Multi Port Configuration*/
#define VCOM_CNT (7)

#define TUNE_UART_TIMTOUT (80UL)
#define UART_FIFO_DEPTH (UART_FIFO_RTSTRGLV_8BYTES)

#define ENABLE_COMMON_INTERRUPT_EP  0 /* 0:for WIN10; 1: for linux */
...
* |          |           |               |          |              | 0x00    | EP0       | CTRL IN  |
* |          |           |               |          |              | 0x00    | EP1       | CTRL OUT |
* | 1        | UART0     | VCOM0         | 0        | 0            | N/A     | N/A       | INT IN   |
* |          |           |               |          | 1            | 0x81    | EP2       | BULK IN  |
* |          |           |               |          | 1            | 0x01    | EP3       | BULK OUT |
* | 2        | UART1     | VCOM1         | 1        | 2            | N/A     | N/A       | INT IN   |
* |          |           |               |          | 3            | 0x82    | EP4       | BULK IN  |
* |          |           |               |          | 3            | 0x02    | EP5       | BULK OUT |
* | 3        | UART2     | VCOM2         | 2        | 4            | N/A     | N/A       | INT IN   |
* |          |           |               |          | 5            | 0x83    | EP6       | BULK IN  |
* |          |           |               |          | 5            | 0x03    | EP7       | BULK OUT |
* | 4        | UART3     | VCOM3         | 3        | 6            | N/A     | N/A       | INT IN   |
* |          |           |               |          | 7            | 0x84    | EP8       | BULK IN  |
* |          |           |               |          | 7            | 0x04    | EP9       | BULK OUT |
* | 5        | UART4     | VCOM4         | 4        | 8            | N/A     | N/A       | INT IN   |
* |          |           |               |          | 9            | 0x85    | EP10      | BULK IN  |
* |          |           |               |          | 9            | 0x05    | EP11      | BULK OUT |
* | 6        | UUART0    | VCOM5         | 5        | 10           | N/A     | N/A       | INT IN   |
* |          |           |               |          | 11           | 0x86    | EP12      | BULK IN  |
* |          |           |               |          | 11           | 0x06    | EP13      | BULK OUT |
* | 7        | N/A       | VCOM6         | 6        | 12           | N/A     | N/A       | INT IN   |
* |          |           |               |          | 13           | 0x87    | EP14      | BULK IN  |
* |          |           |               |          | 13           | 0x07    | EP15      | BULK OUT |
* | -------- | --------- | ------------- | -------- | ------------ | ------- | --------- | -------- |
* |(optional)|           | VCOM0 ~ 6     | 0 ~ 6    | VCOM0 ~ 6    | 0x08    | EP16      | INT_IN   |
* | -------- | --------- | ------------- | -------- | ------------ | ------- | --------- | -------- |
*/
...
#endif
#if (VCOM_CNT>=6)
    #define IDX_VCOM5 0x5
    #define INTF_NUM_VCOM5 (IDX_VCOM5*2)
#endif
#if (VCOM_CNT>=7)
    #define IDX_VCOM6 0x6
    #define INTF_NUM_VCOM6 (IDX_VCOM6*2)
#endif

#if ((VCOM_CNT>=8) || (VCOM_CNT<=0))
    #error VCOM number error, VCOM_CNT must be 1 ~ 7
#endif
...
#else
    #define VCOM_LEN ( LEN_IAD + (LEN_INTERFACE * 2) + LEN_VCOM_COMMAND_INTR + (LEN_ENDPOINT * 2))
#endif
...
#define ENDPOINT_MAX_PKT_SIZE 64
#define EP0_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
#define EP1_MAX_PKT_SIZE    EP0_MAX_PKT_SIZE

#if (VCOM_CNT>=1)
    #define EP2_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
    #define EP3_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=2)
    #define EP4_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
    #define EP5_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=3)
    #define EP6_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
    #define EP7_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=4)
    #define EP8_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
    #define EP9_MAX_PKT_SIZE    ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=5)
    #define EP10_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
    #define EP11_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=6)
    #define EP12_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
    #define EP13_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
#endif

#if (VCOM_CNT>=7)
    #define EP14_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
    #define EP15_MAX_PKT_SIZE   ENDPOINT_MAX_PKT_SIZE
#endif
...
#if (ENABLE_COMMON_INTERRUPT_EP)
    #define COMMON_INT_EP_BASE  (SETUP_BUF_BASE + EP0_BUF_LEN + (EP2_BUF_LEN*2) * VCOM_CNT)
    #define COMMON_INT_EP_LEN   8

    #if  (( VCOM_CNT*ENDPOINT_MAX_PKT_SIZE*2 + COMMON_INT_EP_LEN + SETUP_BUF_LEN + EP0_BUF_LEN) > 1024 )
        #error configured USBD SRAM size exceeds the limitation
    #endif
#endif

#if  (( VCOM_CNT*ENDPOINT_MAX_PKT_SIZE*2 + SETUP_BUF_LEN + EP0_BUF_LEN) > 1024 )
    #error configured USBD SRAM size exceeds the limitation
#endif
...
/* Define the interrupt In EP number */
    ...
    #define BULK_OUT_EP_NUM_0   BULK_IN_EP_NUM_0
#endif
#if (VCOM_CNT>=2)
    #define BULK_IN_EP_NUM_1    0x02
    #define BULK_OUT_EP_NUM_1   BULK_IN_EP_NUM_1
#endif
#if (VCOM_CNT>=3)
    #define BULK_IN_EP_NUM_2    0x03
    #define BULK_OUT_EP_NUM_2   BULK_IN_EP_NUM_2
#endif
#if (VCOM_CNT>=4)
    #define BULK_IN_EP_NUM_3    0x04
    #define BULK_OUT_EP_NUM_3   BULK_IN_EP_NUM_3
#endif
#if (VCOM_CNT>=5)
    #define BULK_IN_EP_NUM_4    0x05
    #define BULK_OUT_EP_NUM_4   BULK_IN_EP_NUM_4
#endif
#if (VCOM_CNT>=6)
    #define BULK_IN_EP_NUM_5    0x06
    #define BULK_OUT_EP_NUM_5   BULK_IN_EP_NUM_5
#endif
#if (VCOM_CNT>=7)
    #define BULK_IN_EP_NUM_6    0x07
    #define BULK_OUT_EP_NUM_6   BULK_IN_EP_NUM_6
#endif

#if (ENABLE_COMMON_INTERRUPT_EP)
    #define COMMON_INT_EP_NUM   0x08
#endif
...
#define MAX_PORT_UART       5   /* Amount of Hardware UART*/
...
#define TX_FIFO_SIZE_5      1  /* TX Hardware FIFO size */
// #define TX_FIFO_SIZE_6      1  /* TX Hardware FIFO size */ //use VCOM loopback
...
typedef struct
{
    ...
    uint8_t au8RxBuf[ENDPOINT_MAX_PKT_SIZE]; /* Bulk IN Buffer */
...
typedef uint32_t (*SetlineCoding_t)(void *uart, uint32_t, uint32_t, uint32_t, uint32_t);

#define GET_BULK_IN_EP(i) ((i+1)*2)
#define GET_BULK_OUT_EP(i) ((i+1)*2+1)
...
#endif  /* __USBD_VCOM_7PORT_CMD_H__ */

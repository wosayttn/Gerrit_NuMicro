...
{
    uint32_t u32EpSts = USBD->EPSTS0 & USBD_EPSTS0_EPSTS4_Msk;
    uint32_t u32Toggle = tVCOM[IDX_VCOM0].psCtrlVar->u32OutToggle;
    ...
    else
    {
        ...
        tVCOM[IDX_VCOM0].psCtrlVar->u32OutToggle = u32EpSts;
...
void EP7_Handler(void)
{
    ...
    uint32_t u32Toggle = tVCOM[IDX_VCOM1].psCtrlVar->u32OutToggle;
    ...
    else
    {
        ...
        tVCOM[IDX_VCOM1].psCtrlVar->u32OutToggle = u32EpSts;
        /* Set a flag to indicate bulk out ready */
...
{
    uint32_t u32EpSts = USBD->EPSTS1 & USBD_EPSTS1_EPSTS10_Msk;
    uint32_t u32Toggle = tVCOM[IDX_VCOM2].psCtrlVar->u32OutToggle;
    ...
    else
    {
        ...
        tVCOM[IDX_VCOM2].psCtrlVar->u32OutToggle = u32EpSts;
        /* Set a flag to indicate bulk out ready */
...
void EP13_Handler(void)
{
    ...
    uint32_t u32Toggle = tVCOM[IDX_VCOM3].psCtrlVar->u32OutToggle;
    ...
    else
    {
        ...
        tVCOM[IDX_VCOM3].psCtrlVar->u32OutToggle = u32EpSts;
        /* Set a flag to indicate bulk out ready */
...
{
    uint32_t u32EpSts = USBD->EPSTS2 & USBD_EPSTS2_EPSTS16_Msk;
    uint32_t u32Toggle = tVCOM[IDX_VCOM4].psCtrlVar->u32OutToggle;
    ...
    else
    {
        ...
        tVCOM[IDX_VCOM4].psCtrlVar->u32OutToggle = u32EpSts;
        /* Set a flag to indicate bulk out ready */

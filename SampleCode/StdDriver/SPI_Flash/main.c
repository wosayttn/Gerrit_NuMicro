...
int main(void)
{
    ...
    printf("Warning: this demo erases the whole flash chip and assumes W25Q-compatible opcodes and status-register behavior.\n");
    printf("Use only on expendable lab media; it is not production-safe guidance.\n");

...
-------
  ...
  -pagesize 4096   Set the page size to 4096 bytes (matches M5531 RRAM page size)

Description
-----------
This tool communicates with the M5531 device running the USBD_Printer_And_HID_Transfer
...
USB device and a page size of 4096 bytes aligned to the M5531 RRAM page size.

...
Description
-----------
This tool communicates with the M253 device running the USBD_Printer_And_HID_Transfer
...
USB device and a page size of 512 bytes aligned to the M253 RRAM page size.

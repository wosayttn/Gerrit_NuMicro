...
int main(void)
{
    uint32_t u32DataCount, u32TestCount, u32Err, u32Timeout;
    ...
    printf(" NOTE: This sample uses a bounded wait for demo recovery only. Add application-specific fault handling before production use.\n");

...
int main(void)
{
    ...
    /* Enable clock output, select CLKO clock source as SCLK and set clock output frequency is HCLK/4.
       HCLK clock source will be switched to HIRC if HXT stop and SCLK clock source is from HXT.

...
int32_t main(void)
{
    ...
    */
    ...
    /* Set the HXT clock frequency monitor upper and lower boundary value.
       The upper boundary value should be more than 2048*(HXT/HIRC).
       The low boundary value should be less than 2048*(HXT/HIRC).
    */
    /* For HXT=12MHz, HIRC=48MHz, 2048*(HXT/HIRC) = 512 */
    CLK->CDUPB  = 512 + 5;
    CLK->CDLOWB = 512 - 5;

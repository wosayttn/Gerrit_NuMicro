...
int32_t CalPeriodTime(PWM_T *PWM, uint32_t u32Ch)
{
    ...
    printf("\nPWM generate: \nHigh Period=12341 ~ 12344, Low Period=28798 ~ 28801, Total Period=41141 ~ 41144\n");
    printf("\nCapture Result: Rising Time = %d, Falling Time = %d \nHigh Period = %d, Low Period = %d, Total Period = %d.\n\n",
           u16RisingTime, u16FallingTime, u16HighPeriod, u16LowPeriod, u16TotalPeriod);

    if ((u16HighPeriod < 12341) || (u16HighPeriod > 12344) || (u16LowPeriod < 28798) || (u16LowPeriod > 28801) || (u16TotalPeriod < 41141) || (u16TotalPeriod > 41144))
    {
...
int main(void)
{
    ...
    while (1)
    {
        ...
        */
        ...
        PDMA_SetTransferAddr(PDMA0, 0, (uint32_t)&PWM1->PDMACAP[1], PDMA_SAR_FIX, (uint32_t)&g_au16Count[0], PDMA_DAR_INC);

        /* Select PDMA request source as PWM RX(PWM1 channel 2 should be PWM1 pair 2) */
        PDMA_SetTransferMode(PDMA0, 0, PDMA_PWM1_P2_RX, FALSE, 0);
        ...
        /* If input minimum frequency is 250Hz, user can calculate capture settings by follows.
           ...
           Capture unit time = 720000000/Capture clock source frequency*prescaler
           97 ns = 1000000000/72000000*7
        */

        /* Set PWM1 channel 2 capture configuration */
        PWM_ConfigCaptureChannel(PWM1, 2, 97, 0);
        PWM_SET_PRESCALER(PWM1, 2, (PWM1)->CLKPSC[0]);

 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Demonstrate how to initiate a Hot-Join request to an I3C Controller.
...
*/
/*
// <o> Select Dynamic Address Assigned Mode
//      <0=> Wait Controller to send ENTDAA CCC.
//      <1=> Initiate a Hot-Join request immediately after I3C Target enabled.
//      <2=> Initiate a Hot-Join request when a 7'h7E header on the bus.
// <i> Select the Dynamic Address Assigned mode to set the Target Dynamic Address.
*/
...
{    
    ...
    printf("\n\nCPU @ %d Hz\n", SystemCoreClock);
    printf("+-----------------------------------------------+\n");
    printf("|    I3C Target Hot-Join Request Sample Code    |\n");
    printf("+-----------------------------------------------+\n");

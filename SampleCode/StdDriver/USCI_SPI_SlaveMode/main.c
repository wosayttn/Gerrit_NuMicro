...
int main(void)
{
    uint32_t u32TxDataCount, u32RxDataCount, u32Timeout;
    ...
    {
        uint32_t u32Progress = 0UL;

        /* Check TX FULL flag and TX data count */
        if ((u32TxDataCount < TEST_COUNT) && (USPI_GET_TX_FULL_FLAG(USPI0) == 0))
        {
        ...
        /* Check RX EMPTY flag */
        if ((u32RxDataCount < TEST_COUNT) && (USPI_GET_RX_EMPTY_FLAG(USPI0) == 0))
        {
        ...
        {
            printf("USCI_SPI slave transfer timed out.\n");
            goto sample_exit;
        }
    }

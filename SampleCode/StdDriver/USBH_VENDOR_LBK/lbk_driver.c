...
err_out:
    ...
    {
        int data_len = (int)(s_lbk_dev.utr_iso_in[0]->data_len * ISO_UTR_NUM);
        usbh_free_mem(s_lbk_dev.utr_iso_in[0]->buff, data_len);
    }
...
void lbk_isochronous_in_stop(void)
{
    ...
    if ((s_lbk_dev.utr_iso_in[0] != NULL) && (s_lbk_dev.utr_iso_in[0]->buff != NULL))       /* free audio buffer                */
    {
        int data_len = (int)(s_lbk_dev.utr_iso_in[0]->data_len * ISO_UTR_NUM);
        usbh_free_mem(s_lbk_dev.utr_iso_in[0]->buff, data_len);
    }
...
err_out:
    ...
    {
        int data_len = (int)(s_lbk_dev.utr_iso_out[0]->data_len * ISO_UTR_NUM);
        usbh_free_mem(s_lbk_dev.utr_iso_out[0]->buff, data_len);
    }
...
void lbk_isochronous_out_stop(void)
{
    ...
    if ((s_lbk_dev.utr_iso_out[0] != NULL) && (s_lbk_dev.utr_iso_out[0]->buff != NULL))       /* free transfer buffer           */
    {
        int data_len = (int)(s_lbk_dev.utr_iso_out[0]->data_len * ISO_UTR_NUM);
        usbh_free_mem(s_lbk_dev.utr_iso_out[0]->buff, data_len);
    }

 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Demonstrate how to swtich deicve role between Controller and Target.
...
void I3C_ControllerRole(void);
void I3C_TargetRole(void);
...
{    
    ...
    printf("    - SDA on PA.0\n");
    printf("    - SCL on PA.1\n");
    printf("# User can hit [S] to switch device role\n");
    printf("\n");
    ...
    while(1)
    {
        ...
        /* Polling a specified char to switch the device role */
        ParseUartInputChar(&g_I3CDev);
    }
}

/**
  * @brief  Polling a specified char to switch the device role.
  */
void ParseUartInputChar(I3C_DEVICE_T *dev)
{
    char mode;
...
int main(void)
{
    ...
    printf("\n\nCPU @ %d Hz\n", SystemCoreClock);
    printf("+--------------------------------------------+\n");
    printf("|    I3C Secondary Controller Sample Code    |\n");
    printf("+--------------------------------------------+\n\n");
...
#else    
    printf("+---------------------------------------------------+\n");
    printf("|  Select device as Controller role or Target role  |\n");
    printf("|  [0] Controller    [Others] Target                |\n");
    printf("+---------------------------------------------------+\n");
    item = getchar();

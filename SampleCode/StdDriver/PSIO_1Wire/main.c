...
int main(void)
{
    ...
    printf("| Demo only: this lab sample assumes a compatible      | \n");
    printf("| device and stable line timing; production code       | \n");
    printf("| should add supervision and fault recovery.           | \n");
    printf("+------------------------------------------------------+ \n");

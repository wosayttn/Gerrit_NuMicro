...
void EADC_FunctionTest()
{
    ...
    while (1)
    {
        ...
        if (u8Option == '1')
        {
            ...
            /* Configure the sample module 0 for analog input channel 1 and enable PWM0 trigger source */
            EADC_ConfigSampleModule(EADC0, g_u32SampleModuleNum, EADC_PWM0TG0_TRIGGER, 1);
        ...
        else if (u8Option == '2')
        {
            ...
            EADC_ConfigSampleModule(EADC0, g_u32SampleModuleNum, EADC_PWM0TG0_TRIGGER, 8);

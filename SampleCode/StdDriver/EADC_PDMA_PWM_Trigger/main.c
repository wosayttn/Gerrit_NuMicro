...
void EADC_FunctionTest()
{
    ...
    while (1)
    {
        ...
        if (u8Option == '1')
        {
            ...
            EADC_ConfigSampleModule(EADC0, g_u32SampleModuleNum, EADC_PWM0TG0_TRIGGER, 2);
        ...
        else if (u8Option == '2')
        {
            ...
            /* Configure the sample module 0 for analog input channel 0 and software trigger source.*/
            EADC_ConfigSampleModule(EADC0, g_u32SampleModuleNum, EADC_PWM0TG0_TRIGGER, 0);

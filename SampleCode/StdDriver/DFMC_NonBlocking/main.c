...
int32_t volatile g_u32DFMC_Status = eDFMC_STATUS_IDLE;
...
/**
  ...
  * @retval   Others          : CPU loop count
  */
uint32_t DFMC_WriteWordTest(uint32_t u32WriteAddr, uint32_t u32Data)
{
    int32_t i32Count = 0;
...
/**
  ...
  * @retval   Others          : CPU loop count
  */
uint32_t DFMC_WriteTest(uint32_t u32WriteAddr, uint32_t *pu32Data, uint32_t u32WordCnt)
{

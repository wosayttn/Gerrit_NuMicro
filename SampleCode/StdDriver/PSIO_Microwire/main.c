...
int main(void)
{
    ...
    printf("| Demo only: external EEPROM wiring and timing are     | \n");
    printf("| board-specific; production code should validate      | \n");
    printf("| peer presence and add recovery handling.             | \n");
    printf("+------------------------------------------------------+ \n");

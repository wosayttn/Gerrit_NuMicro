...
extern uint32_t g_u32UacRecCnt;       /* Counter of UAC record data             */
extern uint32_t g_u32UacPlayCnt;      /* Counter of UAC playback data           */
...
static uint32_t s_u32StreamStartTick;

 ...
 *          Demo-only sample for W25Q-compatible flashes. This code performs
 *          a full-chip erase and updates flash status/QE bits.
 *
...
int main(void)
{
    ...
    printf("+-------------------------------------------------------------------------+\n");
    printf("Demo warning: this sample erases the full flash and assumes a W25Q-compatible device.\n");
    printf("Verify the target flash opcode set, status-register layout, and pin mapping before use.\n");

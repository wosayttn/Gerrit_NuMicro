...
/*---------------------------------------------------------------------------------------------------------*/
/**
 * @brief      Write 9-bit data to 7-bit address register of NAU8822 with I2C.
 *
 * @param[in]  u8Addr  The 7-bit register address of NAU8822.
 * @param[in]  u16Data The 9-bit data to be written to the register.
 *
 * @return     None.
 */
void I2C_WriteNAU8822(uint8_t u8Addr, uint16_t u16Data)
 ...
 *
 * @param[in]  u8ChipAddr The 7-bit I2C address of the NAU88L25.
 * @param[in]  u16SubAddr The 16-bit register address of the NAU88L25.
 * @param[in]  p          Pointer to the data buffer to be written.
...
/**
 * @brief      Write a single 16-bit value to the NAU88L25 audio codec via I2C.
 *
 * @param[in]  u16Addr The 16-bit register address of the NAU88L25.
 * @param[in]  u16Dat  The 16-bit data to be written.
 *
 * @return     0 if successful, otherwise an error code.
 */
uint8_t I2C_WriteNAU88L25(uint16_t u16Addr, uint16_t u16Dat)
 ...
 * @return   None
 *
 * @details  This function configures the NAU88L25 audio codec with a series of I2C commands.

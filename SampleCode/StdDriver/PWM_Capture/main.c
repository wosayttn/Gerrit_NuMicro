...
int32_t CalPeriodTime(PWM_T *PWM, uint32_t u32Ch)
{
    ...
    printf("\nPWM generate: \nHigh Period=12341 ~ 12344, Low Period=28798 ~ 28881, Total Period=41141 ~ 41144\n");
    printf("\nCapture Result: Rising Time = %d, Falling Time = %d \nHigh Period = %d, Low Period = %d, Total Period = %d.\n\n",
           u16RisingTime, u16FallingTime, u16HighPeriod, u16LowPeriod, u16TotalPeriod);

    if ((u16HighPeriod < 12341) || (u16HighPeriod > 12344) || (u16LowPeriod < 28798) || (u16LowPeriod > 28881) || (u16TotalPeriod < 41141) || (u16TotalPeriod > 41144))
    {

 ...
 * @return      None
 *
 * @details     The EQEI0_IRQHandler is default IRQ of EQEI0, declared in startup_M5531.c.
 */
 ...
 * @return      None
 *
 * @details     The EQEI1_IRQHandler is default IRQ of EQEI1, declared in startup_M5531.c.
 */

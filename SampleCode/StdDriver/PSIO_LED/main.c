...
int main(void)
{
    ...
    printf("| Demo only: LED strip timing and power constraints    | \n");
    printf("| are board-specific; production code should add       | \n");
    printf("| validation, recovery handling, and fault checks.     | \n");
    printf("+------------------------------------------------------+ \n");

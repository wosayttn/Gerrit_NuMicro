...
void EADC_FunctionTest()
{
    ...
    while (1)
    {
        ...
        if (u8Option == '1')
        {
            ...
            EADC_ConfigSampleModule(EADC0, 0, EADC_PWM0TG0_TRIGGER, 2);
        ...
        else if (u8Option == '2')
        {
            ...
            /* Configure the sample module 5 for analog input channel 0 and enable ADINT0 trigger source */
            EADC_ConfigSampleModule(EADC0, 5, EADC_PWM0TG0_TRIGGER, 0);

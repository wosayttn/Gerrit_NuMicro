...
/* CHG_CTRL3 */
#define RT9492_DIS_ACDRV_EN BIT(7)
#define RT9490_EN_OTG BIT(6)
#define RT9490_DIS_OTG_OOA BIT(1)

/* CHG_CTRL4 */
#define RT9490_EN_ACDRV2 BIT(7)
#define RT9490_EN_ACDRV1 BIT(6)
#define RT9490_DIS_VOTG_UVP_HICCUP BIT(2)

#define RT9490_DIS_VOTG_UVP_HICCUP_MASK BIT(2)
					
/* CHG_CTRL5 */
#define RT9490_ILIM_HZ_EN BIT(1)
#define RT9490_IBAT_REG_MASK (0x18)

#define RT9490_IBAT_REG_3A	(0<<3)
#define RT9490_IBAT_REG_4A	(1<<3)
#define RT9490_IBAT_REG_5A	(2<<3)

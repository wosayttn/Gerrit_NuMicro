...
__NO_RETURN static void CDC1_ACM_UART_to_USB_Thread(void *arg)
{
    ...
    static osRtxThread_t        cdc1_acm_uart_to_usb_thread_cb_mem               __attribute__((section(".bss.os.thread.cb")));
    static uint64_t             cdc1_acm_uart_to_usb_thread_stack_mem[512U / 8U] __attribute__((section(".bss.os.thread.stack")));
#endif
...
void USBD_CDC1_ACM_Initialize(void)
{
    ...
    //UART_SetTimeoutCnt(UART2, 255);
    //UART_BUS_IDLE_TIMEOUT_ENABLE(UART2);

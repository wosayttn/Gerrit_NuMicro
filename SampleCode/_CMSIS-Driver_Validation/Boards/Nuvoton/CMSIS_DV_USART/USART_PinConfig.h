...
// </h>
// <h> USART15 (UUART1)
// <i> Configuration settings for Driver_USART15 in component ::CMSIS Driver:USART
// <o> USART15_TX Pin <0=>Not Used <1=>PB3 <2=>PB6 <3=>PD6 <4=>PE11
#define RTE_USART15_TX_ID                4
#if    (RTE_USART15_TX_ID == 0)
    #define RTE_SET_USART15_TX_PIN()
#elif  (RTE_USART15_TX_ID == 1)
    #define RTE_SET_USART15_TX_PIN()         SET_USCI1_DAT1_PB3()
#elif  (RTE_USART15_TX_ID == 2)
    #define RTE_SET_USART15_TX_PIN()         SET_USCI1_DAT1_PB6()
#elif  (RTE_USART15_TX_ID == 3)
    #define RTE_SET_USART15_TX_PIN()         SET_USCI1_DAT1_PD6()
#elif  (RTE_USART15_TX_ID == 4)
    #define RTE_SET_USART15_TX_PIN()         SET_USCI1_DAT1_PE11()
#else
    #error "Invalid USART15_TX Pin Configuration!"
#endif
//   <o> USART15_RX Pin <0=>Not Used <1=>PB2 <2=>PB7 <3=>PD5 <4=>PE10
#define RTE_USART15_RX_ID                4
#if    (RTE_USART15_RX_ID == 0)
    #define RTE_SET_USART15_RX_PIN()
#elif  (RTE_USART15_RX_ID == 1)
    #define RTE_SET_USART15_RX_PIN()         SET_USCI1_DAT0_PB2()
#elif  (RTE_USART15_RX_ID == 2)
    #define RTE_SET_USART15_RX_PIN()         SET_USCI1_DAT0_PB7()
#elif  (RTE_USART15_RX_ID == 3)
    #define RTE_SET_USART15_RX_PIN()         SET_USCI1_DAT0_PD5()
#elif  (RTE_USART15_RX_ID == 4)
    #define RTE_SET_USART15_RX_PIN()         SET_USCI1_DAT0_PE10()
#else
    #error "Invalid USART15_RX Pin Configuration!"
#endif

//   <o> USART15_CTS Pin <0=>Not Used <1=>PB5 <2=>PB10 <3=>PD4 <4=>PE8
#define RTE_USART15_CTS_ID               0
#if    (RTE_USART15_CTS_ID == 0)
    #define RTE_SET_USART15_CTS_PIN()
#elif  (RTE_USART15_CTS_ID == 1)
    #define RTE_SET_USART15_CTS_PIN()        SET_USCI1_CTL0_PB5()
#elif  (RTE_USART15_CTS_ID == 2)
    #define RTE_SET_USART15_CTS_PIN()        SET_USCI1_CTL0_PB10()
#elif  (RTE_USART15_CTS_ID == 3)
    #define RTE_SET_USART15_CTS_PIN()        SET_USCI1_CTL0_PD3()
#elif  (RTE_USART15_CTS_ID == 4)
    #define RTE_SET_USART15_CTS_PIN()        SET_USCI1_CTL0_PE9()
#else
    #error "Invalid USART15_CTS Pin Configuration!"
#endif

//   <o> USART15_RTS Pin <0=>Not Used <1=>PB4 <2=>PB9 <3=>PD4 <4=>PE8
#define RTE_USART15_RTS_ID               0
#if    (RTE_USART15_RTS_ID == 0)
    #define RTE_SET_USART15_RTS_PIN()
#elif  (RTE_USART15_RTS_ID == 1)
    #define RTE_SET_USART15_RTS_PIN()        SET_USCI1_CTL1_PB4()
#elif  (RTE_USART15_RTS_ID == 2)
    #define RTE_SET_USART15_RTS_PIN()        SET_USCI1_CTL1_PB9()
#elif  (RTE_USART15_RTS_ID == 3)
    #define RTE_SET_USART15_RTS_PIN()        SET_USCI1_CTL1_PD4()
#elif  (RTE_USART15_RTS_ID == 4)
    #define RTE_SET_USART15_RTS_PIN()        SET_USCI1_CTL1_PE8()
#else
    #error "Invalid USART15_RTS Pin Configuration!"
#endif
// </h>
#endif

...
int main(void)
{
    ...
    //USB Device Validation document as below
    //https://arm-software.github.io/CMSIS-Driver_Validation/latest/group__usbd__comp__test.html
